...
import { c as grokRateLimit, l as grokUsage, s as assertSafePayload } from "./security-BnzJhXOQ.mjs";
import { storedAdminName, verifyAccessToken, verifyDeskToken } from "./access.server-C2km_OFU.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/grok-CEX2-htg.js
...
var askHelios = createServerFn({ method: "POST" }).validator((input) => input).handler(askHelios_createServerFn_handler, async ({ data }) => {
	...
	const { getLiveSnapshot } = await import("./sources-DkQi3_8B.mjs");
