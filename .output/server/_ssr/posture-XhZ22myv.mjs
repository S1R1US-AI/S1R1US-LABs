...
//#region node_modules/.nitro/vite/services/ssr/assets/posture-XhZ22myv.js
...
async function securityPosture(opts) {
	...
	try {
		const gate = await import("./agent-gate-BPeAYPtH.mjs").then((n) => n.r);
		const wl = await import("./agent-gate-BPeAYPtH.mjs").then((n) => n.l);
