...
import { c as grokRateLimit, l as grokUsage, s as assertSafePayload } from "./security-Dm747to4.mjs";
import { storedAdminName, verifyAccessToken, verifyDeskToken } from "./access.server-B-K5novK.mjs";
import { t as createServerRpc } from "./createServerRpc-CcvdN_gc.mjs";
import { n as guardedFetch } from "./net-guard-C4Si76ZP.mjs";
import { c as predAnalyst } from "./prediction-markets-DJbb5cB5.mjs";
import { n as runBots, t as heliosCall } from "./signal-DfFgOscY.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/grok-BwSBkJn9.js
...
async function gradeWithKey(apiKey, question) {
	const { getLiveSnapshot } = await import("./sources-Mdq5HqQ5.mjs");
...
var askHeliosByo = createServerFn({ method: "POST" }).validator((input) => input).handler(askHeliosByo_createServerFn_handler, async ({ data }) => {
	...
	const { looksLikeSecret } = await import("./security-Dm747to4.mjs").then((n) => n.m).then((n) => n.m);
