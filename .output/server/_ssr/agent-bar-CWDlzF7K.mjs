...
var agent_bar_exports = /* @__PURE__ */ __exportAll$1({
	barAgent: () => barAgent,
...
function barAgent(input) {
	...
	import("./intrusion-log-Dl3lKsr8.mjs").then((n) => n.a).then((n) => n.a).then(({ recordIntrusion }) => recordIntrusion({
		kind: "bad-bot",
		ip,
		ua: row.kind,
...
//#endregion
export { noteForumStrike as a, isBarredIp as i, barAgent as n, isBarredAgent as r, agent_bar_CWDlzF7K_exports as t };
