...
import { g as vulnRows, p as protocolRows } from "./security-Cm24ExbM.mjs";
...
import { n as agentSecurityStats, t as MCP_TOOLS } from "./agent-security-j9HmdOss.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/hunter-BQREoBQH.js
var HEADER_SPEC = [
	{
		id: "nosniff",
...
*/
var hunter_exports = /* @__PURE__ */ __exportAll({
...
function runHunter() {
	...
	const findings = [
		...
		finding("h-cup-sim", "WP2 Auth", "Championship simulation pause is system Admin only", "HIGH", "PASS", "setChampionshipSim uses verifyAccessToken (system HMAC). Copy-admin app. tokens rejected. Sim LIVE|PAUSED is world-cup.json, not gm-board status. Coinbase create stays locked on web and phone apps.", "Never wire setSimStatus to app-admin or a board token. Do not reuse GM B0aRd LIVE/PAUSED for the cup."),
...
//#endregion
export { cachedIntel as a, firewallLayers as c, runHunter as i, firewallSummary as l, cachedHunter as n, ingestIntel as o, hunter_exports as r, refreshIntel as s, HUNTER_WPS as t, headerPosture as u };
