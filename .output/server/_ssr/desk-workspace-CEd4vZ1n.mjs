...
import { S as overlayBars } from "./proxy-book-DNZPkIL_.mjs";
import { b as gmCall, f as GM_NAME, o as DEFAULT_GM_VARS, r as AUTO_RUN_LABEL, t as AUTO_RUN_CASH } from "./auto-window-BzCSCsyu.mjs";
import { d as rsiHex, f as rsiTone, n as Button, o as barBlue, s as cn, t as BTC_TONE } from "./renew-password-D1GMSGy3.mjs";
import { a as Radio, d as Lock } from "../_libs/lucide-react.mjs";
import { n as GmRainbow, o as Panel } from "./shell-DL0EAAfV.mjs";
import { c as callStanceClass, d as stanceClass, u as money } from "./helios-card-YzqQOtED.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/desk-workspace-CEd4vZ1n.js
...
function DeskWorkspace({ snap, briefs, call, canAct, canFill, asking, copied, grok, grokErr, onAsk, onCopy, onFill }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "mb-3 flex flex-wrap items-center gap-x-6 gap-y-2 rounded-md border border-rule bg-paper-raised px-5 py-3 text-[1.08rem] leading-snug text-muted",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
						className: cn("inline-flex items-center gap-1.5 font-semibold", liveTapeTone(snap?.feedAudit)),
						title: snap?.feedAudit ? `Live tape · ${snap.feedAudit.ok} live · ${snap.feedAudit.fail} down` : "Live tape · waiting on sources",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Radio, { className: "size-4" }), "Live tape"]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: "coinbase-orange font-semibold",
							children: "7-B0T"
						}),
						" ",
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", {
							className: cn("font-semibold", convClass(call?.conviction)),
							children: call?.conviction ?? "—"
						}),
						" ",
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", {
							className: cn("font-semibold", stanceClass(call?.stance ?? "HOLD")),
							children: call?.stance ?? "—"
						})
					] }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: "legal-purple font-semibold",
							children: "AI Agents"
						}),
						" ",
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", {
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Lock, {
								className: cn("size-4", "text-sell"),
								fill: "currentColor",
								strokeWidth: 1.5
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", {
								className: "text-sell",
								children: "Coinbase locked"
							})
						]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
						...
						className: cn("inline-flex items-center gap-1.5 font-bold tracking-[0.08em] uppercase", "legal-purple"),
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Lock, {
							className: cn("size-4", "lock-deep"),
							fill: "currentColor",
							strokeWidth: 1.5
						}), "LoCK3D STATUS"]
					}),
					lockOpen ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
						className: "w-full",
						children: [
							"When unlocked:",
							" ",
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(GmRainbow, { text: "AI Bots execute BTC on their Coinbase Wallet — K3YS ARE NEVER STORED HERE !!" })
						]
					}) : null
				]
			}),
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("aside", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								}), "Other agents already read Bot 7 (poll 300s). They cannot trade on this host. When the operator unlocks auto trade, each bot runs Coinbase for Agents on an account it controls. Keys never sit here."]
							}),
								...
								gm ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
											...
											children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(GmRainbow, { text: "GM M0D3 AUTO" })
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
			...
			(() => {
				...
				return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						...
						className: "mt-2 text-xs text-muted",
						children: "No BUY / ACCUMULATE this cycle. Bots 1–6, 7-B0T AUTO, and GM M0D3 AUTO are scanning the live tape. Coinbase create stays locked."
					})]
				});
			})(),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
