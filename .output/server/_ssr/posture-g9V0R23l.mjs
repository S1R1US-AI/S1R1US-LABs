...
import { i as asiRows, n as agentSecurityStats, s as llmAgentRows } from "./agent-security-j9HmdOss.mjs";
import { a as cachedIntel, c as firewallLayers, i as runHunter, l as firewallSummary, o as ingestIntel, s as refreshIntel, u as headerPosture } from "./hunter-BQREoBQH.mjs";
import { n as pciRows, r as pluginInventory, t as owaspRows } from "./control-map-CYwGTHQc.mjs";
import { readFileSync } from "node:fs";
//#region node_modules/.nitro/vite/services/ssr/assets/posture-g9V0R23l.js
...
async function securityPosture(opts) {
	...
	try {
		const gate = await import("./agent-gate-C84uSfby.mjs").then((n) => n.r);
		const wl = await import("./agent-gate-C84uSfby.mjs").then((n) => n.l);
