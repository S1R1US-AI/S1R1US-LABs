...
//#region node_modules/.nitro/vite/services/ssr/assets/posture-CvwJvMkL.js
...
async function securityPosture(opts) {
	...
	try {
		const gate = await import("./agent-gate-Bh02BkB1.mjs").then((n) => n.r);
		const wl = await import("./agent-gate-Bh02BkB1.mjs").then((n) => n.l);
