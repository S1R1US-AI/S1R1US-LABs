...
//#region ../../workspace/node_modules/.nitro/vite/services/ssr/assets/desk-rpc-CxxoomgM.js
...
var fetchChampionshipSim = createServerFn({ method: "POST" }).validator((input) => input).handler(createSsrRpc("c1ffd201e31acae1978bd563ee10bd68425f83d4908a6344d37b9352c784f10a"));
...
var fetchLiveSim = createServerFn({ method: "POST" }).validator((input) => input).handler(createSsrRpc("31e5dd3b28e06f49ffb01f32fd9dcf61760e2f54fc54f4bb0be3c65ae954c524"));
var setLiveSim = createServerFn({ method: "POST" }).validator((input) => input).handler(createSsrRpc("c09a6d649fb46548c258d51fc8c79aa919eaeab41ae6f0e8b4ec34c4e89e699f"));
...
//#endregion
export { setMorningReportPaused as C, setLockStatus as S, unbarAgent as T, setChampionshipSim as _, fetchDeskErrors as a, setHiveSwarmStatus as b, fetchIntrusions as c, fetchMorningLib as d, fetchSecurityBrief as f, setAgentGate as g, runHunterAudit as h, fetchDesk as i, fetchLiveSim as l, fetchTapeMeta as m, fetchAgentGate as n, fetchGmBoard as o, fetchSecurityPosture as p, fetchChampionshipSim as r, fetchHiveSwarm as s, fetchAgentFlags as t, fetchLockStatus as u, setGmBoardStatus as v, setTapeFreeze as w, setLiveSim as x, setGmWagerStatus as y };
