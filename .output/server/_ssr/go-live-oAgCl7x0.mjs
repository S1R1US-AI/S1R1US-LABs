//#region node_modules/.nitro/vite/services/ssr/assets/go-live-oAgCl7x0.js
...
var GO_LIVE_DEADLINE = "2026-12-01";
var GO_LIVE_DEADLINE_LABEL = `${GO_LIVE_DEADLINE} 09:00 America/New_York`;
var GO_LIVE = [
	{
		id: "gl0",
		n: 0,
...
var GO_LIVE_HEADLINE = `GO-LIVE PATH STARTED ${GO_LIVE_START} — HARD DEADLINE ${GO_LIVE_DEADLINE_LABEL}. PoC rails + Auto GM/7-B0T would-accumulate + SUP3R B0WL paper LIVE. DEPLOY #68. Coinbase create LOCKED. Seek a licensed professional and a licensed attorney before live use.`;
...
//#endregion
export { GO_LIVE_STEPS as a, GO_LIVE_START as i, GO_LIVE_DEADLINE_LABEL as n, goLiveBrief as o, GO_LIVE_HEADLINE as r, GO_LIVE as t };
