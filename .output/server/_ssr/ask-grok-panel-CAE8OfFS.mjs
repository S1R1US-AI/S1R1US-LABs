...
import { Y as PAGE_DESC_COMPUTE, rn as SEO_TAB_COMPUTE, zn as TAB_COMPUTE } from "./brand-1s5EgS5V.mjs";
import { r as getBearerToken } from "./client-Dkf4Mpw3.mjs";
import { m as useCurrentUserState, n as Button } from "./renew-password-DaX2kF3V.mjs";
import { f as LoaderCircle, r as ScanSearch } from "../_libs/lucide-react.mjs";
import { m as Panel } from "./shell-DPpJkkER.mjs";
//#region ../../workspace/node_modules/.nitro/vite/services/ssr/assets/ask-grok-panel-CAE8OfFS.js
...
function AskGrokPanel({ kicker = "Ask Grok" }) {
	...
	async function onAsk() {
		...
		try {
			...
			const { askHeliosByo } = await import("./grok-BhCNSoSo.mjs").then((n) => n.r);
