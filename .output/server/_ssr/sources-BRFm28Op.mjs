...
//#region ../../workspace/node_modules/.nitro/vite/services/ssr/assets/sources-BRFm28Op.js
...
async function buildSnapshot() {
	try {
		const { ensureLiveSimScheduler } = await import("./live-sim.server-DIHNBqON.mjs");
