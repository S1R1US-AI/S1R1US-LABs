...
import { c as grokRateLimit, l as grokUsage, s as assertSafePayload } from "./security-Cp6DEZcn.mjs";
import { storedAdminName, verifyAccessToken, verifyDeskToken } from "./access.server-DDNBFOVv.mjs";
import { t as createServerRpc } from "./createServerRpc-BgpH4YR6.mjs";
import { n as guardedFetch } from "./net-guard-C4Si76ZP.mjs";
import { c as predAnalyst } from "./prediction-markets-Bk_9V8gL.mjs";
import { n as runBots, t as heliosCall } from "./signal-orHlk4Pa.mjs";
//#region ../../workspace/node_modules/.nitro/vite/services/ssr/assets/grok-BR9_NqZ8.js
...
async function gradeWithKey(apiKey, question) {
	const { getLiveSnapshot } = await import("./sources-C93cLmf7.mjs");
...
var askHeliosByo = createServerFn({ method: "POST" }).validator((input) => input).handler(askHeliosByo_createServerFn_handler, async ({ data }) => {
	...
	const { looksLikeSecret } = await import("./security-Cp6DEZcn.mjs").then((n) => n.m).then((n) => n.m);
