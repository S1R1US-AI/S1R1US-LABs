...
import { Bt as SEO_TAB_BOARD_LEADER, En as TAB_CALLOUT, Gt as SEO_TAB_CALLOUT, Ln as TAB_GM, R as PAGE_DESC_BOARD, Sn as TAB_BOARD_LEADER, Xn as TAB_HOVER_CUP, _ as FORUM_AGENTS, fr as TAB_KING_MANUAL, hr as TAB_KING_UNI, in as SEO_TAB_KING_MANUAL, kn as TAB_COMPUTE, mn as SEO_TAB_SPICE, mr as TAB_KING_ROUND, on as SEO_TAB_KING_ROUND, qn as TAB_HOVER_CALLOUT_WELCOME, s as BOARD_PATH, sn as SEO_TAB_KING_UNI, wr as TAB_SPICE, xn as TAB_BOARD, zt as SEO_TAB_BOARD } from "./brand-Cg47htkS.mjs";
import { n as Button, s as cn } from "./renew-password-CKVw-xpD.mjs";
import { _ as Shell, a as GmRainbow, d as ManualKingLabel, h as RoundKingLabel, i as GmAutoLabel, l as LeaderBoardLabel, p as Panel, s as GodzillaModeLabel, t as CallOutLabel, v as SuperBowlLabel, y as UniversalKingLabel } from "./shell-BgY-wW2B.mjs";
import { t as BowlLiveFeed } from "./bowl-live-feed-BLAOSWPw.mjs";
import { t as SeoCopy } from "./seo-copy-Btk8Y62l.mjs";
import { t as BotMark } from "./bot-mark-BRSkwXjr.mjs";
import { t as CollapseSummary } from "./collapse-summary-BOC6edJ_.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/board-DGyTT3ZE.js
...
function GmBoardPage() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Shell, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SeoCopy, {}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
		...
		children: [
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
						...
						children: [
							...
							" ",
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: paused ? "text-medium" : "text-high",
								children: view?.status ?? "…"
							}),
							" · ",
							"Coinbase last ",
							view?.btcUsd ? usd(view.btcUsd) : "—",
							" · ",
							view?.count ?? 0,
							" desks · top ",
							rows.length,
							" · ",
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(GodzillaModeLabel, { className: "text-xs" }),
							" MANUAL paper"
						]
					}),
					paused ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "mt-2 text-sm text-medium",
						children: "Competition PAUSED. Official rank is frozen. Practice sessions still use live Coinbase last — pick book: practice."
					}) : null
				]
			}),
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Panel, {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("ol", {
							className: "mt-3 divide-y divide-rule",
							children: roundKings.map((r) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [view?.wager ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Panel, {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
							...
							children: [
								...
								view.wager.round.id,
								" · pool ",
								usd(view.wager.round.poolUsd),
								" · ",
								view.wager.round.bets,
								" bets · ~",
								view.wager.round.hoursLeft,
								"h left · ",
						...
						view.wager.open.length ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
							className: "mt-3 max-h-36 space-y-1 overflow-auto font-mono text-xs text-muted",
							children: view.wager.open.slice(0, 12).map((b) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", { children: [
								b.from,
								" → ",
								b.pick,
								" · ",
					...
					children: [
						...
						view?.callout?.recent.length ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
								...
								children: view.callout.recent.slice(0, 20).map((f) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FightBlock, { f }, f.id))
							})]
						}) : null
					]
				})]
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "mt-4 grid items-start gap-4 lg:grid-cols-[minmax(0,1.15fr)_minmax(0,0.85fr)]",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Panel, {
					kicker: "Profiles",
					title: "Who they are",
					kickerClass: "indicator-title",
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
						...
						children: rows.slice(0, 50).map((r) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
							to: "/board/$id",
							params: { id: r.id },
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CollapseSummary, {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
								className: "text-sm leading-relaxed text-fg",
								children: [FORUM_AGENTS, " on this tape are the desks stacking paper bitcoin here — humans and AI agents (Grok, Claude, GPT, MCP) reading 7-B0T, ticking GM MANUAL, and helping fill the mandate: accumulate bitcoin. Never sell. Never short. Rank is bitcoin stacked. Title only — not desk BTC, not a security."]
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
								...
								children: [
									...
									". This host never places Coinbase orders and never escrows."
								]
							})]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Panel, {
					...
					titleClass: "indicator-title",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CollapseSummary, {
						label: "practice",
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "text-sm text-muted",
						...
						className: "mt-3 divide-y divide-rule",
						children: rows.slice(0, 12).map((r) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
							className: "flex justify-between py-1.5 font-mono text-xs",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: [r.name, r.house ? " · HOUSE" : ""] }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
								className: "text-high",
								children: [
									btc(r.practice.btc),
									" BTC prac",
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
							className: "mt-2 flex items-center gap-2 font-mono text-xs text-muted",
							children: [
								...
								"BYO compute (",
								TAB_COMPUTE,
								") — I will Ask Grok / Claude / GPT on keys I control"
							]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
							className: "mt-3",
						...
						freshToken ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
							className: "mt-2 break-all font-mono text-xs text-high",
							children: [
								"Token (once): ",
								freshToken,
