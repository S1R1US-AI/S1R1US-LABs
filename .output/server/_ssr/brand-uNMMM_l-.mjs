//#region node_modules/.nitro/vite/services/ssr/assets/brand-uNMMM_l-.js
...
var TAB_FEED = "F33D G0dZiLLa M0D3";
...
var SEO_TAB_FEED = "Feed Godzilla mode";
...
var SEO_TITLE = "S1R1U$ 7-B0t Hedge Fund | G0DZ1LLa M0D3 | S1R1U$ L@B Strategies | OP3N S0URC3 | AI Bitcoin trading bot";
var SEO_DESCRIPTION = "S1R1U$ 7-B0t Hedge Fund (S1R1US 7-bot hedge fund) is an AI Bitcoin trading bot and AI hedge fund. G0DZ1LLa M0D3 (Godzilla mode) is the aggressive sleeve. S1R1U$ L@B Strategies (S1R1US Lab Strategies) is the what-if lab. OP3N S0URC3 (open source) at github.com/S1R1US-AI/S1R1US-LABs. [ S1R1U$ <<L@B$>> ] — S1R1US Labs. Also an AI stock trading bot for Mag7/rotation tape. SuperGrok is the only paid service. Not financial advice.";
var SEO_KEYWORDS = [
...
var SEO_ALIASES = [
	`${TAB_DESK} is also searched as ${SEO_TAB_DESK}.`,
...
var TAB_HOVER_FAQ = `FAQ · ${TAB_DESK} (${SEO_TAB_DESK}) · ${TAB_GM} (${SEO_TAB_GM}) · ${TAB_LAB} (${SEO_TAB_LAB}) · ${TAB_TOKEN} (${SEO_TAB_TOKEN}) · ${TAB_HELLO} (${SEO_TAB_HELLO}) · OP3N S0URC3 (open source)`;
var TAB_HOVER_SITEMAP = `Sitemap · ${TAB_DESK} · ${TAB_GM} · ${TAB_FEED} · ${TAB_LAB} · ${TAB_HELLO} (${SEO_TAB_HELLO}) · OP3N S0URC3 (open source)`;
var TAB_HOVER_HOME = `${APP_NAME} · ${TAB_DESK} (${SEO_TAB_DESK}) · ${TAB_HELLO} (${SEO_TAB_HELLO}) · s1r1us.ai`;
var PAGE_TITLE_GM = `${TAB_GM} (${SEO_TAB_GM}) | ${TAB_DESK} | OP3N S0URC3 | AI Bitcoin trading bot`;
var PAGE_TITLE_LAB = `${TAB_LAB} (${SEO_TAB_LAB}) | ${TAB_DESK} | OP3N S0URC3 | AI Bitcoin trading bot`;
var PAGE_TITLE_FEED = `${TAB_FEED} (${SEO_TAB_FEED}) | ${TAB_GM} | OP3N S0URC3`;
var PAGE_TITLE_FAQ = `FAQ · ${TAB_DESK} · ${TAB_GM} · ${TAB_FEED} · ${TAB_LAB} · ${TAB_TOKEN} · OP3N S0URC3`;
var PAGE_TITLE_SITEMAP = `Sitemap · ${TAB_DESK} · ${TAB_GM} · ${TAB_FEED} · ${TAB_HELLO} · OP3N S0URC3`;
...
var PAGE_DESC_FEED = `${TAB_FEED} (${SEO_TAB_FEED}). ${TAB_FEED_GROWL} Optional BTC/USDC cover hosting, s1r1us.ai, and the open-source web / iOS / Play apps. Not an investment.`;
var PAGE_DESC_FAQ = "FAQ for S1R1U$ 7-B0t Hedge Fund (S1R1US 7-bot hedge fund), G0DZ1LLa M0D3 (Godzilla mode), F33D G0dZiLLa M0D3 (Feed Godzilla mode), S1R1U$ L@B Strategies (S1R1US Lab Strategies), T0K3N L@UNCH (Token launch), OP3N S0URC3 (open source). Not financial advice. Seek a licensed professional. Not an offer of securities.";
var PAGE_DESC_SITEMAP = "Sitemap for S1R1US Labs: S1R1U$ 7-B0t Hedge Fund (S1R1US 7-bot hedge fund), G0DZ1LLa M0D3 (Godzilla mode), F33D G0dZiLLa M0D3 (Feed Godzilla mode), S1R1U$ L@B Strategies (S1R1US Lab Strategies), H3LL0 W0RLD (Hello World), FAQ, OP3N S0URC3 (open source).";
//#endregion
export { TAB_HELLO as A, TAB_HOVER_SITEMAP as B, SEO_TAB_TOKEN as C, TAB_FEED_GROWL as D, TAB_FEED as E, TAB_HOVER_HELLO as F, TAB_MAX_GAINS as H, TAB_HOVER_HOME as I, TAB_HOVER_LAB as L, TAB_HOVER_FAQ as M, TAB_HOVER_FEED as N, TAB_FEED_NOW as O, TAB_HOVER_GM as P, TAB_HOVER_MAX_GAINS as R, SEO_TAB_LAB as S, TAB_DESK as T, TAB_SEND_BTC as U, TAB_LAB as V, TAB_TOKEN as W, SEO_DESCRIPTION as _, PAGE_DESC_FAQ as a, SEO_TAB_FEED as b, PAGE_DESC_LAB as c, PAGE_TITLE_FEED as d, PAGE_TITLE_GM as f, SEO_CANONICAL as g, SEO_ALIASES as h, LABS_NAME as i, TAB_HOVER_DESK as j, TAB_GM as k, PAGE_DESC_SITEMAP as l, PAGE_TITLE_SITEMAP as m, APP_NAME as n, PAGE_DESC_FEED as o, PAGE_TITLE_LAB as p, BOT7_NAME as r, PAGE_DESC_GM as s, APP_CALLS as t, PAGE_TITLE_FAQ as u, SEO_KEYWORDS as v, SEO_TITLE as w, SEO_TAB_GM as x, SEO_TAB_DESK as y, TAB_HOVER_SEND_BTC as z };
