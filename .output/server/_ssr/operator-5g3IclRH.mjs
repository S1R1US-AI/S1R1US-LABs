...
import { t as authMiddleware } from "./middleware-Du0OBIlg.mjs";
import { n as create, t as persist } from "../_libs/zustand.mjs";
import { t as createSsrRpc } from "./createSsrRpc-B2Izd0c7.mjs";
import { a as signOut } from "./client-Dp7wcF1K.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/operator-5g3IclRH.js
var optionalXSession = createMiddleware({ type: "function" }).client(async ({ next }) => {
	const { getBearerToken } = await import("./client-Dp7wcF1K.mjs").then((n) => n.n).then((n) => n.n);
	return next({ sendContext: { bearerToken: getBearerToken() ?? void 0 } });
}).server(async ({ next, context }) => {
	const { getSessionUser } = await import("./verify.server-3YJL-enW.mjs");
	const { runWithBearer } = await import("./access.server-BY9Cz6ZS.mjs");
