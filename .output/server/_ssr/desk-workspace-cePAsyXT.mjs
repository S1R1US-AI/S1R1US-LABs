...
import { Jn as TAB_GM_AUTO, S as GIF_AI_BTC_BOT_NAME, Yn as TAB_GM_AUTO_TAIL, b as GIF_AI_BTC_BOT, dn as SEO_TAB_GM_AUTO, x as GIF_AI_BTC_BOT_EQ } from "./brand-DGWej0Mj.mjs";
import { _ as overlayBars } from "./proxy-book-BG4V1YAe.mjs";
import { b as gmCall, f as GM_NAME, o as DEFAULT_GM_VARS, r as AUTO_RUN_LABEL, t as AUTO_RUN_CASH } from "./auto-window-Dch1ZGrQ.mjs";
import { d as rsiHex, f as rsiTone, n as Button, o as barBlue, s as cn, t as BTC_TONE } from "./renew-password-SvIj_uPF.mjs";
import { _ as Panel, a as GmRainbow, x as SeoImage } from "./shell-BehmArVu.mjs";
import { c as callStanceClass, d as stanceClass, u as money } from "./helios-card-DtFM7OFk.mjs";
import { t as Lock3dRail } from "./lock3d-status-wVJxiGmV.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/desk-workspace-cePAsyXT.js
...
function TapeChart({ snap }) {
	...
	const [showMacd50, setShowMacd50] = (0, import_react.useState)(false);
	const [showMacd200, setShowMacd200] = (0, import_react.useState)(false);
	const [asset, setAsset] = (0, import_react.useState)("GOLD");
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(GoldBtcRatio, {
							btc: last.close,
							gold: quotes.GOLD?.last
						})
					]
				}) : null]
			}),
...
function GoldBtcRatio({ btc, gold }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
		...
		title: "Gold to BTC ratio — Coinbase PAXG-USD (1 PAXG = 1 oz gold)",
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
				className: "gold-css",
				children: "GOLD:BTC"
