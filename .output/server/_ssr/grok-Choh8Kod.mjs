...
import { c as grokRateLimit, l as grokUsage, s as assertSafePayload } from "./security-CdTEEtPf.mjs";
import { storedAdminName, verifyAccessToken, verifyDeskToken } from "./access.server-CKEnuqSn.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/grok-Choh8Kod.js
...
var askHelios = createServerFn({ method: "POST" }).validator((input) => input).handler(askHelios_createServerFn_handler, async ({ data }) => {
	...
	const { getLiveSnapshot } = await import("./sources-25H2sJoh.mjs");
