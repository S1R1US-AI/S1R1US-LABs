...
import { c as grokRateLimit, l as grokUsage, s as assertSafePayload } from "./security-C5jp0dl0.mjs";
import { storedAdminName, verifyAccessToken, verifyDeskToken } from "./access.server-mPMZ6WsK.mjs";
import { t as createServerRpc } from "./createServerRpc-CcvdN_gc.mjs";
import { n as guardedFetch } from "./net-guard-C4Si76ZP.mjs";
import { c as predAnalyst } from "./prediction-markets-B383LH4K.mjs";
import { n as runBots, t as heliosCall } from "./signal-DNSRJrEz.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/grok-Bt4z20sL.js
...
async function gradeWithKey(apiKey, question) {
	const { getLiveSnapshot } = await import("./sources-CTCu6Knd.mjs");
...
var askHeliosByo = createServerFn({ method: "POST" }).validator((input) => input).handler(askHeliosByo_createServerFn_handler, async ({ data }) => {
	...
	const { looksLikeSecret } = await import("./security-C5jp0dl0.mjs").then((n) => n.m).then((n) => n.m);
