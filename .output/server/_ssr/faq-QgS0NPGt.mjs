...
import { A as LOCK_HEADLINE, B as OWL_HEADLINE, Cr as TAB_HOVER_OWL, D as HIVE_PATH, Dn as SEO_TAB_ROBOTS, E as HIVE_HEADLINE, Fr as TAB_OSS_ROADMAP, Gn as TAB_DESK, Gt as SEO_CANONICAL, Hn as TAB_COFFEE, Hr as TAB_ROBOTS, Ht as ROBOTS_PATH, Ir as TAB_OWL, Kn as TAB_FEED, Mr as TAB_LAB, N as MENU_BOARD, Nr as TAB_LOCK3D, Pn as TAB_BEARS, R as OSS_ROADMAP_HEADLINE, Rn as TAB_BOWL, Sr as TAB_HOVER_OSS_ROADMAP, St as PAGE_TITLE_FAQ, Tr as TAB_HOVER_ROBOTS, V as OWL_PATH, Vn as TAB_CALLOUT_WELCOME, Vt as ROBOTS_HEADLINE, Wn as TAB_CUP, Wr as TAB_SPICE, Yn as TAB_FORUM, Z as PAGE_DESC_FAQ, _r as TAB_HOVER_HIVE, a as BEARS_HEADLINE, ar as TAB_HOVER_BOARD, br as TAB_HOVER_LOCK, d as BOWL_PATH, en as SEO_TAB_BOWL, f as CALLOUT_WELCOME_HEADLINE, g as CUP_PATH, h as CUP_HEADLINE, in as SEO_TAB_CALLOUT_WELCOME, ir as TAB_HOVER_BEARS, j as LOCK_PATH, o as BEARS_PATH, or as TAB_HOVER_BOWL, p as CALLOUT_WELCOME_PATH, r as APP_NAME, s as BOARD_PATH, sn as SEO_TAB_CUP, sr as TAB_HOVER_CALLOUT_WELCOME, tr as TAB_HIVE, u as BOWL_HEADLINE, ur as TAB_HOVER_CUP, wn as SEO_TAB_OWL, z as OSS_ROADMAP_PATH, zn as TAB_CALLING_BOTS } from "./brand-D1W3F7j-.mjs";
import { _ as SeoImage, h as RainbowGodzillaText, m as Panel, s as GodzillaModeLabel, v as Shell } from "./shell-h_0UyERA.mjs";
import { t as SeoCopy } from "./seo-copy-0YpWT2tg.mjs";
import { n as SupportDonate } from "./support-donate-BwPtM1Kn.mjs";
import { O as FAQ_ITEMS } from "./router-D1mMBW2E.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/faq-QgS0NPGt.js
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Panel, {
							...
							children: [
								...
								item.id === "gm-board" || item.id === "spice-up" || item.id === "board-agents" || item.id === "board-humans" || item.id === "board-wallet" || item.id === "super-bowl" || item.id === "admin-bowl" || item.id === "world-cup" || item.id === "call-out-welcome" || item.id === "hive-swarm" || item.id === "hive-resource" || item.id === "byo-connect" || item.id === "byo-compute" || item.id === "lock3d-status" || item.id === "live-vs-sim" || item.id === "how-to-use" || item.id === "instructions" || item.id === "live-sim" || item.id === "go-live" || item.id === "oss-roadmap" || item.id === "pred-live-goal" || item.id === "s1r1us-predictions" || item.id === "pred-grant" || item.id === "pred-board" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									...
									}) : item.id === "go-live" || item.id === "oss-roadmap" || item.id === "pred-live-goal" ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
										to: OSS_ROADMAP_PATH,
										className: "text-oss hover:underline",
									...
									}) : item.id === "s1r1us-predictions" || item.id === "pred-grant" || item.id === "pred-board" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
										to: "/pr3d",
										className: "text-tab hover:underline",
										title: "S1R1US Pr3d1ctions",
										children: "Open S1R1US Pr3d1ctions — paper book"
