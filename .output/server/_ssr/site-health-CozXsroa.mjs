...
import { verifyAccessToken } from "./access.server-DqRB7q7_.mjs";
import { t as createServerRpc } from "./createServerRpc-CcvdN_gc.mjs";
import { n as guardedFetch, t as cloudflareDns } from "./net-guard-C4Si76ZP.mjs";
import { i as COIN_DOMAIN } from "./model-CKMVxB3T.mjs";
import { t as DO_INGRESS_A } from "./godaddy-dns-DCMIOqdf.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/site-health-CozXsroa.js
var hits = [];
function throttle() {
	const now = Date.now();
