...
import { a as getBaseURL, c as getProtocol, d as resolveBaseURL, f as wildcardMatch, i as PACKAGE_VERSION, l as isDynamicBaseURLConfig, n as GROK_PROVIDERS, o as getHost, r as NATIVE_X_PROVIDER_ID, s as getOrigin, t as GENERIC_OAUTH_ERROR_CODES, u as isRequestLike } from "./providers-AGnCJ8JQ.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/server-CTDe1qDd.js
		...
		hooks: { after: [{
			...
			handler: createAuthMiddleware(async (ctx) => {
				...
				if (returned instanceof Headers) {
					...
					const { setCookie } = await import("./server-Mq7o1Nh0.mjs").then((n) => n.t);
