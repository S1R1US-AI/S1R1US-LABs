import { A as preferredXAccountId, M as ensureDbReady, N as getPglite, O as looksLikeAdminX } from "./security--bvR_bJI.mjs";
...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/server-B0Itj6dR.js
		...
		hooks: { after: [{
			...
			handler: createAuthMiddleware(async (ctx) => {
				...
				if (returned instanceof Headers) {
					...
					const { setCookie } = await import("./server-DFlXc04R.mjs").then((n) => n.t);
