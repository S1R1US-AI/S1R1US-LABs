...
import { a as XRenewWhenAdmin, m as useCurrentUserState, n as Button, p as useCurrentUser } from "./renew-password-4zi8_z0w.mjs";
import { i as GROK_PROVIDERS } from "./server-DrYSoF3f.mjs";
import { d as Lock } from "../_libs/lucide-react.mjs";
import { C as YubiForm, d as LoginCluster, v as Shell, x as UserButton } from "./shell-DoIoNIED.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/login-ChXqSr4Z.js
...
function ResetPwordExpand({ plane }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
			type: "button",
			className: "text-expand font-medium",
			onClick: () => setOpen((v) => !v),
					...
					children: [
						GROK_PROVIDERS.map((p) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
							...
							onClick: () => {
								...
								}), new Promise((_, reject) => setTimeout(() => reject(/* @__PURE__ */ new Error("x-timeout")), 25e3))]).catch(() => {
