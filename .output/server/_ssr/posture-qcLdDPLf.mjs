...
//#region node_modules/.nitro/vite/services/ssr/assets/posture-qcLdDPLf.js
...
async function securityPosture(opts) {
	...
	try {
		const gate = await import("./agent-gate-DI8mmmai.mjs").then((n) => n.r);
		const wl = await import("./agent-gate-DI8mmmai.mjs").then((n) => n.l);
