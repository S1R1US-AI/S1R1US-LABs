...
import { Ht as SEO_CANONICAL, Vn as TAB_DESK, k as LABS_NAME, r as APP_NAME } from "./brand-1s5EgS5V.mjs";
import { h as RainbowGodzillaText, m as Panel, s as GodzillaModeLabel, u as LeaderBoardLabel, v as Shell } from "./shell-CF-JpJUO.mjs";
import { t as SeoCopy } from "./seo-copy-D19X5B18.mjs";
import { M as SITEMAP_LOCK_VIEWS, N as SITEMAP_MACHINE, j as PUBLIC_PAGES } from "./router-C6CO7gdi.mjs";
//#region ../../workspace/node_modules/.nitro/vite/services/ssr/assets/sitemap-Bih53ETN.js
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
				...
				children: [
					...
					". LoCK3D STATUS name click opens AI Agents, H1V3 SW@RM, 7-B0T AUTO, G M0D3 AUTO, G M0D3 M@NU@L, AI Agents LIVE. Crawlers: ",
					SEO_CANONICAL
				]
			}),
