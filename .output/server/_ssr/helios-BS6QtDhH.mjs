...
import { Or as TAB_LAB, n as APP_CALLS, r as APP_NAME } from "./brand-KjHNY1ry.mjs";
import { f as looksLikeSecret } from "./security-Cp6DEZcn.mjs";
import { n as runBots, t as heliosCall } from "./signal-orHlk4Pa.mjs";
import { r as STOP_DEFAULT, s as initialStop, u as usePaper } from "./store-oEyIFO9k.mjs";
import { n as askHelios } from "./grok-BhCNSoSo.mjs";
...
import { c as fgTone, n as Button, s as cn } from "./renew-password-Bx3_KB2s.mjs";
import { a as Radio } from "../_libs/lucide-react.mjs";
import { S as Shell, _ as Panel } from "./shell-BZ_Ba6g7.mjs";
import { a as PaperCard, d as stanceClass, i as HeliosCard, n as CallWords, s as bannerTone, u as money } from "./helios-card-C0mhRf7c.mjs";
import { t as TapeFreezeBanner } from "./tape-freeze-BFhbdhoE.mjs";
import { t as SeoCopy } from "./seo-copy-DmCfY7GY.mjs";
import { t as LiveTracks } from "./live-tracks-xo2aprkh.mjs";
//#region ../../workspace/node_modules/.nitro/vite/services/ssr/assets/helios-BS6QtDhH.js
...
var LAB_PRESETS = [
	{
		id: "live",
		name: "Live tape",
		blurb: "No overlay. 7-B0T reads the last validated pull.",
		knobs: { ...DEFAULT_KNOBS }
	},
	{
		id: "crash",
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					...
					children: preset === "custom" ? "Custom overlay — move a slider, 7-B0T re-runs on the live tape." : activeLab?.blurb
				}),
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
					...
					children: [
						"Paper NAV ",
						money(liveNav || 1e3, 0),
						". Clip is 1% NAV on ACCUMULATE, 2% on BUY, 1% on TRIM. Desk is the live view of bots 1–6 and 7-B0T. L@B is for strategy experiments only — knobs never write a feed."
					]
				})
			]
		})
...
function StructureBoard({ live, lab, whatIf }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Panel, {
		...
		title: whatIf ? "Live tape vs this lab" : "Live structure 7-B0T is reading",
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
