...
import { i as asiRows, n as agentSecurityStats, s as llmAgentRows } from "./agent-security-dJ5dmEbA.mjs";
import { a as firewallSummary, c as ingestIntel, i as firewallLayers, l as refreshIntel, o as headerPosture, r as cachedIntel, u as runHunter } from "./hunter-oKYFgqiE.mjs";
import { n as pciRows, r as pluginInventory, t as owaspRows } from "./control-map-CYwGTHQc.mjs";
import { readFileSync } from "node:fs";
//#region node_modules/.nitro/vite/services/ssr/assets/posture-CcPFCSmm.js
...
async function securityPosture(opts) {
	...
	try {
		const gate = await import("./agent-gate-iASVg-3_.mjs").then((n) => n.r);
		const wl = await import("./agent-gate-iASVg-3_.mjs").then((n) => n.l);
