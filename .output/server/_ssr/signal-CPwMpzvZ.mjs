import { c as MINER_TICKERS, g as clipForNav, s as MAG7_TICKERS, t as BOT_ROSTER } from "./proxy-book-DOFYn3ZO.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/signal-CPwMpzvZ.js
function roster(id) {
...
function heliosCall(snap, briefs, navUsd) {
	...
	else if (passed >= 3 && (twoSource || fg <= 35 || rsi != null && rsi < 40 || asiaDiscount || cheapVsGold || ratioCheap || macdDiscount)) stance = "ACCUMULATE";
