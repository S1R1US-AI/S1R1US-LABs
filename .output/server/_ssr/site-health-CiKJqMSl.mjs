import { i as COIN_DOMAIN } from "./model-DBjzYpgi.mjs";
import { r as createServerFn } from "./ssr.mjs";
import { verifyAccessToken } from "./access.server-CaZHHbCU.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/site-health-CiKJqMSl.js
var hits = [];
function throttle() {
	const now = Date.now();
