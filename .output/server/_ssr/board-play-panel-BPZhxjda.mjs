...
import { Bn as TAB_CALLOUT, N as MENU_BOARD, T as HIVE_DISCLAIMER, Wr as TAB_SPICE, t as APP_ADMIN_PATH, tr as TAB_HIVE } from "./brand-D1W3F7j-.mjs";
import { t as ANALYSIS_AS_OF } from "./security-BwwT3rcO.mjs";
import { t as alignmentScore } from "./alignment-CDukfrXE.mjs";
import { f as GM_NAME } from "./auto-window-BwThLGam.mjs";
import { t as LIVE_SIM_NAME } from "./live-sim-BsobJS8V.mjs";
import { n as morningInlineHref, r as morningPdfName, t as MORNING_TITLE } from "./morning-lib-D4ZKOXow.mjs";
import { a as morningPred, i as morningHtmlLinks, n as morningBadBots, o as morningSecurity, r as morningFeeds, t as morningAgent } from "./morning-ops-Bjs2ZPJI.mjs";
import { t as systemHealth } from "./system-health-wtq3Sjan.mjs";
...
import { t as useGm } from "./gm-store-Do40vTLk.mjs";
import { n as Button, s as cn } from "./renew-password-dhV3CJgU.mjs";
import { m as Download, o as Play, p as ExternalLink, s as Pause } from "../_libs/lucide-react.mjs";
import { _ as SeoImage, a as GmRainbow, l as HiveSwarmLabel, m as Panel, t as CallOutLabel, u as LeaderBoardLabel, y as SuperBowlLabel } from "./shell-h_0UyERA.mjs";
import { t as GoLivePanel } from "./go-live-panel-BgslqRIJ.mjs";
import { t as BowlLiveFeed } from "./bowl-live-feed-BhnN1MdV.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/board-play-panel-BPZhxjda.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Panel, {
		...
		children: [
			...
			brief.open.length ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
				...
				className: "mt-2 text-sm leading-relaxed text-fg",
				children: "None. G M0D3 AUTO + AI agents simulation is running with pause/stop for system and phone-app Admin. Data pulls follow sim. Stray practice is killed. S1R1US Pr3d1ctions stays paper. This host never places Coinbase orders."
			}),
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
				...
				children: [
					...
					"). Paper on Coinbase last. Includes S1R1US Pr3d1ctions (Ph0 W@ll3t / $42k ph0 BTC). Daily auto pause ",
					sim?.pauseEt ?? "07:00",
					" ET, morning report",
					" ",
					sim?.reportEt ?? "07:30",
