...
import { At as PAGE_TITLE_OSS_ROADMAP, Cn as SEO_TAB_OSS_ROADMAP, Fr as TAB_OSS_ROADMAP, Gt as SEO_CANONICAL, Sr as TAB_HOVER_OSS_ROADMAP, at as PAGE_DESC_OSS_ROADMAP, k as LABS_NAME, r as APP_NAME } from "./brand-D1W3F7j-.mjs";
import { m as GITHUB_URL } from "./model-CNb-iZ2J.mjs";
import { o as GO_LIVE_START, r as GO_LIVE_DEADLINE_LABEL, s as GO_LIVE_STEPS, t as GO_LIVE } from "./go-live-CaLXlH4n.mjs";
import { a as OSS_ROADMAP_AGENT_WELCOME, c as PRED_MONETIZATION, d as ossRoadmapPublic, i as LOCKED_FUNCTIONS, l as REAL_MONEY_PRED_ESTIMATE, n as FULL_LIVE_ESTIMATE, o as OSS_ROADMAP_HEADLINE, r as LIVE_FUNCTIONS, s as OSS_ROADMAP_PATH, t as DATED_MILESTONES, u as STATUS_LEGEND } from "./oss-roadmap-BXfG3jrB.mjs";
import { s as cn } from "./renew-password-dhV3CJgU.mjs";
import { h as RainbowGodzillaText, m as Panel, v as Shell } from "./shell-h_0UyERA.mjs";
import { t as SeoCopy } from "./seo-copy-0YpWT2tg.mjs";
import { t as QuantFlexWelcome } from "./quant-flex-welcome-C02NuFu0.mjs";
import { n as CollapseSummary } from "./collapse-summary-CSq-ftr1.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/roadmap-Blm4aarj.js
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
				...
				children: [
					...
					". Real-money S1R1US prediction market (live AI agent + Admin trading) is a ",
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", {
						className: "text-sell",
						children: "LOCKED"
					}),
					" future goal estimated",
					" ",
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", {
						className: "text-fg",
						children: REAL_MONEY_PRED_ESTIMATE.label
					}),
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Panel, {
				id: "pred-monetization",
				kicker: "Pred",
				title: "S1R1US Pr3d1ctions monetization (mandate-aligned only)",
				className: "mt-6",
				kickerClass: "text-tab",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
					...
					children: [
						...
						". Only options that keep accumulate-never-sell and gift/SaaS-only stay on the plan."
					]
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
					className: "divide-y divide-rule",
					children: PRED_MONETIZATION.map((f) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(StatusRow, {
						status: f.status,
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "flex flex-wrap items-baseline gap-x-3 gap-y-1",
							children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
				...
				children: [
					...
					". Proof of concept. Education only. Not financial advice."
				]
			})
		]
	}) });
