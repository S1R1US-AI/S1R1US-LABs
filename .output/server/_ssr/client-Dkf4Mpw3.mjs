...
import { a as getBaseURL, i as PACKAGE_VERSION, r as NATIVE_X_PROVIDER_ID, t as GENERIC_OAUTH_ERROR_CODES } from "./providers-DoZIBobl.mjs";
...
//#region ../../workspace/node_modules/.nitro/vite/services/ssr/assets/client-Dkf4Mpw3.js
var client_Dkf4Mpw3_exports = /* @__PURE__ */ __exportAll({
	a: () => signOut,
	i: () => signIn,
	n: () => client_exports,
	r: () => getBearerToken,
...
var client_exports = /* @__PURE__ */ __exportAll$1({
	NATIVE_X_PROVIDER_ID: () => NATIVE_X_PROVIDER_ID,
...
async function signIn(providerId, opts = {}) {
	...
	const { data, error } = providerId === "twitter" || providerId === "x" ? await authClient.signIn.social({
		provider: "twitter",
		callbackURL,
		errorCallbackURL
...
//#endregion
export { signOut as a, signIn as i, client_Dkf4Mpw3_exports as n, getBearerToken as r, authClient as t };
