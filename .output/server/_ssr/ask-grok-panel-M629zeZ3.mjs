...
import { b as PAGE_DESC_COMPUTE, st as SEO_TAB_COMPUTE, wt as TAB_COMPUTE } from "./brand-ByvcTltq.mjs";
import { r as getBearerToken } from "./client-Gq2WFxue.mjs";
import { m as useCurrentUserState, n as Button } from "./renew-password-BJlIO2uF.mjs";
import { f as LoaderCircle, r as ScanSearch } from "../_libs/lucide-react.mjs";
import { c as Panel } from "./shell-CiBE4AkH.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/ask-grok-panel-M629zeZ3.js
...
function AskGrokPanel({ kicker = "Ask Grok" }) {
	...
	const [question, setQuestion] = (0, import_react.useState)("Grade Bot 7 on this tape. Accumulate BTC — never short.");
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Panel, {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
				...
				children: [
					PAGE_DESC_COMPUTE,
					" Sign in with X for identity. Paste your xAI API key so Ask Grok spends",
					" ",
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: "text-fg",
						children: "your"
					}),
					" compute, not the operator SuperGrok bill. The key stays in this browser session — this host never stores it. ",
					SEO_TAB_COMPUTE,
					"."
				]
			}),
