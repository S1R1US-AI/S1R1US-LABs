...
import { O as TAB_GM } from "./brand-BYgKrfVF.mjs";
import { c as GM_CASH_STEP, d as GM_NAME, f as GM_PROFIT_BTC, l as GM_FUND_EXPLORER, m as GM_VAR_META, o as GM_CASH_MAX, p as GM_PROFIT_EXPLORER, s as GM_CASH_MIN, u as GM_FUND_USDC, v as dayTraderTf, y as gmCall } from "./auto-window-DwqBABJQ.mjs";
import { g as createSsrRpc, h as useOperator } from "./operator-BS2LwWEy.mjs";
import { _ as usePaper, g as useDeskTape } from "./store-DO7K-IX1.mjs";
import { f as rsiTone, i as USD_TONE, n as Button, s as cn, t as BTC_TONE } from "./renew-password-CuYHL_Bh.mjs";
import { a as LoginCluster, c as Shell, i as GodzillaMark, r as GmRainbow, s as Panel } from "./shell-rJtcWl2j.mjs";
import { a as bannerTone, o as money, t as CallWords } from "./helios-card-dh6swmQt.mjs";
import { t as SeoCopy } from "./seo-copy-DUFKDceQ.mjs";
import { a as useGm, s as usePractice } from "./router-B9W6sa7H.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/gm-MAMFSd4B.js
...
function isHighAccumulate(call) {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(GodzillaMark, { className: "h-12 w-[5.5rem] shrink-0" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Panel, {
						kicker: "GM call",
						title: isHighAccumulate(call) ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(GmRainbow, { text: `${call.conviction} ${call.stance}` }) : call ? `${call.conviction} ${call.stance}` : "Waiting on tape",
						kickerClass: bannerTone(call),
						titleClass: call && !isHighAccumulate(call) ? bannerTone(call) : call ? void 0 : "text-medium",
						children: [
							call ? isHighAccumulate(call) ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
								...
								children: [
									"Bot 7",
									" ",
									call ? isHighAccumulate(call.vsBot7) ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(GmRainbow, { text: `${call.vsBot7.conviction} ${call.vsBot7.stance}` }) : `${call.vsBot7.conviction} ${call.vsBot7.stance}` : "—",
...
function AutoLiveFeed({ call, px, lastTick, now, gmBook, gmTicks, bot7Ticks, paperCash, paperBtc }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Panel, {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "text-sm text-muted",
				children: "Live Coinbase tape. GM AUTO reads it with Bot 7. Coinbase orders stay off until Live is unlocked."
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "text-[11px] text-muted",
						children: "Call"
					}), call ? isHighAccumulate(call) ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(GmRainbow, { text: `${call.conviction} ${call.stance}` }) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
						className: "uppercase",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "text-tab",
							...
							" ",
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: call.stance === "ACCUMULATE" || call.stance === "BUY" ? "text-high" : "text-sell",
		...
		children: rows.map((r) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
				...
				children: [
					...
					" ·",
					" ",
					/HIGH(\s+CONVICTION)?\s+ACCUMULATE/.test(r.text) ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(GmRainbow, { text: r.text }) : r.text
				]
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
				className: "text-muted",
