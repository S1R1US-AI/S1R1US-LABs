...
import { a as firewallSummary, c as ingestIntel, i as firewallLayers, l as refreshIntel, o as headerPosture, r as cachedIntel, u as runHunter } from "./hunter-D-KpvGGA.mjs";
import { n as pciRows, r as pluginInventory, t as owaspRows } from "./control-map-CYwGTHQc.mjs";
import { readFileSync } from "node:fs";
//#region node_modules/.nitro/vite/services/ssr/assets/posture-DwCz_Xoz.js
...
async function securityPosture(opts) {
	...
	try {
		const gate = await import("./agent-gate-lxeWet1C.mjs").then((n) => n.r);
		const wl = await import("./agent-gate-lxeWet1C.mjs").then((n) => n.l);
