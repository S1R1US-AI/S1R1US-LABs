...
import { p as mandatePublic } from "./mandate-DWFG_LcU.mjs";
import { d as hiveResourcePublic } from "./hive-resource-BThKJHxr.mjs";
import { f as lockStatusView, t as LOCK_DEFAULT } from "./lock-status-CMXj-4We.mjs";
import { i as LOCKED_FUNCTIONS } from "./oss-roadmap-B2FCxwZA.mjs";
//#region ../../workspace/node_modules/.nitro/vite/services/ssr/assets/alignment-nHnmdtxs.js
var alignment_nHnmdtxs_exports = /* @__PURE__ */ __exportAll({
	n: () => alignment_exports,
	t: () => alignmentScore
});
...
function alignmentScore(hunterReport) {
	...
	const checks = [
		...
		check("s-pred-paper", "legal", "BTC prediction markets are 7-B0T overlay only — no paper book, no pred MCP bets, no fake wallets", !MCP_TOOLS.has("pred_list") && !MCP_TOOLS.has("pred_bet") && !MCP_TOOLS.has("pred_arm") && !MCP_TOOLS.has("pred_live") && !MCP_TOOLS.has("orders_create"), 3, "no pred_list/pred_arm/pred_bet; Polymarket/Kalshi overlay only")
	];
...
//#endregion
export { alignment_nHnmdtxs_exports as n, alignmentScore as t };
