...
import { Ht as SEO_CANONICAL, Vr as seoImgAlt, gr as TAB_HOVER_LOCK, j as LOCK_PATH, k as LABS_NAME, pr as TAB_HOVER_HIVE, rt as PAGE_DESC_LOCK, t as APP_ADMIN_PATH, tr as TAB_HOVER_BOARD } from "./brand-1s5EgS5V.mjs";
import { a as LOCK_IDS, c as TAB_LOCK3D, d as lockGifSrc, i as LOCK_GIF_OPEN_NAME, n as LOCK_GIF_CLOSED, o as LOCK_META, p as lockViewPath, r as LOCK_GIF_OPEN, s as SEO_TAB_LOCK3D } from "./lock-status-CMXj-4We.mjs";
import { s as cn } from "./renew-password-DaX2kF3V.mjs";
import { a as Radio } from "../_libs/lucide-react.mjs";
import { _ as SeoImage, m as Panel, v as Shell } from "./shell-CF-JpJUO.mjs";
import { i as LockHead, r as LockBoard } from "./lock3d-status-CdwfaJLl.mjs";
import { t as SeoCopy } from "./seo-copy-D19X5B18.mjs";
import { t as QuantFlexWelcome } from "./quant-flex-welcome-19FsWgFm.mjs";
import { n as CollapseSummary } from "./collapse-summary-BNyfUJRM.mjs";
import { a as LOCK_BANNER_ASK, c as LOCK_IMG_SEO, d as lockWelcomePublic, i as LOCK_AGENT_WELCOME, k as GITHUB_REPO_URL, l as LOCK_LIVE_VS_SIM, o as LOCK_HEADLINE, s as LOCK_HOW_TO_TOGGLE, u as LOCK_TUTORIAL } from "./router-C6CO7gdi.mjs";
//#region ../../workspace/node_modules/.nitro/vite/services/ssr/assets/l0ck-Bd2izG4K.js
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Panel, {
				...
				children: [LOCK_TUTORIAL.map((s) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
							to: "/pr3d",
							className: "pred-nav gold-css hover:underline",
							children: "PR3D1CT10N$"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
							to: "/agent",
