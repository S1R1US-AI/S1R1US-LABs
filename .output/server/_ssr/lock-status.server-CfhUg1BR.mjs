import { a as LOCK_IDS, d as lockStatusView, l as emptyFlags, p as normalizeFlags, t as LOCK_DEFAULT } from "./lock-status-CQ3k2p73.mjs";
import { n as lastGoodMeta } from "./tape-persist-CHN2yE-V.mjs";
import { r as stampGoLiveNotice } from "./go-live-notices-y5KTHj_G.mjs";
import { a as setAgentComm, i as isAgentCommOpen } from "./agent-gate-iASVg-3_.mjs";
import { s as setHiveStatus, t as hiveAdmin } from "./hive-swarm-BlY4eKCD.mjs";
import { o as predSimPaused, s as setPredBookLocked } from "./pred-book-3k6waxCi.mjs";
import { mkdirSync, readFileSync, writeFileSync } from "node:fs";
//#region node_modules/.nitro/vite/services/ssr/assets/lock-status.server-CfhUg1BR.js
...
function applySideEffects(prev, next, by) {
	...
	if (prev.locked.pred !== next.locked.pred) setPredBookLocked(next.locked.pred);
}
