...
import { b as COMPANY_X_URL } from "./tenancy-XVYWlKJ3.mjs";
import { Dr as seoImgAlt, E as LOCK_PATH, Gn as TAB_HOVER_BOARD, Nt as SEO_CANONICAL, X as PAGE_DESC_LOCK, or as TAB_HOVER_LOCK, rr as TAB_HOVER_HIVE, t as APP_ADMIN_PATH, w as LABS_NAME } from "./brand-Cg47htkS.mjs";
...
import { o as SEO_TAB_LOCK3D, s as TAB_LOCK3D } from "./lock-status-Da6B71U7.mjs";
import { i as LockName, r as LockGif } from "./lock3d-status-DiEAg4w9.mjs";
...
import { a as LOCK_BANNER_ASK, c as LOCK_IMG_SEO, d as lockWelcomePublic, i as LOCK_AGENT_WELCOME, k as GITHUB_REPO_URL, l as LOCK_LIVE_VS_SIM, o as LOCK_HEADLINE, s as LOCK_HOW_TO_TOGGLE, u as LOCK_TUTORIAL } from "./router-DpkJCcUF.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/l0ck-D0qUurKT.js
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Panel, {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
					...
					children: rows.length ? rows.map((row) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
						className: "flex flex-wrap items-center gap-x-3 gap-y-2 py-2.5",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(LockGif, { locked: row.locked }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					}, row.id)) : welcome.rails.map((row) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
						className: "py-2.5",
