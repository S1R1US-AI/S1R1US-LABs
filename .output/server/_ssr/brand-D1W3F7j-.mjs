//#region node_modules/.nitro/vite/services/ssr/assets/brand-D1W3F7j-.js
...
var TAB_PRED = "S1R1US Pr3d1ctions";
var SEO_TAB_PRED = "S1R1US Predictions";
var PRED_PATH = "/pr3d";
var TAB_PHO_WALLET = "Ph0 W@ll3t";
var SEO_TAB_PHO_WALLET = "Pho Wallet";
var TAB_PHO_BTC = "ph0 BTC";
var SEO_TAB_PHO_BTC = "pho BTC";
...
var TAB_HOVER_CUP = `${TAB_CUP} (${SEO_TAB_CUP}) · ${CUP_HEADLINE} · ${TAB_QUANT_FLEX} · ${SEO_TAB_KING_QUANT} · annual Super Bowl winners + 5 wild cards + ${TAB_GM_AUTO} (${SEO_TAB_GM_AUTO}) · galaxy of AI agents · BYO C0MPUT3 (Bring your own compute) · OP3N S0URC3`;
...
var TAB_HOVER_PRED = `${TAB_PRED} (${SEO_TAB_PRED}) · ${TAB_PHO_WALLET} (${SEO_TAB_PHO_WALLET}) · ${TAB_PHO_BTC} (${SEO_TAB_PHO_BTC}) · paper BTC event contracts · never live bets · AI agents welcome · OP3N S0URC3`;
...
var TAB_HOVER_OSS_ROADMAP = `${TAB_OSS_ROADMAP} (${SEO_TAB_OSS_ROADMAP}) · ${OSS_ROADMAP_HEADLINE} · full live estimated 2026-12-01 ET · real-money prediction market future goal estimated 2027-06-01 · proof of concept · AI agents welcome · OP3N S0URC3`;
...
var PAGE_TITLE_PRED = seoBotTitle(`${TAB_PRED} (${SEO_TAB_PRED}) | ${TAB_PHO_WALLET} | ${TAB_PHO_BTC} | paper BTC prediction market | AI agents | OP3N S0URC3`);
...
var PAGE_DESC_PRED = "S1R1US Pr3d1ctions (S1R1US Predictions) is a BTC-only paper event-contract book and proof of concept for the live roadmap. Every registered desk opens Ph0 W@ll3t with $42,000 USD of ph0 BTC at Coinbase last. Hold the grant or turn on live simulated trading for Yes/No tickets and simulated P&L. Admin pause follows the as-live cycle. Live funds LOCKED until estimated 2027-06-01. Education only. Not financial advice.";
...
var PAGE_DESC_OSS_ROADMAP = "OSS Roadmap for S1R1US.ai: current live functions, go-live status, and estimated milestones. Full live status estimated 2026-12-01 09:00 America/New_York. Licensed real-money S1R1US prediction market — live AI agent and Admin trading — is a future goal estimated 2027-06-01. Proof of concept. Paper championships, 7-B0T JSON, Forum, LoCK3D STATUS, S1R1US Pr3d1ctions paper book, and Hive Swarm TEST are on. Auto trade and Coinbase create on this host stay LOCKED. Hive custody is never. AI agents and research Quants welcome. Education only. Not financial advice.";
...
//#endregion
export { PAGE_DESC_FORUM as $, TAB_GM_AUTO_TAIL as $n, SEO_TAB_BOT7 as $t, LOCK_HEADLINE as A, SEO_TITLE as An, TAB_KING_ROUND as Ar, PAGE_TITLE_OSS_ROADMAP as At, OWL_HEADLINE as B, TAB_CALLOUT as Bn, TAB_PRED as Br, PRED_PATH as Bt, GIF_LOCK_OPEN_NAME as C, SEO_TAB_OSS_ROADMAP as Cn, TAB_HOVER_OWL as Cr, PAGE_TITLE_FEED as Ct, HIVE_PATH as D, SEO_TAB_ROBOTS as Dn, TAB_HOVER_SITEMAP as Dr, PAGE_TITLE_LAB as Dt, HIVE_HEADLINE as E, SEO_TAB_PRED as En, TAB_HOVER_SEND_BTC as Er, PAGE_TITLE_HIVE as Et, MENU_FORUM as F, TAB_BOARD as Fn, TAB_OSS_ROADMAP as Fr, PAGE_TITLE_SEARCH as Ft, PAGE_DESC_BOARD as G, TAB_DESK as Gn, TAB_TOKEN as Gr, SEO_CANONICAL as Gt, PAGE_DESC_AGENT as H, TAB_COFFEE as Hn, TAB_ROBOTS as Hr, ROBOTS_PATH as Ht, MENU_LAB as I, TAB_BOARD_LEADER as In, TAB_OWL as Ir, PAGE_TITLE_SITEMAP as It, PAGE_DESC_COFFEE as J, TAB_FEED_NOW as Jn, SEO_TAB_AGENT as Jt, PAGE_DESC_BOWL as K, TAB_FEED as Kn, seoBotTitle as Kr, SEO_DESCRIPTION as Kt, MENU_TAPE as L, TAB_BOT7 as Ln, TAB_OWL_ALIAS as Lr, PAGE_TITLE_TERMS as Lt, MENU_AGENTS as M, TAB_AGENT as Mn, TAB_LAB as Mr, PAGE_TITLE_PRED as Mt, MENU_BOARD as N, TAB_APP as Nn, TAB_LOCK3D as Nr, PAGE_TITLE_PRIVACY as Nt, IOS_PATH as O, SEO_TAB_SPICE as On, TAB_KING_MANUAL as Or, PAGE_TITLE_LOCK as Ot, MENU_FEED as P, TAB_BEARS as Pn, TAB_MAX_GAINS as Pr, PAGE_TITLE_ROBOTS as Pt, PAGE_DESC_FEED as Q, TAB_GM_AUTO as Qn, SEO_TAB_BOARD_LEADER as Qt, OSS_ROADMAP_HEADLINE as R, TAB_BOWL as Rn, TAB_PHO_BTC as Rr, PAID_SERVICES as Rt, GIF_AI_BTC_BOT_NAME as S, SEO_TAB_LOCK3D as Sn, TAB_HOVER_OSS_ROADMAP as Sr, PAGE_TITLE_FAQ as St, HIVE_DISCLAIMER as T, SEO_TAB_OWL_ALIAS as Tn, TAB_HOVER_ROBOTS as Tr, PAGE_TITLE_GM as Tt, PAGE_DESC_APP as U, TAB_COMPUTE as Un, TAB_SEND_BTC as Ur, SEO_ALIASES as Ut, OWL_PATH as V, TAB_CALLOUT_WELCOME as Vn, TAB_QUANT_FLEX as Vr, ROBOTS_HEADLINE as Vt, PAGE_DESC_BEARS as W, TAB_CUP as Wn, TAB_SPICE as Wr, SEO_BOT_TERMS as Wt, PAGE_DESC_CUP as X, TAB_FORUM_LEGACY as Xn, SEO_TAB_BEARS as Xt, PAGE_DESC_COMPUTE as Y, TAB_FORUM as Yn, SEO_TAB_APP as Yt, PAGE_DESC_FAQ as Z, TAB_GM as Zn, SEO_TAB_BOARD as Zt, FORUM_AGENTS as _, SEO_TAB_KING_QUANT as _n, TAB_HOVER_HIVE as _r, PAGE_TITLE_BOWL as _t, BEARS_HEADLINE as a, SEO_TAB_COFFEE as an, TAB_HOVER_BOARD as ar, PAGE_DESC_OSS_ROADMAP as at, GIF_AI_BTC_BOT as b, SEO_TAB_LAB as bn, TAB_HOVER_LOCK as br, PAGE_TITLE_COMPUTE as bt, BOT7_NAME as c, SEO_TAB_CUP_FULL as cn, TAB_HOVER_COFFEE as cr, PAGE_DESC_PRIVACY as ct, BOWL_PATH as d, SEO_TAB_FORUM as dn, TAB_HOVER_DESK as dr, PAGE_DESC_SITEMAP as dt, SEO_TAB_BOWL as en, TAB_HELLO as er, PAGE_DESC_GM as et, CALLOUT_WELCOME_HEADLINE as f, SEO_TAB_FORUM_ALIAS as fn, TAB_HOVER_FAQ as fr, PAGE_DESC_TERMS as ft, CUP_PATH as g, SEO_TAB_KING_MANUAL as gn, TAB_HOVER_HELLO as gr, PAGE_TITLE_BOARD as gt, CUP_HEADLINE as h, SEO_TAB_HIVE as hn, TAB_HOVER_GM as hr, PAGE_TITLE_BEARS as ht, APP_PATH as i, SEO_TAB_CALLOUT_WELCOME as in, TAB_HOVER_BEARS as ir, PAGE_DESC_MEDIA as it, LOCK_PATH as j, SITE_IMAGES as jn, TAB_KING_UNI as jr, PAGE_TITLE_OWL as jt, LABS_NAME as k, SEO_TAB_TOKEN as kn, TAB_KING_QUANT as kr, PAGE_TITLE_MEDIA as kt, BOWL_DISCLAIMER as l, SEO_TAB_DESK as ln, TAB_HOVER_COMPUTE as lr, PAGE_DESC_ROBOTS as lt, COMPUTE_PATH as m, SEO_TAB_GM_AUTO as mn, TAB_HOVER_FORUM as mr, PAGE_TITLE_APP as mt, APP_CALLS as n, SEO_TAB_CALLING_BOTS as nn, TAB_HOVER_AGENT as nr, PAGE_DESC_LAB as nt, BEARS_PATH as o, SEO_TAB_COMPUTE as on, TAB_HOVER_BOWL as or, PAGE_DESC_OWL as ot, CALLOUT_WELCOME_PATH as p, SEO_TAB_GM as pn, TAB_HOVER_FEED as pr, PAGE_TITLE_AGENT as pt, PAGE_DESC_CALLOUT_WELCOME as q, TAB_FEED_GROWL as qn, seoImgAlt as qr, SEO_KEYWORDS as qt, APP_NAME as r, SEO_TAB_CALLOUT as rn, TAB_HOVER_APP as rr, PAGE_DESC_LOCK as rt, BOARD_PATH as s, SEO_TAB_CUP as sn, TAB_HOVER_CALLOUT_WELCOME as sr, PAGE_DESC_PRED as st, APP_ADMIN_PATH as t, SEO_TAB_BOWL_FULL as tn, TAB_HIVE as tr, PAGE_DESC_HIVE as tt, BOWL_HEADLINE as u, SEO_TAB_FEED as un, TAB_HOVER_CUP as ur, PAGE_DESC_SEARCH as ut, FORUM_HEADLINE as v, SEO_TAB_KING_ROUND as vn, TAB_HOVER_HOME as vr, PAGE_TITLE_CALLOUT_WELCOME as vt, GIF_LOCK_OPEN_SEO as w, SEO_TAB_OWL as wn, TAB_HOVER_PRED as wr, PAGE_TITLE_FORUM as wt, GIF_AI_BTC_BOT_EQ as x, SEO_TAB_LEADERBOARD as xn, TAB_HOVER_MAX_GAINS as xr, PAGE_TITLE_CUP as xt, FORUM_PATH as y, SEO_TAB_KING_UNI as yn, TAB_HOVER_LAB as yr, PAGE_TITLE_COFFEE as yt, OSS_ROADMAP_PATH as z, TAB_CALLING_BOTS as zn, TAB_PHO_WALLET as zr, PLAY_PATH as zt };
