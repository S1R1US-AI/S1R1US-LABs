...
import { Ir as TAB_HIVE, Ti as TAB_SPICE, Y as HIVE_DISCLAIMER, _i as TAB_MINERS, er as SEO_TAB_MINERS, lt as MINERS_DISCLAIMER, rt as MENU_BOARD, t as APP_ADMIN_PATH, xr as TAB_CALLOUT } from "./brand-CDqF9nyU.mjs";
import { _ as minerAddressError, b as stratumUrl, c as MINERS_STRATUM_SCHEME, d as bucketMinerSamples, f as ckpoolStatsUrl, h as fmtThs, i as MINERS_DEFAULT_STRATUM, l as MINER_TIMEFRAMES, n as MINERS_DEFAULT_ADDRESS, o as MINERS_INSTRUCTIONS, r as MINERS_DEFAULT_BACKUP, s as MINERS_PASSWORD_NOTE, y as stratumError } from "./btc-miners-C_ITq4f_.mjs";
import { S as require_jsx_runtime, U as require_react, v as Link } from "../_libs/@tanstack/react-router+[...].mjs";
import { t as ANALYSIS_AS_OF } from "./security-htqI4xhk.mjs";
...
import { a as RefreshCw, c as Pickaxe, g as Download, h as ExternalLink, i as Save, l as Pause, s as Play } from "../_libs/lucide-react.mjs";
import { C as SuperBowlLabel, _ as Panel, a as GmRainbow, l as HiveSwarmLabel, t as CallOutLabel, u as LeaderBoardLabel, x as SeoImage } from "./shell-DhzBcQbb.mjs";
import { n as morningInlineHref, r as morningPdfName, t as MORNING_TITLE } from "./morning-lib-D4ZKOXow.mjs";
import { t as alignmentScore } from "./alignment-DWIh0CIf.mjs";
import { a as morningPred, i as morningHtmlLinks, n as morningBadBots, o as morningSecurity, r as morningFeeds, t as morningAgent } from "./morning-ops-YoBm8EPR.mjs";
import { f as GM_NAME } from "./auto-window-D9gd5Rg8.mjs";
import { t as LIVE_SIM_NAME } from "./live-sim-C2yWsSkm.mjs";
import { t as systemHealth } from "./system-health-vBKbEiFG.mjs";
...
import { t as useGm } from "./gm-store-CsQqY9_F.mjs";
import { t as GoLivePanel } from "./go-live-panel-hR6b_pGf.mjs";
import { t as BowlLiveFeed } from "./bowl-live-feed-CVoMljcf.mjs";
import { a as YAxis, c as Line, g as Tooltip, h as ResponsiveContainer, l as CartesianGrid, o as XAxis, s as Area, t as ComposedChart } from "../_libs/recharts+[...].mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/btc-miners-panel-ROIof3iM.js
...
function SecurityMorningSection() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Panel, {
		...
		children: [
			...
			brief.s3c ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: cn("mt-1 font-mono text-sm", brief.s3c.fail === 0 ? "text-high" : "text-sell"),
				children: brief.s3c.headline
			}) : null,
			brief.owl ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
				className: cn("mt-1 font-mono text-xs", brief.owl.score >= 90 ? "text-high" : "text-sell"),
				children: [
					"W1S3 0WL$ security ",
					brief.owl.score,
					"/100 — ",
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
				...
				children: [
					...
					" ",
					sim?.reportEt ?? "07:30",
					" ET, then resume. System Admin and phone-app Admin may pause. Championship World Cup / C@LL 0UT pause is also system Admin and phone-app Admin. Old practice ticks stay off. Checkpoint stays synced with the desk build. Conflict rebases to baseline DEPLOY #68 LIVE with pause allowed. Current fold is S1R1US App build #113 (live sim launch)."
				]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "mt-2 font-mono text-xs text-muted",
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("dl", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("dt", {
						...
						children: [sim?.label ?? "S1R1US App build #113", sim?.synced ? " · synced" : " · desync"]
					})] }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("dt", {
						className: "text-muted",
						children: "Status"
...
*/
var fetchBtcMiners = createServerFn({ method: "POST" }).validator((input) => input).handler(createSsrRpc("b362f7977f60bf3a07a7b092135628c037bdd92c14111c6c9f73719c4fb90045"));
var saveBtcMiners = createServerFn({ method: "POST" }).validator((input) => input).handler(createSsrRpc("dd627f16b08fd625ddcdb5e70b03e75ced60f170f83a09f88a23a79a71f378f5"));
/** Pro trading desk palette: bright green tape, yellow + blue contrasts. */
var HASH_GREEN = "#39ff14";
var HASH_YELLOW = "#ffd024";
var HASH_BLUE = "#38bdf8";
function fmtAgo(sec) {
	const s = Number(sec);
	if (!Number.isFinite(s) || s <= 0) return "—";
	const d = Math.floor(Date.now() / 1e3) - s;
	if (d < 0) return "now";
...
function BtcMinersPanel({ token }) {
	...
	async function save() {
		...
		setSaved(null);
		try {
			const res = await saveBtcMiners({ data: {
				token,
				config: {
					stratum,
					backup,
			...
			applyRes(res);
			if (res.ok) setSaved(stratum.trim() || backup.trim() || address.trim() ? `Saved — ${TAB_MINERS} data and view rebuilt for your stratum.` : "Saved blank — S1R1US.ai CKPool data populated the dialogue boxes.");
		} catch (e) {
	...
	const graph = (0, import_react.useMemo)(() => bucketMinerSamples(view?.samples ?? [], frame), [view?.samples, frame]);
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Panel, {
				...
				title: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Pickaxe, {
						className: "size-5",
						style: { color: HASH_GREEN }
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", {
								href: view?.statsUrl ?? ckpoolStatsUrl("33kmWvmf3nz3255dGmbHxigb9X6Szv6cJ8"),
								target: "_blank",
								rel: "noreferrer",
								className: "font-mono text-oss hover:underline",
								children: view?.statsUrl ?? ckpoolStatsUrl("33kmWvmf3nz3255dGmbHxigb9X6Szv6cJ8")
							}),
					...
					view?.error && !err ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(MinerMetric, {
								label: "Hash 1m",
								value: fmtThs(view?.ths.m1),
								color: HASH_GREEN
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(MinerMetric, {
								label: "Hash 5m",
								value: fmtThs(view?.ths.m5),
								color: HASH_YELLOW
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(MinerMetric, {
								label: "Hash 1hr",
								value: fmtThs(view?.ths.h1),
								color: HASH_BLUE
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(MinerMetric, {
								label: "Hash 1d",
								value: fmtThs(view?.ths.d1)
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(MinerMetric, {
								label: "Hash 7d",
								value: fmtThs(view?.ths.d7)
							})
						]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("dl", {
						className: "mt-3 grid grid-cols-2 gap-2 font-mono text-xs sm:grid-cols-5",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("dt", {
								className: "text-muted",
								children: "Workers"
								...
								className: "text-fg",
								children: stats ? stats.workers.toLocaleString("en-US") : "—"
							})] }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("dt", {
								className: "text-muted",
								children: "Last share"
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("dd", {
								className: active ? "text-high" : "text-medium",
								children: fmtAgo(stats?.lastshare)
							})] }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("dt", {
								className: "text-muted",
								children: "Shares"
								...
								className: "text-fg",
								children: fmtShare(stats?.shares)
							})] }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("dt", {
								className: "text-muted",
								children: "Best share"
								...
								className: "text-fg",
								children: fmtShare(stats?.bestshare)
							})] }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("dt", {
								className: "text-muted",
								children: "Best ever"
								...
								className: "text-fg",
								children: fmtShare(stats?.bestever)
							})] })
						]
					})
				]
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Panel, {
				kicker: "Hash power",
				title: "Oscillating hash power — bright green tape",
				kickerClass: "text-high",
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
						className: "font-mono text-xs text-muted",
						children: ["Time frame", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("select", {
							...
							children: MINER_TIMEFRAMES.map((f) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", {
								value: f.id,
								children: f.label
							}, f.id))
						})]
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								style: { color: HASH_YELLOW },
								children: "■ 5m avg"
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								style: { color: HASH_BLUE },
								children: "■ 1hr avg"
							})
						]
					})]
				}), graph.length > 1 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "mt-3 h-64",
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(ComposedChart, {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Tooltip, {
									...
									formatter: (v, name) => [fmtThs(v), name]
								}),
					...
					children: "Collecting hash power samples from solo CKPool — the graph draws itself as this desk polls the free public stats (styled after the CKPool miner explorer graphs). Keep the miners active and check back."
				})]
			}),
			stats?.worker?.length ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Panel, {
				kicker: "Rigs",
				title: "Workers on the pool",
				kickerClass: "text-tab",
				titleClass: "text-tab",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "overflow-x-auto",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("table", {
						className: "w-full min-w-[36rem] text-left font-mono text-xs",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("thead", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", {
						...
						}) }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tbody", { children: stats.worker.map((w) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
									...
									style: { color: HASH_GREEN },
									children: w.hashrate1m
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
									className: "py-1.5 pr-2",
									style: { color: HASH_BLUE },
									children: w.hashrate1hr
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
									className: "py-1.5 pr-2 text-fg",
									children: w.hashrate1d
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
									className: "py-1.5 pr-2 text-muted",
									children: fmtAgo(w.lastshare)
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
									className: "py-1.5",
									style: { color: HASH_YELLOW },
									children: fmtShare(w.bestshare)
								})
							]
						}, w.workername)) })]
					})
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Panel, {
				kicker: "Your stratum",
				title: "Miner dialogue boxes — update only your own",
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
						...
						children: [
							...
							scope ? ` (this session: ${scope === "system" ? "s1r1us.ai system admin" : "app copy admin"})` : "",
							". Enter your own CKPool miner information and hit Save to rebuild the ",
							TAB_MINERS,
							" data and view. Leave a box blank and hit Save = the S1R1US.ai CKPool data populates the dialogue boxes. ",
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
								...
								children: [
									...
									stratumBad ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: "mt-1 block text-xs text-sell",
										children: stratumBad
									}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: "mt-1 block text-xs text-muted",
										children: stratumUrl(stratum)
									})
								]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
								...
								children: [
									...
									backupBad ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: "mt-1 block text-xs text-sell",
										children: backupBad
									}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: "mt-1 block text-xs text-muted",
										children: stratumUrl(backup || "solo.ckpool.org:443")
									})
								]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
								...
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: "text-muted",
										children: "BTC receiving address for the miners (default = S1R1US.ai system admin BTC key)"
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
										value: address,
									...
									addressBad ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: "mt-1 block text-xs text-sell",
										children: addressBad
									}) : null
								]
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
								variant: "primary",
								onClick: () => void save(),
								disabled: busy || Boolean(stratumBad || backupBad || addressBad),
								children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
								onClick: () => void load(),
								disabled: busy,
								"aria-label": "Refresh miner stats",
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("ol", {
						className: "mt-4 list-decimal space-y-1 pl-5 text-xs leading-relaxed text-muted",
...
function MinerMetric({ label, value, color }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "min-w-0",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
			className: "text-[10px] font-medium tracking-[0.08em] uppercase leading-tight text-muted",
			children: label
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
			className: "mt-0.5 truncate font-mono text-base tabular-nums tracking-tight sm:text-lg",
...
//#endregion
export { LiveSimPanel as a, HiveAdminPanel as i, BtcMinersPanel as n, MorningReportPdf as o, ChampionshipSimPanel as r, BoardPlayPanel as t };
