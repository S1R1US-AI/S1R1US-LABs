...
import { An as TAB_CUP, At as ROBOTS_PATH, Dn as TAB_CALLOUT_WELCOME, E as LOCK_PATH, Fn as TAB_FORUM, Gn as TAB_HOVER_BOARD, Ht as SEO_TAB_BOWL, Kn as TAB_HOVER_BOWL, Kt as SEO_TAB_CALLOUT_WELCOME, Mn as TAB_FEED, N as OWL_HEADLINE, Nt as SEO_CANONICAL, O as MENU_BOARD, On as TAB_COFFEE, P as OWL_PATH, S as HIVE_PATH, Sr as TAB_ROBOTS, T as LOCK_HEADLINE, Tn as TAB_CALLING_BOTS, Vn as TAB_HIVE, W as PAGE_DESC_FAQ, Wn as TAB_HOVER_BEARS, Xn as TAB_HOVER_CUP, Yt as SEO_TAB_CUP, _r as TAB_LOCK3D, a as BEARS_HEADLINE, bn as TAB_BEARS, cr as TAB_HOVER_OWL, d as BOWL_PATH, dn as SEO_TAB_OWL, f as CALLOUT_WELCOME_HEADLINE, g as CUP_PATH, gr as TAB_LAB, h as CUP_HEADLINE, jn as TAB_DESK, kt as ROBOTS_HEADLINE, lr as TAB_HOVER_ROBOTS, o as BEARS_PATH, or as TAB_HOVER_LOCK, p as CALLOUT_WELCOME_PATH, pn as SEO_TAB_ROBOTS, pt as PAGE_TITLE_FAQ, qn as TAB_HOVER_CALLOUT_WELCOME, r as APP_NAME, rr as TAB_HOVER_HIVE, s as BOARD_PATH, u as BOWL_HEADLINE, wn as TAB_BOWL, wr as TAB_SPICE, x as HIVE_HEADLINE, yr as TAB_OWL } from "./brand-Cg47htkS.mjs";
import { _ as Shell, g as SeoImage, m as RainbowGodzillaText, p as Panel, s as GodzillaModeLabel } from "./shell-BgY-wW2B.mjs";
import { t as SeoCopy } from "./seo-copy-Btk8Y62l.mjs";
import { n as SupportDonate } from "./support-donate-D9MMxVDy.mjs";
import { O as FAQ_ITEMS } from "./router-DpkJCcUF.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/faq-I2NDxyTe.js
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Panel, {
							...
							children: [
								...
								item.id === "gm-board" || item.id === "spice-up" || item.id === "board-agents" || item.id === "board-humans" || item.id === "board-wallet" || item.id === "super-bowl" || item.id === "admin-bowl" || item.id === "world-cup" || item.id === "call-out-welcome" || item.id === "hive-swarm" || item.id === "hive-resource" || item.id === "byo-connect" || item.id === "byo-compute" || item.id === "lock3d-status" || item.id === "live-vs-sim" || item.id === "how-to-use" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									...
									}) : item.id === "lock3d-status" || item.id === "live-vs-sim" || item.id === "how-to-use" ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
										to: LOCK_PATH,
