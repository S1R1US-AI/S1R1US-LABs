...
import { Ht as PAGE_DESC_WHITE, Oi as TAB_WHITE, _i as TAB_MINERS, dt as MINERS_PATH, er as SEO_TAB_MINERS } from "./brand-CDqF9nyU.mjs";
import { c as MINERS_STRATUM_SCHEME, i as MINERS_DEFAULT_STRATUM, n as MINERS_DEFAULT_ADDRESS, r as MINERS_DEFAULT_BACKUP } from "./btc-miners-C_ITq4f_.mjs";
import { S as require_jsx_runtime, U as require_react } from "../_libs/@tanstack/react-router+[...].mjs";
import { C as whiteLabelMinerConfig, S as whiteLabelGoLive, _ as WHITE_LABEL_WATCH, a as OSS_LICENSE_NOTICE, b as emptyWhiteLabelConfig, c as WHITE_LABEL_DISCLOSURE_LINKS, d as WHITE_LABEL_LEGAL_STATUS, g as WHITE_LABEL_USER_AGREEMENT, h as WHITE_LABEL_STRIP, l as WHITE_LABEL_DOWNLOAD_URL, m as WHITE_LABEL_STAGE, o as SYSTEM_ADMIN_OVERRIDE, p as WHITE_LABEL_PRIVILEGES, s as WHITE_LABEL_BUILDERS, u as WHITE_LABEL_KEEP_MINERS, x as fieldBlocked, y as builderPrompt } from "./white-label-BD831BeM.mjs";
import { n as Button } from "./renew-password-CgrcnRVg.mjs";
import { S as Shell, _ as Panel } from "./shell-DhzBcQbb.mjs";
import { t as SeoCopy } from "./seo-copy-DPXIBeSr.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/wh1t3-CfEQrtCx.js
...
function WhiteLabelPage() {
	...
	const [minerSaved, setMinerSaved] = (0, import_react.useState)(null);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Shell, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
				className: "legal-purple mt-2 max-w-3xl text-sm font-semibold leading-relaxed",
				children: ["LEGAL STATUS: ", WHITE_LABEL_LEGAL_STATUS]
			}),
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Panel, {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						...
						children: WHITE_LABEL_KEEP_MINERS
					}),
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Panel, {
				className: "mt-4",
				kicker: "Disclosures",
				title: `DISCLOSURE LINKS + USER AGREEMENT (${WHITE_LABEL_STAGE})`,
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
						className: "text-sm leading-relaxed text-muted",
						children: [
							"Any downloaded free copy of the S1R1US.ai White Label product (",
							WHITE_LABEL_STAGE,
							") must include these DISCLOSURE LINKS:"
						]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
						className: "mt-2 space-y-1 font-mono text-xs",
						children: WHITE_LABEL_DISCLOSURE_LINKS.map((l) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
							className: "text-muted",
							children: [l.label, ": "]
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
						...
						children: WHITE_LABEL_USER_AGREEMENT.map((s) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: s }, s))
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "mt-3 text-sm font-semibold text-fg",
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						...
						children: WHITE_LABEL_LEGAL_STATUS
					})
				]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Panel, {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "mt-2 grid gap-3 sm:grid-cols-2",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Box, {
							label: MINERS_STRATUM_SCHEME,
							value: cfg.minerStratum,
							onChange: (v) => set("minerStratum", v),
							placeholder: MINERS_DEFAULT_STRATUM
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Box, {
							label: `Backup pool (${MINERS_STRATUM_SCHEME})`,
							value: cfg.minerBackup,
							onChange: (v) => set("minerBackup", v),
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
							onClick: () => setMinerSaved(whiteLabelMinerConfig(cfg)),
							children: ["Save — rebuild ", TAB_MINERS]
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
							href: MINERS_PATH,
							className: "text-xs text-oss hover:underline",
							children: [
								TAB_MINERS,
								" setup + FAQ: ",
								MINERS_PATH
					...
					minerSaved ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
						className: "mt-2 font-mono text-xs text-up",
						children: [
							TAB_MINERS,
							" rebuilt · ",
							...
							" · BTC ",
							minerSaved.address,
							cfg.minerStratum.trim() || cfg.minerBackup.trim() || cfg.minerBtcAddress.trim() ? "" : " — no stratum entered, so the S1R1US.ai CKPool data populated the dialogue boxes."
						]
					}) : null,
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
