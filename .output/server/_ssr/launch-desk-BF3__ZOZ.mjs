...
import { H as require_react, v as Link, x as require_jsx_runtime, y as Navigate } from "../_libs/@tanstack/react-router+[...].mjs";
import { r as createServerFn } from "./ssr.mjs";
import { a as COMPANY_X_BANNER, i as COMPANY_X_AVATAR, n as ADMIN_X_LABEL, r as COMPANY_X_ART, s as COMPANY_X_LABEL, t as ADMIN_X_HANDLE } from "./x-admin-SEv9ocnZ.mjs";
import { h as TAB_LAB, n as APP_NAME, p as TAB_DESK } from "./brand-Bnp79fYI.mjs";
import { c as loadDeskVault, f as secondFactorStatus, g as createSsrRpc, h as useOperator } from "./operator-D_-RuOB2.mjs";
import { n as create, t as persist } from "../_libs/zustand.mjs";
import { C as PLATFORM_ROWS, D as ROADMAP_TOTAL, E as ROADMAP_STEALTH, O as TIERS, S as OSS_NEEDS, T as ROADMAP, _ as LIQ_BANDS, a as COIN_NAME_NOTE, c as COMPANY_X_STEPS, d as FUND_INTEGRATION, f as FUND_LANES, g as ICP_NOTE, h as HOWEY_POSTURE, i as COIN_DOMAIN, k as TOKEN_UTILITY, l as DNS_STEPS, m as GODADDY_IO, n as CHECKLIST, o as COIN_STANDARD, p as GITHUB_URL, r as COIN_CHAIN_REC, s as COIN_TICKER, t as BUDGET, u as DOMAINS, v as MINT_FLOOR, w as RH_NOTE, y as MINT_STEPS } from "./model-CLHae-Ip.mjs";
import { i as USD_TONE, n as Button, s as cn, t as BTC_TONE } from "./renew-password-DdGxE7hW.mjs";
import { c as Shell, s as Panel, t as CompanyAvatar } from "./shell-kQ1LdHos.mjs";
import { o as money } from "./helios-card-DZHq0XsL.mjs";
import { n as SystemOverview } from "./system-overview-DWuMUw6K.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/launch-desk-BF3__ZOZ.js
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
				...
				children: [
					...
					", not ",
					TAB_DESK,
					", not how bot 7 buys bitcoin. Desk book = operator cash + gifts that get nothing back. Same admin door. Bot 7 never trades this ticker. TOKEN_LAUNCHED =",
					" ",
					"false",
					"."
				]
				...
				children: [
					...
					health ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
								className: "text-muted",
								children: ["www ", health.wwwCname.join(" ") || "—"]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
								className: "text-muted",
								children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
						...
						children: [
							"To put this tape on s1r1us.ai: in Grok use ",
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "font-medium",
								children: "Publish"
							}),
							" ",
							"(you get a grok.me link), then ",
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "font-medium",
								children: "custom domain"
							}),
							" → add s1r1us.ai. Copy the records Grok shows. Leave the current A/CNAME until then — they already reach Vercel; SSL stays invalid until the domain is attached."
						]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("ol", {
						className: "mt-4 list-decimal space-y-2 pl-5 text-sm",
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Panel, {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
						className: "mt-3 text-xs text-muted",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Pick the handle on X, then tell this desk. " }),
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Panel, {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "mt-3 text-xs text-muted",
						children: "Figures are 2026 street ranges. pump.fun mint is $0 — do not budget $150k as seed LP. SuperGrok stays the only paid data service on the trading desk. Token legal is a different bill."
					})
				]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Panel, {
