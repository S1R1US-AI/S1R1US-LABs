...
import { n as APP_NAME } from "./brand-BKM5q_W_.mjs";
import { i as signIn } from "./client-Gq2WFxue.mjs";
import { f as secondFactorStatus, h as useOperator } from "./operator-2NQMIkHh.mjs";
import { a as XRenewWhenAdmin, m as useCurrentUserState, n as Button, p as useCurrentUser } from "./renew-password-D1GMSGy3.mjs";
import { i as GROK_PROVIDERS } from "./server-B1BMxYWD.mjs";
import { d as Lock } from "../_libs/lucide-react.mjs";
import { c as UserButton, i as LoginCluster, s as Shell } from "./shell-DL0EAAfV.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/login-vFJDZ_29.js
				...
				!user ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						xAdmin ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							...
							children: "This X session is not the operator account. Sign out, then Continue with X again as the operator handle — the desk reads the handle from X, not the display name."
						}),
