...
//#region ../../workspace/node_modules/.nitro/vite/services/ssr/assets/sources-CKvzXHSu.js
...
async function buildSnapshot() {
	try {
		const { ensureLiveSimScheduler } = await import("./live-sim.server-zPq67qyn.mjs");
