...
//#region node_modules/.nitro/vite/services/ssr/assets/posture-CFcIYj03.js
...
async function securityPosture(opts) {
	...
	try {
		const gate = await import("./agent-gate-BxSAbUAo.mjs").then((n) => n.r);
		const wl = await import("./agent-gate-BxSAbUAo.mjs").then((n) => n.l);
