...
import { _ as looksLikeCompanyX, c as COMPANY_X_HANDLE, d as COMPANY_X_LOGO_NAME, f as COMPANY_X_NAME, i as COMPANY_X_AVATAR, l as COMPANY_X_LABEL } from "./x-admin-CALKyy-K.mjs";
import { $ as MENU_FORUM, Br as TAB_HOVER_HIVE, Dr as TAB_HOVER_BEARS, Er as TAB_HOVER_APP, Fn as SEO_TAB_HIVE, Fr as TAB_HOVER_FAQ, Hr as TAB_HOVER_LAB, Ir as TAB_HOVER_FEED, Jr as TAB_HOVER_ROBOTS, Kr as TAB_HOVER_OWL, Lr as TAB_HOVER_FORUM, Mr as TAB_HOVER_COMPUTE, Nn as SEO_TAB_GM, Or as TAB_HOVER_BOARD, Pn as SEO_TAB_GM_AUTO, Pr as TAB_HOVER_DESK, Q as MENU_FEED, Qr as TAB_KING_MANUAL, Rr as TAB_HOVER_GM, Tr as TAB_HOVER_AGENT, Vr as TAB_HOVER_HOME, X as MENU_AGENTS, Xr as TAB_HOVER_SITEMAP, Z as MENU_BOARD, Zr as TAB_HOVER_SPONSOR, _ as FORUM_AGENTS, br as TAB_GM, dr as TAB_COFFEE, ei as TAB_KING_ROUND, er as SPONSOR_PATH, et as MENU_LAB, fr as TAB_COMPUTE, jr as TAB_HOVER_COFFEE, lr as TAB_CALLOUT, nr as TAB_APP, oi as TAB_OWL, pi as TAB_SPONSOR, pr as TAB_CUP, q as LABS_NAME, r as APP_NAME, rr as TAB_BEARS, sr as TAB_BOWL, ti as TAB_KING_UNI, tr as TAB_AGENT, tt as MENU_TAPE, ui as TAB_ROBOTS, vi as seoImgAlt, wr as TAB_HIVE, xr as TAB_GM_AUTO } from "./brand-DuaUmsed.mjs";
import { f as looksLikeSecret } from "./security-CQDQQ6Fu.mjs";
import { S as OSS_LINK_LABEL, x as OSS_LINK } from "./model-CKMVxB3T.mjs";
import { n as LEGAL_DISCLAIMER_PARAS } from "./disclaimer-BUZ1ShSW.mjs";
import { c as PRIVACY_PATH, f as TERMS_HOVER, h as TERMS_TITLE, p as TERMS_PATH, s as PRIVACY_HOVER, u as PRIVACY_TITLE } from "./legal-D3Eg702J.mjs";
import { p as xSignInProviderId } from "./providers-AGnCJ8JQ.mjs";
import { a as signOut, i as signIn } from "./client-Dp7wcF1K.mjs";
import { m as secondFactorStatus, v as useOperator } from "./operator-Bi5PjJBI.mjs";
import { a as XRenewWhenAdmin, m as useCurrentUserState, n as Button, p as useCurrentUser, s as cn } from "./renew-password-DgmoQopP.mjs";
import { d as Lock, l as LogOut, u as LogIn } from "../_libs/lucide-react.mjs";
import { B as GM_BURST_MS, V as rainGmBurst } from "./router-P39z53mw.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/shell-C0cyFbMt.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
		...
		children: [
			...
			userOnly ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				...
				children: "This login is a desk user. Admin on s1r1us.ai is only the operator X plus name and password (two YubiKeys). iOS / Google copy Admin is on the downloaded app."
			}) : null,
			...
			!user ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
					...
					children: [
						"Admin needs the operator X account, then name and password. Two physical YubiKeys (primary + backup) are the 2FA backup. Other X accounts and desk users stay users — they cannot open s1r1us.ai Admin, Wallet, or send. iOS / Google download Admin is a separate lock on the",
						" ",
...
var SEO_TAB_PRED = "AI Agent Prediction Market";
var PRED_PATH = "/pr3d";
var PRED_HEADLINE = "AI Agent Prediction Market — education experiment";
var PRED_DISCLAIMER = "PR3D1CT10N$ is an AI Agent Prediction Market education experiment. Fake token S1R1U$ ($ cannot mint a live token). Grant 4,200 paper S1R1U$. Ph0 W@ll3t is off. Polymarket and Kalshi stay a 7-B0T overlay. This host never takes bets. Proof of concept. Education only.";
...
function DisclaimerExpandBody() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "space-y-2",
		children: [LEGAL_DISCLAIMER_PARAS.map((p) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
			className: "w-full text-justify font-mono text-[10px] leading-relaxed text-muted",
			children: p
		}, p.slice(0, 24))), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					className: "legal-purple text-[11px] font-bold tracking-[0.16em] uppercase",
					children: "DISCLAIMER"
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					className: "expand-ctl font-mono text-[10px] tracking-[0.08em]",
					children: open ? "collapse −" : "expand +"
				})]
			}), open ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				id: "disclaimer-full",
				className: "mt-2 w-full max-w-none",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DisclaimerExpandBody, {})
			}) : null]
		})
	});
}
...
//#endregion
export { SuperBowlLabel as C, WorldCupLabel as D, UserButton as E, YubiForm as O, Shell as S, UniversalKingLabel as T, Panel as _, GmRainbow as a, SEO_TAB_PRED as b, GoldCss as c, LoginCluster as d, ManualKingLabel as f, PRED_PATH as g, PRED_HEADLINE as h, GmAutoLabel as i, HiveSwarmLabel as l, PRED_DISCLAIMER as m, CompanyAvatar as n, GodzillaMark as o, OperatorGate as p, ForumTitle as r, GodzillaModeLabel as s, CallOutLabel as t, LeaderBoardLabel as u, RainbowGodzillaText as v, TAB_PRED as w, SeoImage as x, RoundKingLabel as y };
