...
import { c as grokRateLimit, l as grokUsage, s as assertSafePayload } from "./security-CQDQQ6Fu.mjs";
import { storedAdminName, verifyAccessToken, verifyDeskToken } from "./access.server-DqRB7q7_.mjs";
import { t as createServerRpc } from "./createServerRpc-CcvdN_gc.mjs";
import { n as guardedFetch } from "./net-guard-C4Si76ZP.mjs";
import { c as predAnalyst } from "./prediction-markets-DPrcskFN.mjs";
import { n as runBots, t as heliosCall } from "./signal-DX0eOYS2.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/grok-CN6H8cUm.js
...
async function gradeWithKey(apiKey, question) {
	const { getLiveSnapshot } = await import("./sources-DEU09DdG.mjs");
...
var askHeliosByo = createServerFn({ method: "POST" }).validator((input) => input).handler(askHeliosByo_createServerFn_handler, async ({ data }) => {
	...
	const { looksLikeSecret } = await import("./security-CQDQQ6Fu.mjs").then((n) => n.m).then((n) => n.m);
