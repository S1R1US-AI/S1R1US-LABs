...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BLzRYEFV.mjs");
...
var manifest = {
	...
	"5e1297c3c46a34d5383344d4744427836346a714cac56b3c8b95fc2b8e31450d": {
		...
		importer: () => import("./probes-Cv0FH4cY.mjs")
	},
	...
	"bd29d0b6bb34b0f97cb375088f5253f65373a39cffb50760d3afefd56a5a4669": {
		...
		importer: () => import("./site-health-DG3X6_l-.mjs")
	},
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DtVoeubR.mjs").then((n) => n.t),
