...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CBAgnWHF.mjs");
...
var manifest = {
	...
	"7092675022d7921cd8cc08898a38d6a7910d94df92d5d08d1b5ad31e50ccaeb3": {
		...
		importer: () => import("./lock-request-rpc-CPMX8Yin.mjs")
	},
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-IrBynbL7.mjs").then((n) => n.t),
