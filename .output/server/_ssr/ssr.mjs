...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-B7AnXnIZ.mjs");
...
var manifest = {
	...
	"7092675022d7921cd8cc08898a38d6a7910d94df92d5d08d1b5ad31e50ccaeb3": {
		...
		importer: () => import("./lock-request-rpc-ClwG3HHS.mjs")
	},
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-C6CO7gdi.mjs").then((n) => n.t),
