...
//#region node_modules/.nitro/vite/services/ssr/assets/posture-D8wIOuIs.js
...
async function securityPosture(opts) {
	...
	try {
		const gate = await import("./agent-gate-ImCgNXMe.mjs").then((n) => n.r);
		const wl = await import("./agent-gate-ImCgNXMe.mjs").then((n) => n.l);
