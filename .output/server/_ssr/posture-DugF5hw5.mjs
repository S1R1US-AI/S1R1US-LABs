...
//#region node_modules/.nitro/vite/services/ssr/assets/posture-DugF5hw5.js
...
async function securityPosture(opts) {
	...
	try {
		const gate = await import("./agent-gate-_sbjT5Tf.mjs").then((n) => n.r);
		const wl = await import("./agent-gate-_sbjT5Tf.mjs").then((n) => n.l);
