...
import { b as COMPANY_X_URL, d as COMPANY_X_AVATAR, g as COMPANY_X_LABEL, h as COMPANY_X_HANDLE, v as COMPANY_X_LOGO_NAME, w as looksLikeCompanyX, x as companyHandleSet, y as COMPANY_X_NAME } from "./tenancy-XVYWlKJ3.mjs";
import { $n as TAB_HOVER_FEED, A as MENU_FORUM, An as TAB_CUP, D as MENU_AGENTS, Dr as seoImgAlt, En as TAB_CALLOUT, Gn as TAB_HOVER_BOARD, Hn as TAB_HOVER_AGENT, Jn as TAB_HOVER_COFFEE, Ln as TAB_GM, M as MENU_TAPE, O as MENU_BOARD, On as TAB_COFFEE, Qn as TAB_HOVER_FAQ, Rn as TAB_GM_AUTO, Sr as TAB_ROBOTS, Un as TAB_HOVER_APP, Vn as TAB_HIVE, Wn as TAB_HOVER_BEARS, Yn as TAB_HOVER_COMPUTE, Zn as TAB_HOVER_DESK, _ as FORUM_AGENTS, ar as TAB_HOVER_LAB, bn as TAB_BEARS, cr as TAB_HOVER_OWL, dr as TAB_HOVER_SITEMAP, er as TAB_HOVER_FORUM, fr as TAB_KING_MANUAL, gr as TAB_LAB, hr as TAB_KING_UNI, ir as TAB_HOVER_HOME, j as MENU_LAB, k as MENU_FEED, kn as TAB_COMPUTE, lr as TAB_HOVER_ROBOTS, mr as TAB_KING_ROUND, nn as SEO_TAB_GM_AUTO, r as APP_NAME, rn as SEO_TAB_HIVE, rr as TAB_HOVER_HIVE, tn as SEO_TAB_GM, tr as TAB_HOVER_GM, vn as TAB_AGENT, w as LABS_NAME, wn as TAB_BOWL, yn as TAB_APP, yr as TAB_OWL } from "./brand-Cg47htkS.mjs";
import { f as looksLikeSecret } from "./security-Cm24ExbM.mjs";
import { S as OSS_LINK_LABEL, x as OSS_LINK } from "./model-DnitDZdY.mjs";
import { a as signOut, i as signIn } from "./client-Gq2WFxue.mjs";
import { m as secondFactorStatus, v as useOperator } from "./operator-BWHXtJvm.mjs";
import { a as XRenewWhenAdmin, m as useCurrentUserState, n as Button, p as useCurrentUser, s as cn } from "./renew-password-CKVw-xpD.mjs";
import { i as GROK_PROVIDERS } from "./server-DrYSoF3f.mjs";
import { _ as TERMS_TITLE, f as PRIVACY_TITLE, h as TERMS_PATH, l as PRIVACY_HOVER, m as TERMS_HOVER, r as LEGAL_NFA, s as LEGAL_USE_IS_AGREEMENT, u as PRIVACY_PATH, y as rainGmBurst } from "./legal-BU0YkXex.mjs";
import { d as Lock, l as LogOut, u as LogIn } from "../_libs/lucide-react.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/shell-BgY-wW2B.js
...
function RainbowGodzillaText({ text }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: parts.map((p, i) => RAINBOW_BITS.includes(p) ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(GmRainbow, { text: p }, i) : p) });
}
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CompanyAvatar, {
								...
								className: "truncate text-[0.9625rem] font-semibold tracking-[0.04em] text-fg",
								children: "S1R1US"
							})]
						}),
...
//#endregion
export { YubiForm as S, Shell as _, GmRainbow as a, UserButton as b, HiveSwarmLabel as c, ManualKingLabel as d, OperatorGate as f, SeoImage as g, RoundKingLabel as h, GmAutoLabel as i, LeaderBoardLabel as l, RainbowGodzillaText as m, CompanyAvatar as n, GodzillaMark as o, Panel as p, ForumTitle as r, GodzillaModeLabel as s, CallOutLabel as t, LoginCluster as u, SuperBowlLabel as v, WorldCupLabel as x, UniversalKingLabel as y };
