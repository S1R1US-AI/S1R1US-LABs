...
import { verifyAccessToken } from "./access.server-Cb5mEDCx.mjs";
import { t as createServerRpc } from "./createServerRpc-CcvdN_gc.mjs";
import { n as guardedFetch, t as cloudflareDns } from "./net-guard-BVXXcES3.mjs";
import { i as COIN_DOMAIN } from "./model-Cpv_Su3q.mjs";
import { t as DO_INGRESS_A } from "./godaddy-dns-DCMIOqdf.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/site-health-DB82jPSM.js
var hits = [];
function throttle() {
	const now = Date.now();
