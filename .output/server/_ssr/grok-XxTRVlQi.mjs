...
import { c as grokRateLimit, l as grokUsage, s as assertSafePayload } from "./security-CMyXz6XE.mjs";
import { storedAdminName, verifyAccessToken, verifyDeskToken } from "./access.server-5mVXeerR.mjs";
import { t as createServerRpc } from "./createServerRpc-BgpH4YR6.mjs";
import { n as guardedFetch } from "./net-guard-C4Si76ZP.mjs";
import { c as predAnalyst } from "./prediction-markets-BXpIiy7X.mjs";
import { n as runBots, t as heliosCall } from "./signal-DMlYP7Up.mjs";
//#region ../../workspace/node_modules/.nitro/vite/services/ssr/assets/grok-XxTRVlQi.js
...
async function gradeWithKey(apiKey, question) {
	const { getLiveSnapshot } = await import("./sources-CKvzXHSu.mjs");
...
var askHeliosByo = createServerFn({ method: "POST" }).validator((input) => input).handler(askHeliosByo_createServerFn_handler, async ({ data }) => {
	...
	const { looksLikeSecret } = await import("./security-CMyXz6XE.mjs").then((n) => n.m).then((n) => n.m);
