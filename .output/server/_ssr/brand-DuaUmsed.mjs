//#region node_modules/.nitro/vite/services/ssr/assets/brand-DuaUmsed.js
...
var PAGE_TITLE_FAQ = seoBotTitle(`FAQ · ${TAB_DESK} · ${TAB_GM} · live tape · morning report · admin panel · ${TAB_BEARS} · ${TAB_OWL} · ${TAB_ROBOTS} · ${TAB_BOWL} · ${TAB_CUP} · ${TAB_HIVE} · ${TAB_LOCK3D} · ${TAB_OSS_ROADMAP} · ${TAB_FORUM} · ${TAB_FEED} · ${TAB_LAB} · ${TAB_TOKEN} · ${TAB_COFFEE} · ${TAB_CALLING_BOTS} · ${TAB_COMPUTE} · OP3N S0URC3`);
var PAGE_TITLE_SITEMAP = seoBotTitle(`Sitemap · ${TAB_DESK} · ${TAB_GM} · ${TAB_BEARS} · ${TAB_OWL} · ${TAB_ROBOTS} · ${TAB_BOWL} · ${TAB_CUP} · ${TAB_HIVE} · ${TAB_LOCK3D} · ${TAB_OSS_ROADMAP} · ${TAB_FORUM} · ${TAB_FEED} · ${TAB_HELLO} · ${TAB_COFFEE} · ${TAB_AGENT} · ${TAB_COMPUTE} · OP3N S0URC3`);
...
//#endregion
export { MENU_FORUM as $, SPONSOR_HEADLINE as $n, TAB_KING_QUANT as $r, PAGE_TITLE_ROBOTS as $t, GIF_FEED_CHAIN_NAME as A, SEO_TAB_FEED as An, TAB_HOVER_CALLOUT_WELCOME as Ar, PAGE_DESC_SPONSOR as At, GIF_SPONSOR_HEART_NAME as B, SEO_TAB_LAB as Bn, TAB_HOVER_HIVE as Br, PAGE_TITLE_COMPUTE as Bt, GIF_COFFEE_CRYPTO as C, SEO_TAB_CALLOUT as Cn, TAB_HELLO as Cr, PAGE_DESC_MEDIA as Ct, GIF_COFFEE_TIP as D, SEO_TAB_CUP as Dn, TAB_HOVER_BEARS as Dr, PAGE_DESC_ROBOTS as Dt, GIF_COFFEE_LARGE_NAME as E, SEO_TAB_COMPUTE as En, TAB_HOVER_APP as Er, PAGE_DESC_PRIVACY as Et, GIF_LOCK_OPEN_NAME as F, SEO_TAB_HIVE as Fn, TAB_HOVER_FAQ as Fr, PAGE_TITLE_BEARS as Ft, HIVE_PATH as G, SEO_TAB_OWL_ALIAS as Gn, TAB_HOVER_OSS_ROADMAP as Gr, PAGE_TITLE_GM as Gt, GIF_SPONSOR_LARGE_NAME as H, SEO_TAB_LOCK3D as Hn, TAB_HOVER_LAB as Hr, PAGE_TITLE_FAQ as Ht, GIF_LOCK_OPEN_SEO as I, SEO_TAB_KING_MANUAL as In, TAB_HOVER_FEED as Ir, PAGE_TITLE_BOARD as It, LOCK_HEADLINE as J, SEO_TAB_SPONSOR as Jn, TAB_HOVER_ROBOTS as Jr, PAGE_TITLE_LOCK as Jt, IOS_PATH as K, SEO_TAB_ROBOTS as Kn, TAB_HOVER_OWL as Kr, PAGE_TITLE_HIVE as Kt, GIF_SPONSOR_GOAL as L, SEO_TAB_KING_QUANT as Ln, TAB_HOVER_FORUM as Lr, PAGE_TITLE_BOWL as Lt, GIF_FEED_GIFT_NAME as M, SEO_TAB_FORUM_ALIAS as Mn, TAB_HOVER_COMPUTE as Mr, PAGE_DESC_WHITE as Mt, GIF_FEED_LARGE as N, SEO_TAB_GM as Nn, TAB_HOVER_CUP as Nr, PAGE_TITLE_AGENT as Nt, GIF_COFFEE_TIP_NAME as O, SEO_TAB_CUP_FULL as On, TAB_HOVER_BOARD as Or, PAGE_DESC_SEARCH as Ot, GIF_FEED_LARGE_NAME as P, SEO_TAB_GM_AUTO as Pn, TAB_HOVER_DESK as Pr, PAGE_TITLE_APP as Pt, MENU_FEED as Q, SITE_IMAGES as Qn, TAB_KING_MANUAL as Qr, PAGE_TITLE_PRIVACY as Qt, GIF_SPONSOR_GOAL_NAME as R, SEO_TAB_KING_ROUND as Rn, TAB_HOVER_GM as Rr, PAGE_TITLE_CALLOUT_WELCOME as Rt, GIF_AI_BTC_BOT_NAME as S, SEO_TAB_CALLING_BOTS as Sn, TAB_GM_AUTO_TAIL as Sr, PAGE_DESC_LOCK as St, GIF_COFFEE_LARGE as T, SEO_TAB_COFFEE as Tn, TAB_HOVER_AGENT as Tr, PAGE_DESC_OWL as Tt, HIVE_DISCLAIMER as U, SEO_TAB_OSS_ROADMAP as Un, TAB_HOVER_LOCK as Ur, PAGE_TITLE_FEED as Ut, GIF_SPONSOR_LARGE as V, SEO_TAB_LEADERBOARD as Vn, TAB_HOVER_HOME as Vr, PAGE_TITLE_CUP as Vt, HIVE_HEADLINE as W, SEO_TAB_OWL as Wn, TAB_HOVER_MAX_GAINS as Wr, PAGE_TITLE_FORUM as Wt, MENU_AGENTS as X, SEO_TAB_WHITE as Xn, TAB_HOVER_SITEMAP as Xr, PAGE_TITLE_OSS_ROADMAP as Xt, LOCK_PATH as Y, SEO_TAB_TOKEN as Yn, TAB_HOVER_SEND_BTC as Yr, PAGE_TITLE_MEDIA as Yt, MENU_BOARD as Z, SEO_TITLE as Zn, TAB_HOVER_SPONSOR as Zr, PAGE_TITLE_OWL as Zt, FORUM_AGENTS as _, seoBotTitle as _i, SEO_TAB_BOARD as _n, TAB_FEED_NOW as _r, PAGE_DESC_FEED as _t, BEARS_HEADLINE as a, TAB_OSS_ROADMAP as ai, PAID_SERVICES as an, TAB_BOARD_LEADER as ar, OWL_HEADLINE as at, GIF_AI_BTC_BOT as b, SEO_TAB_BOWL as bn, TAB_GM as br, PAGE_DESC_HIVE as bt, BOT7_NAME as c, TAB_PRED as ci, ROBOTS_PATH as cn, TAB_CALLING_BOTS as cr, PAGE_DESC_APP as ct, BOWL_PATH as d, TAB_SEND_BTC as di, SEO_CANONICAL as dn, TAB_COFFEE as dr, PAGE_DESC_BOWL as dt, TAB_KING_ROUND as ei, PAGE_TITLE_SEARCH as en, SPONSOR_PATH as er, MENU_LAB as et, CALLOUT_WELCOME_HEADLINE as f, TAB_SPICE as fi, SEO_DESCRIPTION as fn, TAB_COMPUTE as fr, PAGE_DESC_CALLOUT_WELCOME as ft, CUP_PATH as g, WHITE_LABEL_PATH as gi, SEO_TAB_BEARS as gn, TAB_FEED_GROWL as gr, PAGE_DESC_FAQ as gt, CUP_HEADLINE as h, TAB_WHITE as hi, SEO_TAB_APP as hn, TAB_FEED as hr, PAGE_DESC_CUP as ht, APP_PATH as i, TAB_MAX_GAINS as ii, PAGE_TITLE_WHITE as in, TAB_BOARD as ir, OSS_ROADMAP_PATH as it, GIF_FEED_GIFT as j, SEO_TAB_FORUM as jn, TAB_HOVER_COFFEE as jr, PAGE_DESC_TERMS as jt, GIF_FEED_CHAIN as k, SEO_TAB_DESK as kn, TAB_HOVER_BOWL as kr, PAGE_DESC_SITEMAP as kt, BOWL_DISCLAIMER as l, TAB_QUANT_FLEX as li, SEO_ALIASES as ln, TAB_CALLOUT as lr, PAGE_DESC_BEARS as lt, COMPUTE_PATH as m, TAB_TOKEN as mi, SEO_TAB_AGENT as mn, TAB_DESK as mr, PAGE_DESC_COMPUTE as mt, APP_CALLS as n, TAB_LAB as ni, PAGE_TITLE_SPONSOR as nn, TAB_APP as nr, MENU_WHITE as nt, BEARS_PATH as o, TAB_OWL as oi, PLAY_PATH as on, TAB_BOT7 as or, OWL_PATH as ot, CALLOUT_WELCOME_PATH as p, TAB_SPONSOR as pi, SEO_KEYWORDS as pn, TAB_CUP as pr, PAGE_DESC_COFFEE as pt, LABS_NAME as q, SEO_TAB_SPICE as qn, TAB_HOVER_PRED as qr, PAGE_TITLE_LAB as qt, APP_NAME as r, TAB_LOCK3D as ri, PAGE_TITLE_TERMS as rn, TAB_BEARS as rr, OSS_ROADMAP_HEADLINE as rt, BOARD_PATH as s, TAB_OWL_ALIAS as si, ROBOTS_HEADLINE as sn, TAB_BOWL as sr, PAGE_DESC_AGENT as st, APP_ADMIN_PATH as t, TAB_KING_UNI as ti, PAGE_TITLE_SITEMAP as tn, TAB_AGENT as tr, MENU_TAPE as tt, BOWL_HEADLINE as u, TAB_ROBOTS as ui, SEO_BOT_TERMS as un, TAB_CALLOUT_WELCOME as ur, PAGE_DESC_BOARD as ut, FORUM_HEADLINE as v, seoImgAlt as vi, SEO_TAB_BOARD_LEADER as vn, TAB_FORUM as vr, PAGE_DESC_FORUM as vt, GIF_COFFEE_CRYPTO_NAME as w, SEO_TAB_CALLOUT_WELCOME as wn, TAB_HIVE as wr, PAGE_DESC_OSS_ROADMAP as wt, GIF_AI_BTC_BOT_EQ as x, SEO_TAB_BOWL_FULL as xn, TAB_GM_AUTO as xr, PAGE_DESC_LAB as xt, FORUM_PATH as y, SEO_TAB_BOT7 as yn, TAB_FORUM_LEGACY as yr, PAGE_DESC_GM as yt, GIF_SPONSOR_HEART as z, SEO_TAB_KING_UNI as zn, TAB_HOVER_HELLO as zr, PAGE_TITLE_COFFEE as zt };
