...
import { Gt as SEO_CANONICAL, _r as TAB_HOVER_HIVE, ar as TAB_HOVER_BOARD, br as TAB_HOVER_LOCK, j as LOCK_PATH, k as LABS_NAME, qr as seoImgAlt, rt as PAGE_DESC_LOCK, t as APP_ADMIN_PATH } from "./brand-D1W3F7j-.mjs";
import { a as LOCK_IDS, c as TAB_LOCK3D, f as lockViewPath, i as LOCK_GIF_OPEN_NAME, o as LOCK_META, r as LOCK_GIF_OPEN, s as SEO_TAB_LOCK3D } from "./lock-status-CQ3k2p73.mjs";
...
import { i as LockHead, r as LockBoard } from "./lock3d-status-D_7f6QTr.mjs";
...
import { a as LOCK_BANNER_ASK, c as LOCK_IMG_SEO, d as lockWelcomePublic, i as LOCK_AGENT_WELCOME, k as GITHUB_REPO_URL, l as LOCK_LIVE_VS_SIM, o as LOCK_HEADLINE, s as LOCK_HOW_TO_TOGGLE, u as LOCK_TUTORIAL } from "./router-D1mMBW2E.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/l0ck-CvU-5Njl.js
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Panel, {
				...
				children: [LOCK_TUTORIAL.map((s) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
							to: "/pr3d",
							className: "gold-css hover:underline",
							title: "S1R1US Predictions",
							children: "Pr3d1ctions"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
							to: "/agent",
							className: "text-oss hover:underline",
