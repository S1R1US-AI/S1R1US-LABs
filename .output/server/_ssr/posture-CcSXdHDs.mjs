...
import { a as listIntrusions, n as ingestPersisted, r as intrusionSummary } from "./intrusion-log-DgqVPLPw.mjs";
import { a as underAttack, i as listActions, r as ingestActions } from "./auto-defend-Djnzn2VN.mjs";
import { i as wafStats, n as ingestWafLog } from "./waf-B_PDEz1d.mjs";
import { i as asiRows, n as agentSecurityStats, s as llmAgentRows } from "./agent-security-fYS4prvN.mjs";
import { a as cachedIntel, c as firewallLayers, i as runHunter, l as firewallSummary, o as ingestIntel, s as refreshIntel, u as headerPosture } from "./hunter-BjvCXTM1.mjs";
import { n as pciRows, r as pluginInventory, t as owaspRows } from "./control-map-D3uKp1H6.mjs";
import { readFileSync } from "node:fs";
//#region node_modules/.nitro/vite/services/ssr/assets/posture-CcSXdHDs.js
...
async function securityPosture(opts) {
	...
	try {
		const gate = await import("./agent-gate-CPEElLYl.mjs").then((n) => n.r);
		const wl = await import("./agent-gate-CPEElLYl.mjs").then((n) => n.a);
	...
	try {
		bars = (await import("./agent-bar-tE7hqyyO.mjs").then((n) => n.t)).listAgentBars();
	} catch {}
	try {
