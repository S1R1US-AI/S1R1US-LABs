...
import { n as approveOutgoing, v as useOperator } from "./operator-B-83GDbl.mjs";
import { c as fgTone, f as rsiTone, i as USD_TONE, n as Button, s as cn, t as BTC_TONE } from "./renew-password-CgrcnRVg.mjs";
import { _ as Copy, m as LoaderCircle, r as ScanSearch, u as Paperclip } from "../_libs/lucide-react.mjs";
import { _ as Panel } from "./shell-DhzBcQbb.mjs";
import { n as STARTING_CASH } from "./store-oEyIFO9k.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/helios-card-BHXEEBxX.js
...
function HeliosCard({ call, grok, grokErr, asking, copied, canFill, onAsk, onCopy, onFill, kicker = "7-B0T", title = APP_CALLS, canAct = true, canAsk, tape }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Panel, {
		...
		children: call ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
			...
			canAct ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
				...
				children: "Admin — expand for proprietary 7-B0T overseer."
			})] }) : null,
