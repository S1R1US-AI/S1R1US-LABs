import { n as GO_LIVE_DEADLINE } from "./go-live-BIzGOXvb.mjs";
import { r as checkpointLabel } from "./checkpoint-Dyt8QP7f.mjs";
import { i as liveSimNote, n as LIVE_SIM_SEO, r as LIVE_SIM_TZ, t as LIVE_SIM_NAME } from "./live-sim-HvvIQMSB.mjs";
...
//#region ../../workspace/node_modules/.nitro/vite/services/ssr/assets/live-sim.server-BH3WjQGp.js
/**
...
function liveSimPublic() {
	const s = load();
	const w = nextWindow();
	const synced = s.checkpoint === 111 && s.conflict === null;
	return {
		name: LIVE_SIM_NAME,
		seo: LIVE_SIM_SEO,
		status: s.status,
...
function testLiveSimCheckpoint() {
	...
	const notes = [];
	if (pub.checkpoint !== 111) notes.push("checkpoint desync");
