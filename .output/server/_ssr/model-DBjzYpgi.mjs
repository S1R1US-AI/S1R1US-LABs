import { Dr as TAB_FEED, Er as TAB_DESK, Mr as TAB_GM, mi as TAB_LAB, r as APP_NAME } from "./brand-CDqF9nyU.mjs";
import { c as COMPANY_X_HANDLE, m as companyHandleSet, s as COMPANY_X_BIO, t as ADMIN_X_HANDLE } from "./x-admin-CALKyy-K.mjs";
import { c as SUPPORT_GIFT_RECEIPT } from "./support-w0TmEm7L.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/model-DBjzYpgi.js
...
var OSS_NEEDS = [
	...
	{
		id: "faq-sitemap",
		need: "Public FAQ + HTML sitemap + sitemap.xml + sitemap-index.xml + video-sitemap.xml. Footer Sitemap | FAQ | OP3N S0URC3. robots Allow /gm /labs /faq /sitemap /forum /media /search. Disallow admin/login/launch/renew/source/guide.",
		minUsd: 0,
		maxUsd: 0,
		done: true
	},
