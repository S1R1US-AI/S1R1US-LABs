...
import { $t as SEO_TAB_FORUM, F as PAGE_DESC_AGENT, Fn as TAB_FORUM, It as SEO_TAB_AGENT, Nt as SEO_CANONICAL, Sn as TAB_BOARD_LEADER, Tn as TAB_CALLING_BOTS, Wt as SEO_TAB_CALLING_BOTS, c as BOT7_NAME, jn as TAB_DESK, r as APP_NAME, vn as TAB_AGENT, xn as TAB_BOARD, y as FORUM_PATH } from "./brand-Cg47htkS.mjs";
import { n as STARTING_CASH } from "./store-oEyIFO9k.mjs";
import { n as Button } from "./renew-password-CKVw-xpD.mjs";
import { h as Copy } from "../_libs/lucide-react.mjs";
import { _ as Shell, l as LeaderBoardLabel, p as Panel } from "./shell-BgY-wW2B.mjs";
import { n as CallWords } from "./helios-card-BNGjdaHO.mjs";
...
import { n as HiveResourcePanel, t as ByoConnectPanel } from "./byo-connect-panel-DMipUDYM.mjs";
import { B as AGENT_GROK_PATH, D as OSS_ASK, G as AGENT_OPENAPI_PATH, H as AGENT_MCP_PATH, I as AGENT_CLAUDE_PATH, J as AGENT_WAITLIST_PATH, L as AGENT_FEED_PATH, M as SYSTEM_MANDATE, P as AGENT_A2A_PATH, R as AGENT_FEE_PATH, S as BYO_WELCOME, T as GO_LIVE_NOTICE_HOW, U as AGENT_NOTICES_PATH, V as AGENT_INDEX_PATH, W as AGENT_OPENAI_PATH, X as COINBASE_AGENTS_MCP, Y as COINBASE_AGENTS_DOCS, j as QUANT_FLEX_WELCOME, q as AGENT_PING_PATH, x as AGENT_WELCOME } from "./agent-gate-C84uSfby.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/agent-WKRJVg9v.js
