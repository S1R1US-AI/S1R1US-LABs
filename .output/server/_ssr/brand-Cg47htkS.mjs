//#region node_modules/.nitro/vite/services/ssr/assets/brand-Cg47htkS.js
...
var SEO_ALIASES = [
	...
	`${TAB_GM} is also searched as ${SEO_TAB_GM}, Godzilla mode, and Godzilla Mode. ${TAB_GM_AUTO} is also searched as ${SEO_TAB_GM_AUTO}. Main menu: GM.`,
...
var PAGE_TITLE_FAQ = seoBotTitle(`FAQ · ${TAB_DESK} · ${TAB_GM} · live tape · morning report · admin panel · ${TAB_BEARS} · ${TAB_OWL} · ${TAB_ROBOTS} · ${TAB_BOWL} · ${TAB_CUP} · ${TAB_HIVE} · ${TAB_LOCK3D} · ${TAB_FORUM} · ${TAB_FEED} · ${TAB_LAB} · ${TAB_TOKEN} · ${TAB_COFFEE} · ${TAB_CALLING_BOTS} · ${TAB_COMPUTE} · OP3N S0URC3`);
var PAGE_TITLE_SITEMAP = seoBotTitle(`Sitemap · ${TAB_DESK} · ${TAB_GM} · ${TAB_BEARS} · ${TAB_OWL} · ${TAB_ROBOTS} · ${TAB_BOWL} · ${TAB_CUP} · ${TAB_HIVE} · ${TAB_LOCK3D} · ${TAB_FORUM} · ${TAB_FEED} · ${TAB_HELLO} · ${TAB_COFFEE} · ${TAB_AGENT} · ${TAB_COMPUTE} · OP3N S0URC3`);
...
var PAGE_DESC_GM = `${TAB_GM} (${SEO_TAB_GM}) is the aggressive sleeve of ${TAB_DESK} (${SEO_TAB_DESK}). ${TAB_GM_AUTO} (${SEO_TAB_GM_AUTO}) is always rainbow. AI Bitcoin trading bot. OP3N S0URC3 (open source). Not financial advice.`;
...
//#endregion
export { PAGE_DESC_PRIVACY as $, TAB_HOVER_FEED as $n, SEO_TAB_FORUM as $t, MENU_FORUM as A, TAB_CUP as An, ROBOTS_PATH as At, PAGE_DESC_CALLOUT_WELCOME as B, TAB_HELLO as Bn, SEO_TAB_BOARD_LEADER as Bt, IOS_PATH as C, TAB_BOT7 as Cn, TAB_SEND_BTC as Cr, PAGE_TITLE_ROBOTS as Ct, MENU_AGENTS as D, TAB_CALLOUT_WELCOME as Dn, seoImgAlt as Dr, PAID_SERVICES as Dt, LOCK_PATH as E, TAB_CALLOUT as En, seoBotTitle as Er, PAGE_TITLE_TERMS as Et, PAGE_DESC_AGENT as F, TAB_FORUM as Fn, SEO_KEYWORDS as Ft, PAGE_DESC_FEED as G, TAB_HOVER_BOARD as Gn, SEO_TAB_CALLOUT as Gt, PAGE_DESC_COMPUTE as H, TAB_HOVER_AGENT as Hn, SEO_TAB_BOWL as Ht, PAGE_DESC_APP as I, TAB_FORUM_LEGACY as In, SEO_TAB_AGENT as It, PAGE_DESC_HIVE as J, TAB_HOVER_COFFEE as Jn, SEO_TAB_COMPUTE as Jt, PAGE_DESC_FORUM as K, TAB_HOVER_BOWL as Kn, SEO_TAB_CALLOUT_WELCOME as Kt, PAGE_DESC_BEARS as L, TAB_GM as Ln, SEO_TAB_APP as Lt, MENU_TAPE as M, TAB_FEED as Mn, SEO_BOT_TERMS as Mt, OWL_HEADLINE as N, TAB_FEED_GROWL as Nn, SEO_CANONICAL as Nt, MENU_BOARD as O, TAB_COFFEE as On, PLAY_PATH as Ot, OWL_PATH as P, TAB_FEED_NOW as Pn, SEO_DESCRIPTION as Pt, PAGE_DESC_OWL as Q, TAB_HOVER_FAQ as Qn, SEO_TAB_FEED as Qt, PAGE_DESC_BOARD as R, TAB_GM_AUTO as Rn, SEO_TAB_BEARS as Rt, HIVE_PATH as S, TAB_BOARD_LEADER as Sn, TAB_ROBOTS as Sr, PAGE_TITLE_PRIVACY as St, LOCK_HEADLINE as T, TAB_CALLING_BOTS as Tn, TAB_TOKEN as Tr, PAGE_TITLE_SITEMAP as Tt, PAGE_DESC_CUP as U, TAB_HOVER_APP as Un, SEO_TAB_BOWL_FULL as Ut, PAGE_DESC_COFFEE as V, TAB_HIVE as Vn, SEO_TAB_BOT7 as Vt, PAGE_DESC_FAQ as W, TAB_HOVER_BEARS as Wn, SEO_TAB_CALLING_BOTS as Wt, PAGE_DESC_LOCK as X, TAB_HOVER_CUP as Xn, SEO_TAB_CUP_FULL as Xt, PAGE_DESC_LAB as Y, TAB_HOVER_COMPUTE as Yn, SEO_TAB_CUP as Yt, PAGE_DESC_MEDIA as Z, TAB_HOVER_DESK as Zn, SEO_TAB_DESK as Zt, FORUM_AGENTS as _, SITE_IMAGES as _n, TAB_LOCK3D as _r, PAGE_TITLE_HIVE as _t, BEARS_HEADLINE as a, SEO_TAB_KING_QUANT as an, TAB_HOVER_LAB as ar, PAGE_TITLE_APP as at, HIVE_DISCLAIMER as b, TAB_BEARS as bn, TAB_OWL_ALIAS as br, PAGE_TITLE_MEDIA as bt, BOT7_NAME as c, SEO_TAB_LAB as cn, TAB_HOVER_OWL as cr, PAGE_TITLE_BOWL as ct, BOWL_PATH as d, SEO_TAB_OWL as dn, TAB_HOVER_SITEMAP as dr, PAGE_TITLE_COMPUTE as dt, SEO_TAB_FORUM_ALIAS as en, TAB_HOVER_FORUM as er, PAGE_DESC_ROBOTS as et, CALLOUT_WELCOME_HEADLINE as f, SEO_TAB_OWL_ALIAS as fn, TAB_KING_MANUAL as fr, PAGE_TITLE_CUP as ft, CUP_PATH as g, SEO_TITLE as gn, TAB_LAB as gr, PAGE_TITLE_GM as gt, CUP_HEADLINE as h, SEO_TAB_TOKEN as hn, TAB_KING_UNI as hr, PAGE_TITLE_FORUM as ht, APP_PATH as i, SEO_TAB_KING_MANUAL as in, TAB_HOVER_HOME as ir, PAGE_TITLE_AGENT as it, MENU_LAB as j, TAB_DESK as jn, SEO_ALIASES as jt, MENU_FEED as k, TAB_COMPUTE as kn, ROBOTS_HEADLINE as kt, BOWL_DISCLAIMER as l, SEO_TAB_LEADERBOARD as ln, TAB_HOVER_ROBOTS as lr, PAGE_TITLE_CALLOUT_WELCOME as lt, COMPUTE_PATH as m, SEO_TAB_SPICE as mn, TAB_KING_ROUND as mr, PAGE_TITLE_FEED as mt, APP_CALLS as n, SEO_TAB_GM_AUTO as nn, TAB_HOVER_HELLO as nr, PAGE_DESC_SITEMAP as nt, BEARS_PATH as o, SEO_TAB_KING_ROUND as on, TAB_HOVER_LOCK as or, PAGE_TITLE_BEARS as ot, CALLOUT_WELCOME_PATH as p, SEO_TAB_ROBOTS as pn, TAB_KING_QUANT as pr, PAGE_TITLE_FAQ as pt, PAGE_DESC_GM as q, TAB_HOVER_CALLOUT_WELCOME as qn, SEO_TAB_COFFEE as qt, APP_NAME as r, SEO_TAB_HIVE as rn, TAB_HOVER_HIVE as rr, PAGE_DESC_TERMS as rt, BOARD_PATH as s, SEO_TAB_KING_UNI as sn, TAB_HOVER_MAX_GAINS as sr, PAGE_TITLE_BOARD as st, APP_ADMIN_PATH as t, SEO_TAB_GM as tn, TAB_HOVER_GM as tr, PAGE_DESC_SEARCH as tt, BOWL_HEADLINE as u, SEO_TAB_LOCK3D as un, TAB_HOVER_SEND_BTC as ur, PAGE_TITLE_COFFEE as ut, FORUM_HEADLINE as v, TAB_AGENT as vn, TAB_MAX_GAINS as vr, PAGE_TITLE_LAB as vt, LABS_NAME as w, TAB_BOWL as wn, TAB_SPICE as wr, PAGE_TITLE_SEARCH as wt, HIVE_HEADLINE as x, TAB_BOARD as xn, TAB_QUANT_FLEX as xr, PAGE_TITLE_OWL as xt, FORUM_PATH as y, TAB_APP as yn, TAB_OWL as yr, PAGE_TITLE_LOCK as yt, PAGE_DESC_BOWL as z, TAB_GM_AUTO_TAIL as zn, SEO_TAB_BOARD as zt };
