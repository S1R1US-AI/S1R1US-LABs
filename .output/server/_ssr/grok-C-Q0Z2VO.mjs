...
import { c as grokRateLimit, l as grokUsage, s as assertSafePayload } from "./security-D_r_MqD6.mjs";
import { storedAdminName, verifyAccessToken, verifyDeskToken } from "./access.server-CzZcdjzg.mjs";
import { t as createServerRpc } from "./createServerRpc-CcvdN_gc.mjs";
import { n as guardedFetch } from "./net-guard-C4Si76ZP.mjs";
import { c as predAnalyst } from "./prediction-markets-Cx-5C4hC.mjs";
import { n as runBots, t as heliosCall } from "./signal-CelysD5m.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/grok-C-Q0Z2VO.js
...
async function gradeWithKey(apiKey, question) {
	const { getLiveSnapshot } = await import("./sources-tNP5mGHd.mjs");
...
var askHeliosByo = createServerFn({ method: "POST" }).validator((input) => input).handler(askHeliosByo_createServerFn_handler, async ({ data }) => {
	...
	const { looksLikeSecret } = await import("./security-D_r_MqD6.mjs").then((n) => n.m).then((n) => n.m);
