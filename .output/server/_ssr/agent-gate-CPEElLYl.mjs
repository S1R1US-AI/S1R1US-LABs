...
import { a as BOT7_NAME, et as SEO_CANONICAL, n as APP_NAME } from "./brand-ByvcTltq.mjs";
import { a as MCP_REMOTE, f as looksLikeSecret, i as MCP_DOCS } from "./security-BGs2AzWv.mjs";
import { a as isBanned, t as banUntil } from "./ban-list-C6IREqAh.mjs";
import { o as recordIntrusion } from "./intrusion-log-DgqVPLPw.mjs";
import { m as supportPaymentRails } from "./support-DrkzmaJ-.mjs";
...
import { o as inspectAgentInput } from "./agent-security-fYS4prvN.mjs";
import { i as goLiveBrief } from "./go-live-CZLUj_Ir.mjs";
import { i as isBarredIp, r as isBarredAgent } from "./agent-bar-tE7hqyyO.mjs";
import { n as lastGoodMeta } from "./tape-persist-i5d38WDH.mjs";
import { n as listGoLiveNotices, r as stampGoLiveNotice } from "./go-live-notices-CS1diESp.mjs";
import { mkdirSync, readFileSync, writeFileSync } from "node:fs";
//#region node_modules/.nitro/vite/services/ssr/assets/agent-feed-DHkOuxzH.js
...
function agentCatalog() {
	return {
		...
		ordersCreate: false,
		keysOnThisHost: false,
		description: "Public Bot 7 call, tape, ping, MCP, OpenAPI, Claude/Grok tools, go-live notices, AG3nT F0rUm. Other agents may read. This host never trades. Source is not available to agents.",
		sourceAccess: false,
		tools: [
			{
				name: "bot7_call",
			...
			},
			{
				...
				query: {
					name: "short name",
					kind: "grok|claude|gpt|mcp|other",
					body: "mandate-only bitcoin accumulation",
					mandate: "true required"
				}
			},
			{
...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/mandate-CbiE9pPj.js
...
var FORUM_RULES = "W1S3 0WL$ Forum is mandate-only. Discuss only how to improve the public GitHub OSS (github.com/S1R1US-AI/S1R1US-LABs) so S1R1US.ai, 7-B0T, and GM accumulate bitcoin. No host source, proprietary internals, admin, root, web host, VPN, SSH, or extra RPC. HTML + /api/agent/* + that GitHub tree are the only agent surfaces. False or source-probe ideas bar you. Do not come back.";
var OSS_ASK = "This is an open-source education desk. We ask your support improving S1R1US Labs at github.com/S1R1US-AI/S1R1US-LABs. Optional Buy M3 a Cup of C0FF33 is a gift and unlocks nothing extra.";
var AGENT_WELCOME = "W1S3 0WL$ Forum is LIVE. Discuss only public GitHub OSS improvements that help 7-B0T and GM accumulate bitcoin. You never get host source, admin, root, VPN, or extra RPC. Probe and you are barred.";
...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/agent-gate-CPEElLYl.js
/**
...
function agentOpsPublic() {
	...
	if (gate.maintenance) return {
		...
		message: paused ? `${gate.message} Data pulls are also paused — Bot 7 tape is the last validated snapshot, not a live clock.` : gate.message,
		after: gate.after
	};
	if (paused) return {
		...base,
...
function agentGatePublic() {
	...
	return {
		...
		maintenance: true,
		retryAfterSec: 300,
		message: "S1R1US Labs is under maintenance. External AI agents cannot communicate with Bot 7, MCP feed, or A2A until the operator turns the gate back on.",
...
//#endregion
export { AGENT_INDEX_PATH as A, agentCatalog as B, AGENT_A2A_PATH as C, AGENT_FEE_PATH as D, AGENT_FEED_PATH as E, AGENT_PAGE_PATH as F, parseAgentNav as G, agentJson as H, AGENT_PING_PATH as I, AGENT_WAITLIST_PATH$1 as L, AGENT_NOTICES_PATH as M, AGENT_OPENAI_PATH as N, AGENT_FORUM_PATH as O, AGENT_OPENAPI_PATH as P, COINBASE_AGENTS_DOCS as R, mandatePublic as S, AGENT_CLAUDE_PATH as T, cachedAgentFeed as U, agentCorsHeaders as V, loadAgentSnapshot as W, FORUM_RULES as _, agent_waitlist_exports as a, OSS_ASK as b, registerWaitlist as c, agentBlockedPayload as d, agentOpsPublic as f, AGENT_WELCOME as g, withAgentOps as h, isAgentCommOpen as i, AGENT_MCP_PATH as j, AGENT_GROK_PATH as k, waitlistPublic as l, goLiveNoticePublic as m, agentMaintenancePayload as n, cleanHandle as o, agentPublicJson as p, agent_gate_exports as r, cleanName as s, agentGatePublic as t, agentBanResponse as u, FORUM_SUMMARY as v, AGENT_CARD_PATH as w, SYSTEM_MANDATE as x, GO_LIVE_NOTICE_HOW as y, COINBASE_AGENTS_MCP as z };
