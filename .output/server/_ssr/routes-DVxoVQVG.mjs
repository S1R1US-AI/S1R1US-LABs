...
import { n as APP_NAME, t as APP_CALLS } from "./brand-iv-XZ0o2.mjs";
import { f as looksLikeSecret } from "./security-DAI2JSE-.mjs";
import { n as runBots, t as heliosCall } from "./signal-CPwMpzvZ.mjs";
import { h as useOperator } from "./operator-BWqe-TjH.mjs";
import { _ as usePaper, g as useDeskTape, n as STARTING_CASH, r as STOP_DEFAULT, u as initialStop } from "./store-DO7K-IX1.mjs";
import { c as fgTone, f as rsiTone, i as USD_TONE, l as kimchiHex, o as barBlue, s as cn, t as BTC_TONE, u as kimchiTone } from "./renew-password-D361i6FW.mjs";
import { b as Activity, v as ArrowUpRight, y as ArrowDownRight } from "../_libs/lucide-react.mjs";
import { c as Shell, s as Panel } from "./shell-BO4fz0h9.mjs";
import { n as HeliosCard, o as money, r as PaperCard } from "./helios-card-BysLYvdA.mjs";
import { i as askHelios, t as TapeFreezeBanner } from "./grok-E1obrWNb.mjs";
import { t as SeoCopy } from "./seo-copy-BYIzP5_n.mjs";
import { t as LiveTracks } from "./live-tracks-B_VJ6rdg.mjs";
import { n as Route } from "./router-Bx9rYVEP.mjs";
...
import { a as WhaleTape, i as TapeChart, n as LiqHeatmap, r as S1r1usSite, t as HelloWorld } from "./s1r1us-site-BulOqdqQ.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/routes-DVxoVQVG.js
...
function MetalPanel({ kicker, title, kickerClass, titleClass, rows, metal, spot, empty, note }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Panel, {
		kicker,
		title,
		kickerClass,
...
function SlicePie({ kicker, title, slices, format, usdOf, caption, className, wide, bare, compact, legend = true }) {
	const total = slices.reduce((s, r) => s + r.value, 0);
	...
	const inner = /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		bare ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
			className: "mb-2",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
				className: "block font-mono text-[11px] tracking-[0.12em] text-muted uppercase",
				children: kicker
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Panel, {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Panel, {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
						...
						children: (macro?.stables ?? []).map((s) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", { children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: cn("text-xs font-medium tracking-[0.08em] uppercase", STABLE_TONE[s.symbol] || "text-muted"),
								children: s.symbol
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: cn("mt-1 font-mono text-lg tabular-nums", STABLE_TONE[s.symbol] || "text-fg"),
								children: s.apy != null ? `${s.apy.toFixed(2)}%` : "—"
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
								className: "mt-0.5 text-xs text-muted",
								children: [s.protocol ?? "—", s.tvlUsd ? ` · ${compactTvl(s.tvlUsd)}` : ""]
							})
						] }, s.symbol))
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "mt-3 text-xs text-muted",
...
function Metric({ label, value, hint, tone }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
			className: cn("text-xs font-medium tracking-[0.08em] uppercase", tone || "text-muted"),
			children: label
		}),
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
...
function ProductTable({ title, rows, className }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "mb-2 text-xs font-medium tracking-[0.08em] text-muted uppercase",
				children: title
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
...
function DeskApp() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Shell, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "mb-4 grid gap-4 lg:grid-cols-[minmax(0,1.6fr)_minmax(0,1fr)]",
				...
				}), isAdmin ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PaperCard, {
					mounted,
					cash,
					btc,
...
function QuoteList({ rows }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
		...
		children: rows.map((q) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
			className: "flex items-center justify-between gap-2",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: q.symbol }),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					className: "tabular-nums",
