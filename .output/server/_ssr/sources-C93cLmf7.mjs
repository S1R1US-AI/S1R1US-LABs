...
import { r as DATA_FEEDS, s as fetchPredictionMarkets } from "./prediction-markets-Bk_9V8gL.mjs";
...
async function buildSnapshot() {
	try {
		const { ensureLiveSimScheduler } = await import("./live-sim.server-BH3WjQGp.mjs");
