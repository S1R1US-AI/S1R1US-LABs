...
import { Ct as TAB_COFFEE, Et as TAB_FEED, Tt as TAB_DESK, ot as SEO_TAB_COFFEE, y as PAGE_DESC_COFFEE } from "./brand-ByvcTltq.mjs";
import { a as SUPPORT_COFFEE_USD } from "./support-DrkzmaJ-.mjs";
import { d as Shell } from "./shell-CiBE4AkH.mjs";
import { t as SeoCopy } from "./seo-copy-DyZ5NBmz.mjs";
import { t as CoffeeDonate } from "./support-donate-CL0OaaKE.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/c0ff33-fFhVFrnG.js
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
				...
				children: [
					...
					". Optional. Bots that find Bot 7 useful may send the same amount. This is not a paywall and not a token sale."
				]
			}),
