...
import { verifyAccessToken } from "./access.server-DDNBFOVv.mjs";
import { t as createServerRpc } from "./createServerRpc-BgpH4YR6.mjs";
import { n as guardedFetch, t as cloudflareDns } from "./net-guard-C4Si76ZP.mjs";
import { i as COIN_DOMAIN } from "./model-BLElk76W.mjs";
import { t as DO_INGRESS_A } from "./godaddy-dns-DCMIOqdf.mjs";
//#region ../../workspace/node_modules/.nitro/vite/services/ssr/assets/site-health-D3D8cnMT.js
var hits = [];
function throttle() {
	const now = Date.now();
