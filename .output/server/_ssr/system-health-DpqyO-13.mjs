...
import { t as MCP_TOOLS } from "./agent-security-j9HmdOss.mjs";
import { a as GO_LIVE_STEPS } from "./go-live-oAgCl7x0.mjs";
import { d as hiveResourcePublic } from "./hive-resource-BThKJHxr.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/system-health-DpqyO-13.js
/** Checkpoint-68 overall system health. Function + security + design. Relative imports only. Client-safe. */
var system_health_exports = /* @__PURE__ */ __exportAll({ systemHealth: () => systemHealth });
function grade(n) {
	if (n >= 90) return "A";
	if (n >= 80) return "B";
	if (n >= 70) return "C";
...
function systemHealth() {
	...
	const des = 94;
	const overall = clamp(fn * .4 + sec * .4 + des * .2, 100);
	return {
...
//#endregion
export { system_health_exports as n, systemHealth as t };
