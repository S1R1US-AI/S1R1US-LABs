...
import { c as PRIVACY_PATH, f as TERMS_HOVER, h as TERMS_TITLE, n as LEGAL_HOWEY, o as LEGAL_OWN_RISK, p as TERMS_PATH, r as LEGAL_NFA, s as PRIVACY_HOVER, t as LEGAL_BOTS, u as PRIVACY_TITLE } from "./legal-h_q7W0h2.mjs";
import { p as xSignInProviderId } from "./providers-DoZIBobl.mjs";
import { a as signOut, i as signIn } from "./client-Dkf4Mpw3.mjs";
import { m as secondFactorStatus, v as useOperator } from "./operator-B8S-5cFP.mjs";
import { a as XRenewWhenAdmin, m as useCurrentUserState, n as Button, p as useCurrentUser, s as cn } from "./renew-password-DaX2kF3V.mjs";
import { d as Lock, l as LogOut, u as LogIn } from "../_libs/lucide-react.mjs";
import { B as rainGmBurst } from "./router-BwRj66mY.mjs";
//#region ../../workspace/node_modules/.nitro/vite/services/ssr/assets/shell-DPpJkkER.js
...
function DisclaimerExpandBody() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
			...
			children: [
				"S1R1U$ L@B Strategies is NOT considered financial advice or a financial recommendation. S1R1US.ai and the 7-B0T H3DG3 Fund and any related systems are NOT LICENSED for financial advice. If you need real financial advice seek a licensed professional. S1R1U$ L@B Strategies and all related entities such as Desk, Lab, website or systems are for EDUCATION purpose ONLY. By accessing, browsing, registering, playing, or otherwise using this website, the iOS or Google app, any agent API, PR3D1CT10N$, L3AD3R B0ARD, or any related function, you agree to the",
				" ",
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
					to: TERMS_PATH,
				...
				". If you do not agree, do not use the system. Use is 100 percent at your own risk. We pay ZERO legal fees. Always seek a licensed attorney before live trading. ",
				TERMS_TITLE,
				" · ",
				PRIVACY_TITLE,
				" should be reviewed by our licensed legal counsel."
			]
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
			className: "w-full max-w-none text-justify font-mono text-[10px] leading-relaxed tracking-[0.02em] text-muted/80",
			children: "Use of this website, desk, lab, iOS/Google app, SUP3R B0WL, L3AD3R B0ARD, PR3D1CT10N$, W1S3 0WL$, (or external AI Agent games or experiments) and any related system on S1R1US.ai is 100 percent at your own risk. S1R1US.ai is NOT a financial advisor and is not licensed for financial advice. ALWAYS seek a licensed professional (attorney or financial broker) before trying our service. Not a broker-dealer. Not an investment adviser. Not a recommendation to buy, sell, or hold bitcoin, any token, or any other asset. Education and proof of concept only. Experimental AI. Invest only on the advice of a licensed advisor. You can lose all funds."
		})]
	});
}
function LegalBar() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DisclaimerExpandBody, {});
}
var LINKS = [{
	to: "/",
	label: MENU_TAPE,
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
						...
						children: [
							...
							" (",
							APP_NAME,
							") is education and proof of concept only. ",
							LEGAL_NFA
						]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
