...
import { c as grokRateLimit, l as grokUsage, s as assertSafePayload } from "./security-DF8nfXQK.mjs";
import { storedAdminName, verifyAccessToken, verifyDeskToken } from "./access.server-DJiBiWNu.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/grok-Brth5P5M.js
...
var askHelios = createServerFn({ method: "POST" }).validator((input) => input).handler(askHelios_createServerFn_handler, async ({ data }) => {
	...
	const { getLiveSnapshot } = await import("./sources-C-hxEnM2.mjs");
