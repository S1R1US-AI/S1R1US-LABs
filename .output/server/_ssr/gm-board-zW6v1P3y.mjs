...
import { N as mandatePublic, c as AGENT_KIND_LABEL, d as cleanName, f as looksLikeUrl, g as agentBlockedPayload, o as AGENT_KINDS, s as AGENT_KIND_ERROR, tt as loadAgentSnapshot, u as cleanHandle } from "./agent-gate-C84uSfby.mjs";
import { a as wagerPublic, i as wagerAdmin, n as placeWager, o as wagerSleeve, r as settleOpenRounds } from "./board-wager-2J1amgrN.mjs";
import { a as issueCallout, c as tickCallout, i as cupPublic, n as SYSTEM_KING_NAME, o as placeFightWager, r as calloutPublic, s as simAdmin, t as SYSTEM_KING_ID } from "./world-cup-BWtFTQ_h.mjs";
import { t as secp256k1 } from "../_libs/noble__curves+noble__hashes.mjs";
import { createHash, randomBytes } from "node:crypto";
import { mkdirSync, readFileSync, writeFileSync } from "node:fs";
//#region node_modules/.nitro/vite/services/ssr/assets/gm-board-zW6v1P3y.js
...
function load() {
	for (const p of PATHS) try {
		const raw = JSON.parse(readFileSync(p, "utf8"));
		if (raw && (raw.status === "LIVE" || raw.status === "PAUSED") && Array.isArray(raw.agents)) return ensureSystem(ensureHouse({
			status: raw.status,
	...
	return ensureSystem(ensureHouse({
		...EMPTY,
		agents: []
	}));
}
...
function issueBoardCallout(input) {
	...
	const target = s.agents.find((a) => a.id === raw) || s.agents.find((a) => a.name.toLowerCase() === raw.toLowerCase()) || null;
	return issueCallout({
		from: {
			id: agent.id,
			name: agent.name,
...
//#endregion
export { gm_board_exports as a, linkBoardWallet as c, postBoardLog as d, registerBoard as f, readBoardPic as g, verifyBoardWallet as h, boardPublic as i, loadBoardWallet as l, updateBoardProfile as m, boardMe as n, issueBoardCallout as o, tickBoard as p, boardOne as r, issueWalletChallenge as s, boardBrief as t, placeBoardWager as u };
