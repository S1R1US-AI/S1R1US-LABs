...
import { Oi as TAB_WHITE, Sn as SEO_CANONICAL, _t as PAGE_DESC_APP, gr as TAB_BOARD, ji as seoImgAlt, ki as WHITE_LABEL_PATH, mr as TAB_APP, wr as TAB_COMPUTE } from "./brand-CDqF9nyU.mjs";
import { S as require_jsx_runtime, U as require_react, v as Link } from "../_libs/@tanstack/react-router+[...].mjs";
import { a as OSS_LICENSE_NOTICE } from "./white-label-BD831BeM.mjs";
import { n as Button } from "./renew-password-CgrcnRVg.mjs";
import { S as Shell, u as LeaderBoardLabel, x as SeoImage } from "./shell-DhzBcQbb.mjs";
import { t as SeoCopy } from "./seo-copy-DPXIBeSr.mjs";
import { t as AskGrokPanel } from "./ask-grok-panel-dYY__8W-.mjs";
import { _ as SIRI_AGENT_PATH, b as appleIntents, g as GOOGLE_AGENT_PATH, h as APP_SURFACES, m as APP_GATEWAY_PATH, p as APPLE_AGENT_PATH, v as WEBMCP_AGENT_PATH, x as resolveAppTo, y as WEBMCP_TOOLS } from "./router-KNDw2MNy.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/mobile-app-page-BrgTbsNV.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Shell, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SeoCopy, {}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				className: "mt-4 rounded-lg border border-rule bg-surface p-4",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "text-xs font-medium tracking-[0.08em] text-tab uppercase",
						children: "Upgrade to system admin"
					}),
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
						...
						children: [
							"Download this entire open-source system and relaunch it under a domain name YOU control — never under S1R1US.ai. All S1R1US.ai system admin rights, games, rolls, simulations, access tokens, and web host information are stripped before download. Connect Grok, Claude, or GitHub Copilot to help you build it.",
							" ",
							OSS_LICENSE_NOTICE
						]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
						...
						children: "Open the WHITE LABEL download + config"
					})
				]
			}),
