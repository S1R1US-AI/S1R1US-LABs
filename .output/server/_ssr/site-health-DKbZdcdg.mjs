...
import { verifyAccessToken } from "./access.server-DJiBiWNu.mjs";
import { t as createServerRpc } from "./createServerRpc-CcvdN_gc.mjs";
import { n as guardedFetch, t as cloudflareDns } from "./net-guard-C-AYNeR_.mjs";
import { i as COIN_DOMAIN } from "./model-DRca3chI.mjs";
import { t as DO_INGRESS_A } from "./godaddy-dns-DCMIOqdf.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/site-health-DKbZdcdg.js
var hits = [];
function throttle() {
	const now = Date.now();
