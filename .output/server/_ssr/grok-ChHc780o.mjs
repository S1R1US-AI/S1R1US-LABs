...
import { c as grokRateLimit, l as grokUsage, s as assertSafePayload } from "./security-CIRBAp9G.mjs";
import { storedAdminName, verifyAccessToken, verifyDeskToken } from "./access.server-D86r0ibA.mjs";
import { t as createServerRpc } from "./createServerRpc-CcvdN_gc.mjs";
import { n as guardedFetch } from "./net-guard-C4Si76ZP.mjs";
import { c as predAnalyst } from "./prediction-markets-D4erl24v.mjs";
import { n as runBots, t as heliosCall } from "./signal-D-gcEirP.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/grok-ChHc780o.js
...
async function gradeWithKey(apiKey, question) {
	const { getLiveSnapshot } = await import("./sources-DC13Mn6H.mjs");
...
var askHeliosByo = createServerFn({ method: "POST" }).validator((input) => input).handler(askHeliosByo_createServerFn_handler, async ({ data }) => {
	...
	const { looksLikeSecret } = await import("./security-CIRBAp9G.mjs").then((n) => n.m).then((n) => n.m);
