//#region node_modules/.nitro/vite/services/ssr/assets/net-guard-C3s3LqYg.js
/**
...
async function cloudflareDns(name, type = "A") {
	...
	if (!q.endsWith(".ai") && !q.endsWith(".com") && !q.endsWith(".io")) throw new Error("blocked qname tld");
...
//#endregion
export { guardedFetch as n, cloudflareDns as t };
