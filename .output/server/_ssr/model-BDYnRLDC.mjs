import { c as companyHandleSet, o as COMPANY_X_BIO, t as ADMIN_X_HANDLE } from "./x-admin-SEv9ocnZ.mjs";
import { _ as TAB_GM, n as APP_NAME, p as TAB_DESK, v as TAB_LAB } from "./brand-Cp1yHL3f.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/model-BDYnRLDC.js
...
var ROADMAP_STEALTH = `Do not Publish, do not attach s1r1us.ai, do not put pump.fun / ticker / mint steps on ${TAB_DESK} until M1 mint tx is confirmed. Coin tab is admin-only. Snipe risk is the ticker, not the ${APP_NAME} brand.`;
...
var CHECKLIST = [
	...
	},
	{
		id: "x",
		phase: "1 · Identity",
		label: companyHandleSet() ? `Create  as the company X account` : "Create a new company X account (not @S1R1US)",
