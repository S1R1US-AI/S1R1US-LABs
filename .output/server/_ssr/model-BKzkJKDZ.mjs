import { A as companyHandleSet, C as COMPANY_X_BIO, _ as ADMIN_X_HANDLE, w as COMPANY_X_HANDLE } from "./security-D9Edw5IJ.mjs";
import { Dt as TAB_LAB, n as APP_NAME, ot as TAB_DESK, st as TAB_FEED, ut as TAB_GM } from "./brand-BKM5q_W_.mjs";
import { s as SUPPORT_GIFT_RECEIPT } from "./support-DrkzmaJ-.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/model-BKzkJKDZ.js
...
var OSS_NEEDS = [
	...
	{
		id: "faq-sitemap",
		need: "Public FAQ + HTML sitemap + sitemap.xml. Footer Sitemap | FAQ | OP3N S0URC3. robots Allow /gm /helios /faq /sitemap. Disallow admin/login/launch/renew.",
		minUsd: 0,
		maxUsd: 0,
		done: true
	},
