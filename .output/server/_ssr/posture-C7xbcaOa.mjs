...
import { a as firewallSummary, c as ingestIntel, i as firewallLayers, l as refreshIntel, o as headerPosture, r as cachedIntel, u as runHunter } from "./hunter-BiB3s5EG.mjs";
import { n as pciRows, r as pluginInventory, t as owaspRows } from "./control-map-CYwGTHQc.mjs";
import { readFileSync } from "node:fs";
//#region node_modules/.nitro/vite/services/ssr/assets/posture-C7xbcaOa.js
...
async function securityPosture(opts) {
	...
	try {
		const gate = await import("./agent-gate-Dc4_BNmM.mjs").then((n) => n.r);
		const wl = await import("./agent-gate-Dc4_BNmM.mjs").then((n) => n.l);
