import { c as grokRateLimit, l as grokUsage, s as assertSafePayload } from "./security-htqI4xhk.mjs";
import { r as createServerFn } from "./ssr.mjs";
import { storedAdminName, verifyAccessToken, verifyDeskToken } from "./access.server-CaZHHbCU.mjs";
import { t as createServerRpc } from "./createServerRpc-CcvdN_gc.mjs";
import { n as guardedFetch } from "./net-guard-C4Si76ZP.mjs";
import { c as predAnalyst } from "./prediction-markets-BKVhDauB.mjs";
import { n as runBots, t as heliosCall } from "./signal-CbTLccvW.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/grok-CFhh3vlC.js
...
async function gradeWithKey(apiKey, question) {
	const { getLiveSnapshot } = await import("./sources-otJ0ZL8Z.mjs");
...
var askHeliosByo = createServerFn({ method: "POST" }).validator((input) => input).handler(askHeliosByo_createServerFn_handler, async ({ data }) => {
	...
	const { looksLikeSecret } = await import("./security-htqI4xhk.mjs").then((n) => n.m).then((n) => n.m);
