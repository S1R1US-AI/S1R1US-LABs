...
//#region node_modules/.nitro/vite/services/ssr/assets/desk-rpc-B9hvoKXq.js
...
var fetchSecurityBrief = createServerFn({ method: "POST" }).validator((input) => input).handler(fetchSecurityBrief_createServerFn_handler, async ({ data }) => {
	...
	const { morningSecurity, morningBadBots } = await import("./morning-ops-CQ0citRG.mjs").then((n) => n.s).then((n) => n.s);
