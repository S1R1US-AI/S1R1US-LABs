import { Oi as TAB_WHITE, _i as TAB_MINERS, dt as MINERS_PATH, er as SEO_TAB_MINERS, ki as WHITE_LABEL_PATH, ut as MINERS_HEADLINE } from "./brand-CDqF9nyU.mjs";
import { i as MINERS_DEFAULT_STRATUM, n as MINERS_DEFAULT_ADDRESS, r as MINERS_DEFAULT_BACKUP, x as withMinerDefaults } from "./btc-miners-C_ITq4f_.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/white-label-Atrito6B.js
/**
...
var WHITE_LABEL_STAGE = "Education and Experimental Stage Product";
/**
...
*/
var WHITE_LABEL_DISCLOSURE_LINKS = [
	{
		label: "Original Creation distributed by",
		value: "S1R1US.ai",
		url: "https://s1r1us.ai"
	},
	{
		label: "Original Creation distributor Terms",
		value: "https://s1r1us.ai/terms",
		url: "https://s1r1us.ai/terms"
	},
	{
		label: "Original Creation distributor Privacy Policy",
		value: "https://s1r1us.ai/privacy",
		url: "https://s1r1us.ai/privacy"
	}
];
/** USER AGREEMENT for every S1R1US.ai White Label Distribution. */
var WHITE_LABEL_USER_AGREEMENT = [
...
*/
function whiteLabelMinerConfig(cfg) {
...
function whiteLabelGoLive(cfg, actor) {
	...
	return {
		live: true,
		brand,
		report: [`Rebranded for ${brand}. Zero S1R1US.ai system admin account data in this configuration. Go live when your host is ready.`, `DISCLOSURES: keep the DISCLOSURE LINKS active in your readme, Terms of Agreement, and Privacy Policy — ${WHITE_LABEL_DISCLOSURE_LINKS.map((l) => `${l.label}: ${l.value}`).join(" · ")}. NO EXCEPTIONS. VIOLATORS WILL BE BLOCKED FROM ACCESS TO SYSTEM.`]
	};
}
...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/oss-roadmap-CiF7cWKO.js
...
//#endregion
export { WHITE_LABEL_WATCH as C, fieldBlocked as D, emptyWhiteLabelConfig as E, whiteLabelGoLive as O, WHITE_LABEL_USER_AGREEMENT as S, builderPrompt as T, WHITE_LABEL_KEEP_MINERS as _, OSS_ROADMAP_AGENT_WELCOME as a, WHITE_LABEL_STAGE as b, PRED_FOOTNOTE as c, ossRoadmapPublic as d, OSS_LICENSE_NOTICE as f, WHITE_LABEL_DOWNLOAD_URL as g, WHITE_LABEL_DISCLOSURE_LINKS as h, LOCKED_FUNCTIONS as i, whiteLabelMinerConfig as k, REAL_MONEY_PRED_ESTIMATE as l, WHITE_LABEL_BUILDERS as m, FULL_LIVE_ESTIMATE as n, OSS_ROADMAP_HEADLINE as o, SYSTEM_ADMIN_OVERRIDE as p, LIVE_FUNCTIONS as r, OSS_ROADMAP_PATH as s, DATED_MILESTONES as t, STATUS_LEGEND as u, WHITE_LABEL_NAME as v, WHITE_LABEL_WELCOME_BANNERS as w, WHITE_LABEL_STRIP as x, WHITE_LABEL_PRIVILEGES as y };
