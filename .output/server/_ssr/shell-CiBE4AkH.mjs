...
import { Bt as TAB_HOVER_FORUM, Ct as TAB_COFFEE, Ft as TAB_HOVER_COFFEE, It as TAB_HOVER_COMPUTE, Kt as TAB_HOVER_OWL, Lt as TAB_HOVER_DESK, Nt as TAB_HOVER_AGENT, Pt as TAB_HOVER_BEARS, Qt as TAB_OWL, Rt as TAB_HOVER_FAQ, Ut as TAB_HOVER_HOME, Vt as TAB_HOVER_GM, Wt as TAB_HOVER_LAB, Xt as TAB_LAB, Yt as TAB_HOVER_SITEMAP, bt as TAB_AGENT, d as MENU_FEED, en as TAB_ROBOTS, f as MENU_FORUM, jt as TAB_GM, l as LABS_NAME, m as MENU_TAPE, n as APP_NAME, o as FORUM_AGENTS, p as MENU_LAB, qt as TAB_HOVER_ROBOTS, rn as seoImgAlt, u as MENU_AGENTS, wt as TAB_COMPUTE, xt as TAB_BEARS, zt as TAB_HOVER_FEED } from "./brand-ByvcTltq.mjs";
import { f as looksLikeSecret } from "./security-BGs2AzWv.mjs";
import { S as OSS_LINK_LABEL, x as OSS_LINK } from "./model-DKAm90sJ.mjs";
import { a as signOut, i as signIn } from "./client-Gq2WFxue.mjs";
import { f as secondFactorStatus, g as useOperator } from "./operator-YRhDcDP7.mjs";
import { a as XRenewWhenAdmin, m as useCurrentUserState, n as Button, p as useCurrentUser, s as cn } from "./renew-password-BJlIO2uF.mjs";
import { i as GROK_PROVIDERS } from "./server-DrYSoF3f.mjs";
import { d as TERMS_HOVER, f as TERMS_PATH, g as rainGmBurst, i as LEGAL_USE_IS_AGREEMENT, l as PRIVACY_TITLE, m as TERMS_TITLE, o as PRIVACY_HOVER, r as LEGAL_NFA, s as PRIVACY_PATH } from "./legal-D-U436A2.mjs";
import { d as Lock, l as LogOut, u as LogIn } from "../_libs/lucide-react.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/shell-CiBE4AkH.js
...
function RainbowGodzillaText({ text }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: parts.map((p, i) => p === "G0DZ1LLa M0D3" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(GodzillaModeLabel, {}, i) : p) });
}
...
//#endregion
export { GodzillaModeLabel as a, Panel as c, Shell as d, UserButton as f, GodzillaMark as i, RainbowGodzillaText as l, ForumTitle as n, LoginCluster as o, YubiForm as p, GmRainbow as r, OperatorGate as s, CompanyAvatar as t, SeoImage as u };
