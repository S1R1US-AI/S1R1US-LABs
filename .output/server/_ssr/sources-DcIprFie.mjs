...
//#region ../../workspace/node_modules/.nitro/vite/services/ssr/assets/sources-DcIprFie.js
...
async function buildSnapshot() {
	try {
		const { ensureLiveSimScheduler } = await import("./live-sim.server-CB_KsbZ3.mjs");
