...
//#region node_modules/.nitro/vite/services/ssr/assets/operator-YRhDcDP7.js
var optionalXSession = createMiddleware({ type: "function" }).client(async ({ next }) => {
	...
	const { runWithBearer } = await import("./access.server-BhqnGgjj.mjs");
...
//#endregion
export { webauthnBeginRegister as _, disconnectXAdmin as a, loadDeskVault as c, saveDeskVault as d, secondFactorStatus as f, useOperator as g, trackUsdcWallet as h, deleteDeskAccount as i, removeYubi as l, trackProfitWallet as m, approveOutgoing as n, enrollYubi as o, setYubiPanelLock as p, connectXAdmin as r, listDeskAccounts as s, addDeskAccount as t, resetSecondFactor as u, webauthnFinishRegister as v };
