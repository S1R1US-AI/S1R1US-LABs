...
import { c as grokRateLimit, l as grokUsage, s as assertSafePayload } from "./security-D71QYeVL.mjs";
import { storedAdminName, verifyAccessToken, verifyDeskToken } from "./access.server-Cb5mEDCx.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/grok-Bau1CUxH.js
...
var askHelios = createServerFn({ method: "POST" }).validator((input) => input).handler(askHelios_createServerFn_handler, async ({ data }) => {
	...
	const { getLiveSnapshot } = await import("./sources-BTQxkAET.mjs");
