...
import { t as authMiddleware } from "./middleware-DVR7CICF.mjs";
import { n as create, t as persist } from "../_libs/zustand.mjs";
import { t as createSsrRpc } from "./createSsrRpc-B2Izd0c7.mjs";
import { a as signOut } from "./client-Gq2WFxue.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/operator-UeKr_8KN.js
var optionalXSession = createMiddleware({ type: "function" }).client(async ({ next }) => {
	const { getBearerToken } = await import("./client-Gq2WFxue.mjs").then((n) => n.n).then((n) => n.n);
	return next({ sendContext: { bearerToken: getBearerToken() ?? void 0 } });
}).server(async ({ next, context }) => {
	const { getSessionUser } = await import("./verify.server-2QYOq9sy.mjs");
	const { runWithBearer } = await import("./access.server-D86r0ibA.mjs");
...
var confirmWebauthn = createServerFn({ method: "POST" }).middleware([optionalXSession, authMiddleware]).validator((input) => input).handler(createSsrRpc("0481761865848137848ea328ea5df62ee92834ec832192cd763b57cedaf884a9"));
var webauthnBeginLogin = createServerFn({ method: "POST" }).middleware([optionalXSession, authMiddleware]).validator((input) => input).handler(createSsrRpc("dd61df05b0fd80821645d9c56ef2635c65736e3ecf4d8ada1df06f02aa66eea9"));
...
var setYubiPanelLock = createServerFn({ method: "POST" }).middleware([optionalXSession]).validator((input) => input).handler(createSsrRpc("0119304a468f34290344afa31c702b340a12ef2ae972e27cecd33058c9d1ced0"));
var webauthnBeginRegister = createServerFn({ method: "POST" }).middleware([optionalXSession]).validator((input) => input).handler(createSsrRpc("6fc7d0f321f1594724d1925058050777d2ca782050e71ee4fdaa4a9efa735a20"));
var webauthnFinishRegister = createServerFn({ method: "POST" }).middleware([optionalXSession]).validator((input) => input).handler(createSsrRpc("9245cf1543579f8b70006f205bc376319cfdaf0b4db35120c94bb0e492f21a83"));
createServerFn({ method: "POST" }).middleware([optionalXSession]).validator((input) => input).handler(createSsrRpc("b39bd022495ae5e3a029e3daf43bd7890b38515d779d09a48ade7f9d35043be6"));
...
var claimCopyAdmin = createServerFn({ method: "POST" }).validator((input) => input).handler(createSsrRpc("1eda3a065e3f0b42de95beaed22e23df5e348fba2c87caae7820b1dd03e1e961"));
var peekCopyAdmin = createServerFn({ method: "POST" }).validator((input) => input).handler(createSsrRpc("d63a77fa38a871d27ee178917d0340aa4e40fa6ad57210b741bf4c91bf0550d4"));
...
var useOperator = create()(persist((set, get) => ({
	...
	tapWebauthn: async () => {
		...
		try {
			const { clientOrigin, getYubiAssertion } = await import("./webauthn-client-wWVK9Jpi.mjs");
			const begin = await webauthnBeginLogin({ data: {
				ticket,
				origin: clientOrigin()
			} });
			if (!begin.ok) {
			...
			const res = await confirmWebauthn({ data: {
				ticket,
				origin: clientOrigin(),
...
//#endregion
export { trackUsdcWallet as _, deleteDeskAccount as a, webauthnFinishRegister as b, listDeskAccounts as c, removeYubi as d, resetSecondFactor as f, trackProfitWallet as g, setYubiPanelLock as h, connectXAdmin as i, loadDeskVault as l, secondFactorStatus as m, approveOutgoing as n, disconnectXAdmin as o, saveDeskVault as p, claimCopyAdmin as r, enrollYubi as s, addDeskAccount as t, peekCopyAdmin as u, useOperator as v, webauthnBeginRegister as y };
