...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/router-DCS3BuA-.js
var router_DCS3BuA__exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
async function callMcpTool(name, args = {}, ctx = {}) {
	...
	if (name === "lock_status") {
		...
		const { lockStatusPublic } = await import("./lock-status.server-DupVu1Lr.mjs");
		return {
			ok: true,
			data: withAgentOps({
				ok: true,
