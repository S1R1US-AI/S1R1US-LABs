...
import { In as TAB_CALLOUT, N as MENU_BOARD, Rr as TAB_SPICE, T as HIVE_DISCLAIMER, Zn as TAB_HIVE, t as APP_ADMIN_PATH } from "./brand-KjHNY1ry.mjs";
import { t as ANALYSIS_AS_OF } from "./security-Cp6DEZcn.mjs";
import { t as alignmentScore } from "./alignment-CAFkh8RJ.mjs";
import { f as GM_NAME } from "./auto-window-CECRWKlY.mjs";
import { t as LIVE_SIM_NAME } from "./live-sim-HvvIQMSB.mjs";
import { n as morningInlineHref, r as morningPdfName, t as MORNING_TITLE } from "./morning-lib-D4ZKOXow.mjs";
import { a as morningPred, i as morningHtmlLinks, n as morningBadBots, o as morningSecurity, r as morningFeeds, t as morningAgent } from "./morning-ops-Cl4qXLHI.mjs";
import { t as systemHealth } from "./system-health-DqYxCJtG.mjs";
import { C as setMorningReportPaused, _ as setChampionshipSim, a as fetchDeskErrors, b as setHiveSwarmStatus, d as fetchMorningLib, f as fetchSecurityBrief, l as fetchLiveSim, r as fetchChampionshipSim, s as fetchHiveSwarm, t as fetchAgentFlags, x as setLiveSim } from "./desk-rpc-CxxoomgM.mjs";
import { r as useDeskTape } from "./tape-client-fN25VziO.mjs";
import { v as useOperator } from "./operator-B4yIuA_M.mjs";
import { t as useGm } from "./gm-store-uI5TkyEm.mjs";
import { n as Button, s as cn } from "./renew-password-Bx3_KB2s.mjs";
import { m as Download, o as Play, p as ExternalLink, s as Pause } from "../_libs/lucide-react.mjs";
import { C as SuperBowlLabel, _ as Panel, a as GmRainbow, l as HiveSwarmLabel, t as CallOutLabel, u as LeaderBoardLabel, x as SeoImage } from "./shell-BZ_Ba6g7.mjs";
import { t as GoLivePanel } from "./go-live-panel-BqyV2E_l.mjs";
import { t as BowlLiveFeed } from "./bowl-live-feed-CLkQ-0X2.mjs";
//#region ../../workspace/node_modules/.nitro/vite/services/ssr/assets/board-play-panel-qPKGTbZp.js
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("dl", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("dt", {
						...
						children: [sim?.label ?? "S1R1US App build #111", sim?.synced ? " · synced" : " · desync"]
					})] }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("dt", {
						className: "text-muted",
						children: "Status"
