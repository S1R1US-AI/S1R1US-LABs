...
//#region node_modules/.nitro/vite/services/ssr/assets/agent-security-fYS4prvN.js
var agent_security_fYS4prvN_exports = /* @__PURE__ */ __exportAll({
	a: () => hasAgentWebhook,
	c: () => mcpMethodAllowed,
	d: () => readAgentJson,
	i: () => asiRows,
...
function asiRows() {
	return [
		...
		},
		{
			...
			title: "Tool Misuse",
			status: "PASS",
			control: "Allowlist only: bot7_call, ping, fee_info, loop, waitlist, go_live_notice, forum_list, forum_post, forum_register. Source / admin / root / VPN / extra RPC denied. Public GitHub is the OSS tree. Forum is mandate + public GitHub only."
		},
		{
			id: "asi03",
			code: "ASI03",
		...
		},
		{
			...
			status: "PASS",
			control: "Every payload sets live:false trade:false. Bot 7 is a preview, not an approval. HITL is the visitor's Coinbase."
		},
		{
			id: "asi10",
			code: "ASI10",
...
function llmAgentRows() {
	return [
		...
		},
		{
			...
			status: "PASS",
			control: "No agent-writable memory into Bot 7. Waitlist is names only."
		},
		{
			id: "llm06",
			code: "LLM06",
...
//#endregion
export { hasAgentWebhook as a, mcpMethodAllowed as c, readAgentJson as d, asiRows as i, mcpToolAllowed as l, agentSecurityStats as n, inspectAgentInput as o, agent_security_fYS4prvN_exports as r, llmAgentRows as s, MCP_TOOLS as t, noteAgentEvent as u };
