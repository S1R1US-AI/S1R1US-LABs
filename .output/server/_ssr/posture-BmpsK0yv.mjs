...
//#region node_modules/.nitro/vite/services/ssr/assets/posture-BmpsK0yv.js
...
async function securityPosture(opts) {
	...
	try {
		const gate = await import("./agent-gate-2vEIB7om.mjs").then((n) => n.r);
		const wl = await import("./agent-gate-2vEIB7om.mjs").then((n) => n.l);
