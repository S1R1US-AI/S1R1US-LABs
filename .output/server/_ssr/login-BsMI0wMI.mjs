...
import { r as APP_NAME } from "./brand-zDAneT0C.mjs";
import { f as looksLikeSecret } from "./security-CMyXz6XE.mjs";
import { p as xSignInProviderId } from "./providers-DoZIBobl.mjs";
import { i as signIn } from "./client-Dkf4Mpw3.mjs";
import { m as secondFactorStatus, v as useOperator } from "./operator-CbK5Gst4.mjs";
import { a as XRenewWhenAdmin, m as useCurrentUserState, n as Button, p as useCurrentUser } from "./renew-password-BC2PEqGW.mjs";
import { d as Lock } from "../_libs/lucide-react.mjs";
import { E as UserButton, O as YubiForm, S as Shell, d as LoginCluster } from "./shell-DU5mSkYB.mjs";
//#region ../../workspace/node_modules/.nitro/vite/services/ssr/assets/login-BsMI0wMI.js
...
function Login() {
	...
	(0, import_react.useEffect)(() => {
		...
		if (new URLSearchParams(window.location.search).get("error")) setXErr("X sign-in did not finish. Try Continue with X again, or use name and password.");
	}, []);
	(0, import_react.useEffect)(() => {
		if (!me) {
			setXAdmin(false);
				...
				!user ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
							...
							onClick: () => {
								setXErr(null);
								Promise.race([signIn(xSignInProviderId(), {
									callbackURL: "/login",
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							...
							children: "Required: system admin name + password. YubiKey is optional. Operator X is still used to bind the session. Other X accounts stay users. iOS / Google copy Admin is on the downloaded app."
						}),
					...
					children: [
						...
						xAdmin ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							...
							children: "This X session is not the operator account. Sign out, then Continue with X again as the operator. iOS / Google copy Admin is a separate lock on the downloaded app."
						}),
