...
import { a as underAttack, i as listActions, t as applyIntelPatches } from "./auto-defend-Djnzn2VN.mjs";
import { n as guardedFetch } from "./net-guard-3Kz6JH57.mjs";
import { i as wafStats, t as WAF_RULES } from "./waf-B_PDEz1d.mjs";
import { n as agentSecurityStats, t as MCP_TOOLS } from "./agent-security-fYS4prvN.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/hunter-BjvCXTM1.js
var HEADER_SPEC = [
	{
		id: "nosniff",
...
function runHunter() {
	...
	const findings = [
		...
		finding("h-and", "WP2 Auth", "Admin is operator X AND name+password", "HIGH", proto.find((p) => p.id === "2fa")?.status === "PASS" ? "PASS" : "OPEN", "X alone or password alone cannot mint admin. Dual Yubi for outgoing BTC/USDC. Optional admin-panel YubiKey lock (default OFF).", "Keep AND. Do not add passwordless admin. Panel lock stays optional until the operator enrolls a key."),
