...
//#region ../../workspace/node_modules/.nitro/vite/services/ssr/assets/providers-DoZIBobl.js
...
var NATIVE_X_PROVIDER_ID = "twitter";
var GROK_PROVIDERS = [{
	providerId: "grok-x",
	idp: "twitter",
	label: "X"
}];
function isPublicS1r1usHost(hostname) {
	const h = (hostname ?? (typeof window !== "undefined" ? window.location.hostname : "")).toLowerCase();
	return h === "s1r1us.ai" || h === "www.s1r1us.ai";
}
/** Which Continue with X provider the browser should start. */
function xSignInProviderId(hostname) {
	return isPublicS1r1usHost(hostname) ? NATIVE_X_PROVIDER_ID : "grok-x";
}
//#endregion
export { getBaseURL as a, getProtocol as c, resolveBaseURL as d, wildcardMatch as f, PACKAGE_VERSION as i, isDynamicBaseURLConfig as l, GROK_PROVIDERS as n, getHost as o, xSignInProviderId as p, NATIVE_X_PROVIDER_ID as r, getOrigin as s, GENERIC_OAUTH_ERROR_CODES as t, isRequestLike as u };
