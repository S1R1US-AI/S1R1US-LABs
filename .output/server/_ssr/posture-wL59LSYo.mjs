...
//#region node_modules/.nitro/vite/services/ssr/assets/posture-wL59LSYo.js
...
async function securityPosture(opts) {
	...
	try {
		const gate = await import("./agent-gate-COF9dQNT.mjs").then((n) => n.r);
		const wl = await import("./agent-gate-COF9dQNT.mjs").then((n) => n.l);
