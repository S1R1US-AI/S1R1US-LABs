import { $ as LABS_NAME, Cr as TAB_COFFEE, Dr as TAB_FEED, Er as TAB_DESK, In as SEO_TAB_COFFEE, Mr as TAB_GM, Oi as TAB_WHITE, Sn as SEO_CANONICAL, Ti as TAB_SPICE, ki as WHITE_LABEL_PATH, mi as TAB_LAB, r as APP_NAME, rt as MENU_BOARD, xr as TAB_CALLOUT, yr as TAB_BOWL } from "./brand-CDqF9nyU.mjs";
import { c as COMPANY_X_HANDLE } from "./x-admin-CALKyy-K.mjs";
import { c as SUPPORT_GIFT_RECEIPT, o as SUPPORT_COFFEE_USD } from "./support-w0TmEm7L.mjs";
import { m as GITHUB_URL } from "./model-DBjzYpgi.mjs";
import { c as WHITE_LABEL_DISCLOSURE_LINKS, d as WHITE_LABEL_LEGAL_STATUS, g as WHITE_LABEL_USER_AGREEMENT, h as WHITE_LABEL_STRIP, m as WHITE_LABEL_STAGE } from "./white-label-BD831BeM.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/legal-W7-gq1tz.js
...
var LEGAL_PRED_BOOK = "S1R1US Pr3d1ctions paper book is off this desk, web app, and phone apps. Remaining as a brief OSS Roadmap footnote possibility only (/roadmap#pred-footnote). No fake wallets. Polymarket and Kalshi public odds stay a 7-B0T sub-analyst overlay. This host never takes, matches, escrows, or settles bets. Coinbase Wallet / Sparrow bets stay NEVER. FAQ: /faq#btc-bets #oss-roadmap.";
var LEGAL_PRED_LIVE = "A licensed S1R1US prediction market is a possibility footnote on the OSS Roadmap only — not a live function, not on the desk, web app, or phone apps. Estimated 2027-06-01 after counsel + CFTC DCM/FCM or a licensed partner. This host never takes, matches, escrows, or settles bets. Kalshi/Polymarket order routing for others stays NEVER. Coinbase Wallet / Sparrow live prediction bets stay NEVER. Estimates are not promises and not an offer. FAQ: /faq#oss-roadmap. Footnote: /roadmap#pred-footnote.";
var LEGAL_AGENTS = "External AI agents start at /llms.txt (the public instructions module; also /.well-known/llms.txt). /guide is operator-only. Discover MCP at /.well-known/mcp.json, A2A at /.well-known/agent-card.json, and the Agentic Resource Discovery catalog at /.well-known/ai-catalog.json. Read-only 7-B0T JSON, MCP, A2A. Waitlist then poll notices. There is no lock_set, hive_withdraw, or orders_create. This host never holds keys. FAQ: /faq#calling-all-bots #instructions #how-to-use.";
var LEGAL_SAAS = "Optional 7-B0T HTTP keys ($9 / $29) are software SaaS for poll rate. They are not extra conviction, not a profit share, and not a token. Spec is published; keys are not on until the operator turns them on. Gifts unlock nothing extra.";
var LEGAL_FINCEN = "This host is not a money transmitter. Possible money transmission (FinCEN) would be: accept value from others, hold it, and send it on minus a fee. Mining-pool guidance is narrow: even pools become transmitters if they host wallets. This host hosting a hive book and paying out would look custodial. That path is LOCKED on the go-live roadmap (step s8). They do not take a slice of a pooled trading book. This host does not implement hive profit-share, hive withdraw, or auto-send of agent P&L to the admin address. Optional gifts and HTTP SaaS only. Agent sends. Host never skims. Not a security. Education only. FAQ: /faq#hive-resource #go-live #oss-roadmap.";
var LEGAL_WAF = "The application firewall, hunter, and bad-bot bars log probes. Unauthorized reconnaissance is a Terms violation. Pause and maintenance stamp GET /api/agent/notices. This host never POSTs webhooks.";
var LEGAL_MORNING = "S1R1U$ M0rning R3p0rt is the daily 07:30 America/New_York ops PDF. System Admin (Admin → Console) and iOS/Google copy-admin (phone Admin → Console) both receive it. Alignment Score 1–100. Last 14 days, 3 shown, PDF in browser. Copy-admin does not receive the system research paper. FAQ: /faq#morning-report #live-sim.";
var LEGAL_EDU = "Everything on this website is education and proof of concept until operator unlock after counsel. Not a recommendation. Not financial advice. Seek a licensed professional.";
var LEGAL_MANDATE = "The only mandate is: accumulate bitcoin, never sell bitcoin, never short bitcoin. Titles are paper. Rank is bitcoin stacked on paper books.";
var LEGAL_SIM = "Championships (L3AD3R B0ARD, SUP3R B0WL, W0rLd CUP of AI Quant Trading BTC, C@LL 0UT, H1V3 SW@RM, W1S3 0WL$, 7-B0T, bots 1–6, G M0D3 AUTO) tick paper books against live Coinbase last until an Admin pauses them. Until go-live, G M0D3 AUTO and AI agents run as an as-live simulation: auto-pause 07:00 America/New_York, morning report 07:30 ET for system Admin and iOS/Google copy-admin, then resume for the next 24 hours. System Admin and copy-admin may pause or continue that as-live cycle from Admin Console. Data pulls follow the simulation (on when LIVE, idle when PAUSED). Old practice AUTO ticks stay off. System Admin and iOS/Google copy-admin may pause or continue H1V3 SW@RM and championship World Cup / C@LL 0UT simulation. Pause stamps GET /api/agent/notices so agents know the desk is under maintenance and will be invited back. Pause does not unlock Coinbase. Practice never arms Coinbase. Auto trade stays LOCKED until operator unlock after counsel. FAQ: /faq#live-sim #morning-report #live-vs-sim #lock3d-status #world-cup #hive-swarm #oss-roadmap.";
var LEGAL_LAB = "S1R1US Lab Strategies (/labs) is a what-if overlay on the 7-bot tape. Education only. It does not place Coinbase orders.";
...
var TERMS_SECTIONS = [
	...
	{
		id: "pred-book",
		title: "5d-vii-b. S1R1US Pr3d1ctions (off this desk — roadmap footnote only)",
		body: LEGAL_PRED_BOOK
	},
	{
		id: "pred-live",
		title: "5d-vii-c. Licensed S1R1US prediction market (possibility footnote)",
...
//#endregion
export { LEGAL_OSS as a, PRIVACY_PATH as c, PRIVACY_UPDATED as d, TERMS_HOVER as f, TERMS_UPDATED as g, TERMS_TITLE as h, LEGAL_NOT_ATTORNEY as i, PRIVACY_SECTIONS as l, TERMS_SECTIONS as m, LEGAL_HOWEY as n, LEGAL_OWN_RISK as o, TERMS_PATH as p, LEGAL_NFA as r, PRIVACY_HOVER as s, LEGAL_BOTS as t, PRIVACY_TITLE as u };
