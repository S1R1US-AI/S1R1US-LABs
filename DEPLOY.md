...
**Official checkpoint:** [CHECKPOINT.md](CHECKPOINT.md) — **S1R1US App build #111 (live sim launch)** on `main`. Carbon-fiber origin tag `n3w-web-app-install-deploy-68` stays protected.
