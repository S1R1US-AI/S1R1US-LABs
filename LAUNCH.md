...
- Public pages: desk, G0DZ1LLa M0D3, F33D H0ST1Ng (Feed Hosting), lab, FAQ, Terms, sitemap.
...
2. Encrypted env (dashboard only): `BETTER_AUTH_SECRET`, `GROK_AUTH_CLIENT_SECRET`.
