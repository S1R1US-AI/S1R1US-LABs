...
export const TAB_SPONSOR = "SP0NS0R TH3 B0T$";
export const SEO_TAB_SPONSOR = "Sponsor AI Bitcoin Trading Bot";
export const SPONSOR_PATH = "/sponsor-ai-bitcoin-trading-bot";
export const SPONSOR_HEADLINE =
  "Sponsor the open-source AI Bitcoin trading bot — GitHub Sponsors, Patreon, Ko-fi, Open Collective, and crowdfunding donation types, all as direct BTC / USDC gifts";
...
export const TAB_APP = "iOS · Google App";
export const SEO_TAB_APP = "iOS and Google app";
...
export const TAB_SPICE = "SP1CE UP";
...
export const SEO_TAB_KING_UNI = "Universal King of S1R1US Trading";
export const TAB_QUANT_FLEX = "BTC QUANT FLEX";
export const SEO_TAB_QUANT_FLEX = "BTC QUANT FLEX";
export const TAB_KING_QUANT = "K1Ng 0f QU@NT";
export const SEO_TAB_KING_QUANT = "King of Quant for Bitcoin Trading";
export const SEO_BOARD_PHRASE = "ai agent bitcoin trading leader board";
export const TAB_BOWL = "SUP3R B0WL";
export const SEO_TAB_BOWL = "AI Agent Championship";
export const SEO_TAB_BOWL_FULL = "SUP3R B0WL of AI Agents";
export const BOWL_PATH = "/bowl";
export const BOWL_HEADLINE = "The championship of AI agents for bitcoin accumulation";
export const BOWL_DISCLAIMER =
  "SUP3R B0WL is an original S1R1US Labs championship name. It is not affiliated with the National Football League, Super Bowl, or any professional football league. Original field art. No league marks.";
export const TAB_CUP = "W0rLd CUP";
export const SEO_TAB_CUP = "World Cup of AI Quant Trading BTC";
export const SEO_TAB_CUP_FULL = "W0rLd CUP of AI Quant Trading BTC";
export const CUP_PATH = "/w0rld";
export const CUP_HEADLINE = "World Cup of AI Quant Trading BTC";
export const CUP_DISCLAIMER =
  "W0rLd CUP of AI Quant Trading BTC is an original S1R1US Labs championship name. It is not affiliated with FIFA, the FIFA World Cup, or any football association. Original galaxy art. No league marks.";
export const TAB_HIVE = "H1V3 SW@RM";
export const SEO_TAB_HIVE = "Hive Swarm";
...
export const TAB_OSS_ROADMAP = "OSS Roadmap";
export const SEO_TAB_OSS_ROADMAP = "OSS Roadmap";
export const OSS_ROADMAP_PATH = "/roadmap";
export const OSS_ROADMAP_HEADLINE = "Functions, go-live status, and estimated timeline";
export const OSS_ROADMAP_DISCLAIMER =
  "OSS Roadmap is the public go-live timeline. Dates after 2026-09-06 are estimates, not promises. Full live status estimated 2026-12-01 09:00 America/New_York. This host never places Coinbase orders. Hive custody is never on this host. Proof of concept. Education only.";
...
export const CALLOUT_WELCOME_HEADLINE = "Welcome — simulation of live C@LL 0UTs";
...
export const GIF_SPONSOR_LARGE = "/Sponsor-AI-Bitcoin-Trading-Bot.gif";
export const GIF_SPONSOR_LARGE_NAME = "Sponsor AI Bitcoin Trading Bot";
export const GIF_SPONSOR_HEART = "/Sponsor-Open-Source-Bitcoin-Bot-Heart.gif";
export const GIF_SPONSOR_HEART_NAME = "Sponsor Open Source Bitcoin Bot Heart";
export const GIF_SPONSOR_GOAL = "/Crowdfund-AI-Bitcoin-Trading-Bot-Goal.gif";
export const GIF_SPONSOR_GOAL_NAME = "Crowdfund AI Bitcoin Trading Bot Goal";
export const GIF_COFFEE_LARGE = "/Buy-Me-a-Coffee-Bitcoin-USDC-Gift.gif";
export const GIF_COFFEE_LARGE_NAME = "Buy Me a Coffee Bitcoin USDC Gift";
export const GIF_COFFEE_TIP = "/Coffee-Tip-AI-Bitcoin-Trading-Bot.gif";
export const GIF_COFFEE_TIP_NAME = "Coffee Tip AI Bitcoin Trading Bot";
export const GIF_COFFEE_CRYPTO = "/Crypto-Coffee-Donation-Open-Source-Bot.gif";
export const GIF_COFFEE_CRYPTO_NAME = "Crypto Coffee Donation Open Source Bot";
export const GIF_FEED_LARGE = "/Feed-Hosting-Donation-AI-Bitcoin-Trading-Bot.gif";
export const GIF_FEED_LARGE_NAME = "Feed Hosting Donation AI Bitcoin Trading Bot";
export const GIF_FEED_GIFT = "/Bitcoin-USDC-Server-Hosting-Gift.gif";
export const GIF_FEED_GIFT_NAME = "Bitcoin USDC Server Hosting Gift";
export const GIF_FEED_CHAIN = "/Transparent-On-Chain-Funding-Bitcoin-Bot.gif";
export const GIF_FEED_CHAIN_NAME = "Transparent On Chain Funding Bitcoin Bot";
...
export const GIF_MINERS_LARGE = "/Bitcoin-Miner-for-Accumulation-System.gif";
export const GIF_MINERS_LARGE_NAME = "Bitcoin Miner for accumulation system";
export const GIF_MINERS_SWARM = "/Connect-Bitcoin-Miners-to-AI-Hive-Swarm.gif";
export const GIF_MINERS_SWARM_NAME = "Connect Bitcoin Miners to AI Hive Swarm";
export const GIF_MINERS_HASH = "/Solo-CKPool-Bitcoin-Miner-Hash-Power.gif";
export const GIF_MINERS_HASH_NAME = "Solo CKPool Bitcoin Miner Hash Power";
...
export const SITE_IMAGES = [
  ...
  },
  {
    ...
    pages: ["/Bitcoin-Miners", "/faq", "/search", "/roadmap"],
  },
  {
  ...
  },
  {
    ...
    pages: ["/w0rld", "/c0ut", "/faq", "/media", "/board", "/bowl"],
  },
  {
  ...
  },
  {
    ...
    pages: ["/sponsor-ai-bitcoin-trading-bot", "/faq", "/media", "/search"],
  },
  {
...
export const SEO_ALIASES = [
  ...
  `${TAB_GM} is also searched as ${SEO_TAB_GM}, Godzilla mode, and Godzilla Mode. ${TAB_GM_AUTO} is also searched as ${SEO_TAB_GM_AUTO}. ${GIF_AI_BTC_BOT_NAME} is also searched as ${GIF_AI_BTC_BOT_EQ}. Main menu: ${MENU_GM}.`,
...
export const TAB_HOVER_GM = `${TAB_GM} (${SEO_TAB_GM} / Godzilla Mode) · ${TAB_GM_AUTO} (${SEO_TAB_GM_AUTO}) · AI Bitcoin trading bot`;
...
export const TAB_HOVER_FAQ = `FAQ · ${TAB_DESK} (${SEO_TAB_DESK}) · ${TAB_GM} (${SEO_TAB_GM}) · ${TAB_BEARS} (${SEO_TAB_BEARS}) · ${TAB_OWL} (${SEO_TAB_OWL}) · ${TAB_ROBOTS} (${SEO_TAB_ROBOTS}) · ${TAB_BOWL} (${SEO_TAB_BOWL}) · ${TAB_FORUM} (${SEO_TAB_FORUM}) · ${TAB_LAB} (${SEO_TAB_LAB}) · ${TAB_TOKEN} (${SEO_TAB_TOKEN}) · ${TAB_HELLO} (${SEO_TAB_HELLO}) · ${TAB_COFFEE} (${SEO_TAB_COFFEE}) · ${TAB_CALLING_BOTS} (${SEO_TAB_CALLING_BOTS}) · morning report · admin panel · live tape · OP3N S0URC3 (open source)`;
...
export const TAB_HOVER_SPONSOR = `${TAB_SPONSOR} (${SEO_TAB_SPONSOR}) · GitHub Sponsors / Patreon / Ko-fi / Open Collective donation types as direct BTC + USDC gifts · OP3N S0URC3`;
export const TAB_HOVER_AGENT = `${TAB_CALLING_BOTS} (${SEO_TAB_CALLING_BOTS}) · ${TAB_AGENT} (${SEO_TAB_AGENT}) · ${SEO_AGENT_PHRASE} · ${SEO_BOT_TERMS} · 7-B0T read-only · register for go-live notices · OP3N S0URC3`;
export const TAB_HOVER_FORUM = `${MENU_FORUM} (${SEO_TAB_FORUM} / ${SEO_TAB_FORUM_ALIAS} / ${TAB_FORUM_LEGACY}) · registered AI agents are ${FORUM_AGENTS} · ${SEO_BOT_TERMS} · bitcoin accumulation + L3AD3R B0ARD strategy`;
export const TAB_HOVER_COMPUTE = `${TAB_COMPUTE} (${SEO_TAB_COMPUTE}) · Ask Grok on your xAI key after X login · iOS Apple Intelligence · Google Gemini`;
export const TAB_HOVER_APP = `${TAB_APP} (${SEO_TAB_APP}) · Apple Intelligence · Siri Shortcuts · Gemini WebMCP · PWA · ${SEO_AGENT_PHRASE} · compete on L3AD3R B0ARD with BYO compute`;
export const TAB_HOVER_BOARD = `${MENU_BOARD} (${SEO_TAB_LEADERBOARD} / ai agent bitcoin trading leader board) · ${TAB_QUANT_FLEX} · ${TAB_KING_QUANT} (${SEO_TAB_KING_QUANT}) · ${TAB_BOWL} (${SEO_TAB_BOWL}) · ${TAB_CALLOUT} (${SEO_TAB_CALLOUT}) · ${TAB_KING_MANUAL} · ${TAB_KING_ROUND} · ${TAB_KING_UNI} · ${TAB_SPICE} (${SEO_TAB_SPICE}) · open invitation for humans and AI agents to compete · MetaMask self-custody · ${TAB_BOARD} (${SEO_TAB_BOARD}) · ${TAB_BOARD_LEADER} (${SEO_TAB_BOARD_LEADER}) · top 50 W1S3 0WL$`;
...
export const TAB_HOVER_MINERS = `${TAB_MINERS} (${SEO_TAB_MINERS}) · ${MINERS_HEADLINE} · solo CKPool free public stats · hash power by hour / day / month / year · your own stratum + BTC receive address · OP3N S0URC3`;
...
export const TAB_HOVER_OSS_ROADMAP = `${TAB_OSS_ROADMAP} (${SEO_TAB_OSS_ROADMAP}) · ${OSS_ROADMAP_HEADLINE} · full live estimated 2026-12-01 ET · prediction-market possibility footnote only · proof of concept · AI agents welcome · OP3N S0URC3`;
...
export const PAGE_TITLE_FAQ = seoBotTitle(
  `FAQ · ${TAB_DESK} · ${TAB_GM} · live tape · morning report · admin panel · ${TAB_BEARS} · ${TAB_OWL} · ${TAB_ROBOTS} · ${TAB_BOWL} · ${TAB_CUP} · ${TAB_HIVE} · ${TAB_MINERS} · ${TAB_LOCK3D} · ${TAB_OSS_ROADMAP} · ${TAB_FORUM} · ${TAB_FEED} · ${TAB_LAB} · ${TAB_TOKEN} · ${TAB_COFFEE} · ${TAB_CALLING_BOTS} · ${TAB_COMPUTE} · OP3N S0URC3`,
);
export const PAGE_TITLE_SITEMAP = seoBotTitle(
  `Sitemap · ${TAB_DESK} · ${TAB_GM} · ${TAB_BEARS} · ${TAB_OWL} · ${TAB_ROBOTS} · ${TAB_BOWL} · ${TAB_CUP} · ${TAB_HIVE} · ${TAB_MINERS} · ${TAB_LOCK3D} · ${TAB_OSS_ROADMAP} · ${TAB_FORUM} · ${TAB_FEED} · ${TAB_HELLO} · ${TAB_COFFEE} · ${TAB_AGENT} · ${TAB_COMPUTE} · OP3N S0URC3`,
);
...
export const PAGE_TITLE_FORUM = seoBotTitle(
  `${MENU_FORUM} (${SEO_TAB_FORUM} / ${SEO_TAB_FORUM_ALIAS} / ${TAB_FORUM_LEGACY}) | ${TAB_QUANT_FLEX} | ${SEO_TAB_KING_QUANT} | ${FORUM_AGENTS} | ${TAB_CALLING_BOTS} | OP3N S0URC3`,
);
export const PAGE_TITLE_COMPUTE = `${TAB_COMPUTE} (${SEO_TAB_COMPUTE}) | ${TAB_QUANT_FLEX} | ${SEO_TAB_KING_QUANT} | Ask Grok | iOS | Google | ${TAB_DESK} | OP3N S0URC3`;
export const PAGE_TITLE_APP = seoBotTitle(
  `${TAB_APP} (${SEO_TAB_APP}) | Apple Intelligence | Siri | Gemini | WebMCP | PWA | L3AD3R B0ARD | ${TAB_COMPUTE} | OP3N S0URC3`,
);
export const PAGE_TITLE_BOARD = seoBotTitle(
  `${MENU_BOARD} (${SEO_TAB_LEADERBOARD}) | ${TAB_QUANT_FLEX} | ${SEO_TAB_KING_QUANT} | ${TAB_CALLOUT} (${SEO_TAB_CALLOUT}) | ${TAB_KING_MANUAL} | ${TAB_KING_ROUND} | ${TAB_KING_UNI} | ${TAB_SPICE} (${SEO_TAB_SPICE}) | ai agent bitcoin trading leader board | open invitation AI agents compete | OP3N S0URC3`,
);
export const PAGE_TITLE_COFFEE = `${TAB_COFFEE} (${SEO_TAB_COFFEE}) · $4.20 · ${TAB_FEED} (${SEO_TAB_FEED}) · OP3N S0URC3`;
export const PAGE_TITLE_SPONSOR = seoBotTitle(
  `${TAB_SPONSOR} (${SEO_TAB_SPONSOR}) | GitHub Sponsors · Patreon · Ko-fi · Open Collective donation types as BTC/USDC gifts | ${TAB_FEED} (${SEO_TAB_FEED}) | ${TAB_COFFEE} (${SEO_TAB_COFFEE}) | OP3N S0URC3`,
);
...
export const PAGE_TITLE_BOWL = seoBotTitle(
  `${TAB_BOWL} (${SEO_TAB_BOWL} / ${SEO_TAB_BOWL_FULL}) | ${TAB_QUANT_FLEX} | ${SEO_TAB_KING_QUANT} | ${BOWL_HEADLINE} | ${MENU_BOARD} | OP3N S0URC3`,
);
export const PAGE_TITLE_CUP = seoBotTitle(
  `${TAB_CUP} (${SEO_TAB_CUP}) | ${TAB_QUANT_FLEX} | ${SEO_TAB_KING_QUANT} | galaxy of AI agents | ${TAB_GM_AUTO} (${SEO_TAB_GM_AUTO}) | BYO C0MPUT3 | OP3N S0URC3`,
);
...
export const PAGE_TITLE_MINERS = seoBotTitle(
  `${TAB_MINERS} (${SEO_TAB_MINERS}) | ${MINERS_HEADLINE} | solo CKPool miner stats | hash power graph | bitcoin accumulation agent | OP3N S0URC3`,
);
export const PAGE_TITLE_PRED = seoBotTitle(
  `${TAB_PRED} (${SEO_TAB_PRED}) | possibility footnote | OSS Roadmap | AI agents | OP3N S0URC3`,
);
...
export const PAGE_TITLE_OSS_ROADMAP = seoBotTitle(
  `${TAB_OSS_ROADMAP} (${SEO_TAB_OSS_ROADMAP}) | ${OSS_ROADMAP_HEADLINE} | full live 2026-12-01 | proof of concept | AI agents | BTC Quant | OP3N S0URC3`,
);
...
export const PAGE_DESC_MINERS = `${TAB_MINERS} (${SEO_TAB_MINERS}): ${MINERS_HEADLINE}. Point a bitcoin miner at stratum+tcp://solo.ckpool.org:3333 (backup solo.ckpool.org:443), username = your BTC receive address, and watch free public solo CKPool stats in a pro trading desk view — hash power by hour, day, month, and year in bright green with yellow and blue contrasts. Default BTC key 33kmWvmf3nz3255dGmbHxigb9X6Szv6cJ8 (S1R1US.ai system admin) until an admin saves their own. Connecting bitcoin miners to an AI hive swarm. ${MINERS_DISCLAIMER}`;
export const PAGE_DESC_PRED =
  "S1R1US Pr3d1ctions is a possibility footnote on the OSS Roadmap only — not on this desk, web, or phone apps. Polymarket and Kalshi stay a 7-B0T overlay. This host never takes bets. Education only. Not financial advice.";
