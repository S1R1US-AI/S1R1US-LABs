...
export const OSS_ROADMAP_TAB = "OSS Roadmap";
export const OSS_ROADMAP_SEO = "OSS Roadmap";
...
export type FunctionStatus = "LIVE" | "LIVE-PAPER" | "LIVE-TEST" | "LOCKED" | "NEVER";

export type RoadmapStatus = FunctionStatus | "DONE" | "NOW" | "NEXT" | "QUEUED" | "STARTED" | "ALIGNED";

/** Color key for go-live. Green = on. Cyan = paper. Gold = next/test. Red = locked. Purple = never. */
export const STATUS_LEGEND: { status: RoadmapStatus; tone: "green" | "cyan" | "gold" | "red" | "purple"; meaning: string }[] = [
...
export type DatedMilestone = {
  ...
  date: string;
  estimate: boolean;
  status: "DONE" | "NOW" | "NEXT" | "LOCKED" | "NEVER";
  name: string;
  detail: string;
};

export const DATED_MILESTONES: DatedMilestone[] = [
  {
    id: "d0",
    date: "2026-09-05",
    estimate: false,
...
export function ossRoadmapPublic() {
  return {
