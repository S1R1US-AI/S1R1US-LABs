...
export function corporateSearchGraph() {
  ...
  return [
    ...
    },
    {
      ...
      url: `${origin}/l0ck`,
      image: [`${origin}/l0ck-status-banner.jpg`, `${origin}/lock-closed.gif`, `${origin}/lock-open.gif`],
      step: [
        ...
        { "@type": "HowToStep", position: 2, name: "Turn locks on or off (Admin)", text: "System Admin taps the padlock GIF on Admin → Console or the live-tape rail. Include checkboxes pick the master set. SIM / LIVE is desk mode, not Coinbase create. Copy-admin uses /app/admin.", url: `${origin}/l0ck#how-to-toggle` },
