...
export const LEGAL_LAB =
  "S1R1US Lab Strategies (/labs) is a what-if overlay on the 7-bot tape. Education only. It does not place Coinbase orders.";
