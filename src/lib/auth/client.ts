...
import { GROK_PROVIDERS, NATIVE_X_PROVIDER_ID, xSignInProviderId } from "./providers";
...
export { GROK_PROVIDERS, NATIVE_X_PROVIDER_ID, xSignInProviderId };
...
export async function signIn(
  ...
  const { data, error } =
    providerId === NATIVE_X_PROVIDER_ID || providerId === "x"
